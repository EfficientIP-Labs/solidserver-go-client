...
type IpamPoolDeleteSuccess struct {
	...
	Data *[]AppPoolDeleteSuccessData `json:"data,omitempty"`
}
...
func (o *IpamPoolDeleteSuccess) GetData() []AppPoolDeleteSuccessData {
	if o == nil || o.Data == nil {
		var ret []AppPoolDeleteSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []AppPoolDeleteSuccessData and assigns it to the Data field.
