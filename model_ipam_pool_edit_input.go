...
type IpamPoolEditInput struct {
	// todo(here) :ipam.pool.edit.input.pool_end_address_addr. : IPv4 address
	PoolEndAddressAddr *string `json:"pool_end_address_addr,omitempty"`
	// The database identifier (ID) of the IPv4 pool, a unique numeric key value automatically incremented when you add an IPv4 pool. Use the ID to specify which IPv4 pool to edit.
	...
	// todo(here) :ipam.pool.edit.input.pool_start_address_addr. : IPv4 address
