...
type DhcpRangeDeleteSuccess struct {
	...
	Data *[]DhcpRangeDeleteSuccessData `json:"data,omitempty"`
}
...
func (o *DhcpRangeDeleteSuccess) GetData() []DhcpRangeDeleteSuccessData {
	if o == nil || o.Data == nil {
		var ret []DhcpRangeDeleteSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DhcpRangeDeleteSuccessData and assigns it to the Data field.
