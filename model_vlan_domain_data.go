...
type VlanDomainData struct {
	...
	Data *[]VlanDomainDataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []VlanDomainDataData and assigns it to the Data field.
