...
type IpamNetworkEditSuccess struct {
	...
	Data *[]IpamNetworkEditSuccessData `json:"data,omitempty"`
}
...
func (o *IpamNetworkEditSuccess) GetData() []IpamNetworkEditSuccessData {
	if o == nil || o.Data == nil {
		var ret []IpamNetworkEditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []IpamNetworkEditSuccessData and assigns it to the Data field.
