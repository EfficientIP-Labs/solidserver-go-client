...
// IpamAliasEditSuccessData struct for IpamAliasEditSuccessData
type IpamAliasEditSuccessData struct {
...
func (o IpamAliasEditSuccessData) MarshalJSON() ([]byte, error) {
...
type NullableIpamAliasEditSuccessData struct {
	value *IpamAliasEditSuccessData
	isSet bool
}

func (v NullableIpamAliasEditSuccessData) Get() *IpamAliasEditSuccessData {
	return v.value
}

func (v *NullableIpamAliasEditSuccessData) Set(val *IpamAliasEditSuccessData) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAliasEditSuccessData) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAliasEditSuccessData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAliasEditSuccessData(val *IpamAliasEditSuccessData) *NullableIpamAliasEditSuccessData {
	return &NullableIpamAliasEditSuccessData{value: val, isSet: true}
}

func (v NullableIpamAliasEditSuccessData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAliasEditSuccessData) UnmarshalJSON(src []byte) error {
	v.isSet = true
