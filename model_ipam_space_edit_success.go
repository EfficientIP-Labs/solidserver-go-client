...
type IpamSpaceEditSuccess struct {
	...
	Data *[]IpamSpaceEditSuccessData `json:"data,omitempty"`
}
...
func (o *IpamSpaceEditSuccess) GetData() []IpamSpaceEditSuccessData {
	if o == nil || o.Data == nil {
		var ret []IpamSpaceEditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []IpamSpaceEditSuccessData and assigns it to the Data field.
