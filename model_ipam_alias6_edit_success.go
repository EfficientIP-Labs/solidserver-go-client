...
type IpamAlias6EditSuccess struct {
	...
	Data *[]IpamAlias6EditSuccessData `json:"data,omitempty"`
}
...
func (o *IpamAlias6EditSuccess) GetData() []IpamAlias6EditSuccessData {
	if o == nil || o.Data == nil {
		var ret []IpamAlias6EditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []IpamAlias6EditSuccessData and assigns it to the Data field.
