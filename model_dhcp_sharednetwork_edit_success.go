...
type DhcpSharednetworkEditSuccess struct {
	...
	Data *[]DhcpSharednetworkEditSuccessData `json:"data,omitempty"`
}
...
func (o *DhcpSharednetworkEditSuccess) GetData() []DhcpSharednetworkEditSuccessData {
	if o == nil || o.Data == nil {
		var ret []DhcpSharednetworkEditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DhcpSharednetworkEditSuccessData and assigns it to the Data field.
