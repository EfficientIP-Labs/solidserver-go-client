...
type IpamPool6AddSuccess struct {
	...
	Data *[]IpamPool6AddSuccessData `json:"data,omitempty"`
}
...
func (o *IpamPool6AddSuccess) GetData() []IpamPool6AddSuccessData {
	if o == nil || o.Data == nil {
		var ret []IpamPool6AddSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []IpamPool6AddSuccessData and assigns it to the Data field.
