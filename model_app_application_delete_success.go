...
type AppApplicationDeleteSuccess struct {
	...
	Data *[]AppApplicationDeleteSuccessData `json:"data,omitempty"`
}
...
func (o *AppApplicationDeleteSuccess) GetData() []AppApplicationDeleteSuccessData {
	if o == nil || o.Data == nil {
		var ret []AppApplicationDeleteSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []AppApplicationDeleteSuccessData and assigns it to the Data field.
