...
type DhcpServerData struct {
	...
	Data *[]DhcpServerDataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DhcpServerDataData and assigns it to the Data field.
