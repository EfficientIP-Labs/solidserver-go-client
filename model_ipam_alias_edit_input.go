...
type IpamAliasEditInput struct {
	// todo(here) :ipam.alias.edit.input.address_hostaddr. : IPv4 address
	...
	// todo(here) :ipam.alias.edit.input.alias_name. : String
	AliasName *string `json:"alias_name,omitempty"`
	// The database identifier (ID) of the IPv4 alias, a unique numeric key value automatically incremented when you add an IPv4 alias. Use the ID to specify which IPv4 alias to edit.
