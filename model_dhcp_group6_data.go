...
type DhcpGroup6Data struct {
	...
	Data *[]DhcpGroup6DataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DhcpGroup6DataData and assigns it to the Data field.
