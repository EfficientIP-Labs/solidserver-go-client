...
type DhcpSharednetwork6EditSuccess struct {
	...
	Data *[]DhcpSharednetwork6EditSuccessData `json:"data,omitempty"`
}
...
func (o *DhcpSharednetwork6EditSuccess) GetData() []DhcpSharednetwork6EditSuccessData {
	if o == nil || o.Data == nil {
		var ret []DhcpSharednetwork6EditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DhcpSharednetwork6EditSuccessData and assigns it to the Data field.
