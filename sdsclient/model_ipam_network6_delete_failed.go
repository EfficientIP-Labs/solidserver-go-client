...
// checks if the IpamNetwork6DeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamNetwork6DeleteFailed{}

// IpamNetwork6DeleteFailed struct for IpamNetwork6DeleteFailed
type IpamNetwork6DeleteFailed struct {
...
func (o IpamNetwork6DeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamNetwork6DeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamNetwork6DeleteFailed struct {
	value *IpamNetwork6DeleteFailed
	isSet bool
}

func (v NullableIpamNetwork6DeleteFailed) Get() *IpamNetwork6DeleteFailed {
	return v.value
}

func (v *NullableIpamNetwork6DeleteFailed) Set(val *IpamNetwork6DeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamNetwork6DeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamNetwork6DeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamNetwork6DeleteFailed(val *IpamNetwork6DeleteFailed) *NullableIpamNetwork6DeleteFailed {
	return &NullableIpamNetwork6DeleteFailed{value: val, isSet: true}
}

func (v NullableIpamNetwork6DeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamNetwork6DeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
