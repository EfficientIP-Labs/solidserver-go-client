...
type IpamSpaceData struct {
	...
	Data *[]IpamSpaceDataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []IpamSpaceDataData and assigns it to the Data field.
