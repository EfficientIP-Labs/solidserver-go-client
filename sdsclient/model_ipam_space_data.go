...
// checks if the IpamSpaceData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamSpaceData{}

// IpamSpaceData struct for IpamSpaceData
type IpamSpaceData struct {
	...
	Data     []DataInnerIpamSpaceData `json:"data,omitempty"`
}
...
func (o *IpamSpaceData) GetData() []DataInnerIpamSpaceData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamSpaceData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamSpaceData and assigns it to the Data field.
func (o *IpamSpaceData) SetData(v []DataInnerIpamSpaceData) {
	o.Data = v
}

func (o IpamSpaceData) MarshalJSON() ([]byte, error) {
...
func (o IpamSpaceData) ToMap() (map[string]interface{}, error) {
...
type NullableIpamSpaceData struct {
	value *IpamSpaceData
	isSet bool
}

func (v NullableIpamSpaceData) Get() *IpamSpaceData {
	return v.value
}

func (v *NullableIpamSpaceData) Set(val *IpamSpaceData) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamSpaceData) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamSpaceData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamSpaceData(val *IpamSpaceData) *NullableIpamSpaceData {
	return &NullableIpamSpaceData{value: val, isSet: true}
}

func (v NullableIpamSpaceData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamSpaceData) UnmarshalJSON(src []byte) error {
	v.isSet = true
