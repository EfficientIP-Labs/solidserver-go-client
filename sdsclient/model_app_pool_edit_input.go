...
// checks if the AppPoolEditInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPoolEditInput{}
...
func (o AppPoolEditInput) ToMap() (map[string]interface{}, error) {
