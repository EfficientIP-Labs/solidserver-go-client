...
// checks if the AppPoolData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPoolData{}

// AppPoolData struct for AppPoolData
type AppPoolData struct {
	...
	Data     []DataInnerAppPoolData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DataInnerAppPoolData and assigns it to the Data field.
func (o *AppPoolData) SetData(v []DataInnerAppPoolData) {
	o.Data = v
}

func (o AppPoolData) MarshalJSON() ([]byte, error) {
...
func (o AppPoolData) ToMap() (map[string]interface{}, error) {
...
type NullableAppPoolData struct {
	value *AppPoolData
	isSet bool
}

func (v NullableAppPoolData) Get() *AppPoolData {
	return v.value
}

func (v *NullableAppPoolData) Set(val *AppPoolData) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPoolData) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPoolData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPoolData(val *AppPoolData) *NullableAppPoolData {
	return &NullableAppPoolData{value: val, isSet: true}
}

func (v NullableAppPoolData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPoolData) UnmarshalJSON(src []byte) error {
	v.isSet = true
