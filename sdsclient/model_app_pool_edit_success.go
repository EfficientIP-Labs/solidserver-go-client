...
// checks if the AppPoolEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPoolEditSuccess{}

// AppPoolEditSuccess struct for AppPoolEditSuccess
type AppPoolEditSuccess struct {
	...
	Data     []DataInnerAppPoolEditSuccess `json:"data,omitempty"`
}
...
func (o *AppPoolEditSuccess) GetData() []DataInnerAppPoolEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerAppPoolEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerAppPoolEditSuccess and assigns it to the Data field.
func (o *AppPoolEditSuccess) SetData(v []DataInnerAppPoolEditSuccess) {
	o.Data = v
}

func (o AppPoolEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o AppPoolEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableAppPoolEditSuccess struct {
	value *AppPoolEditSuccess
	isSet bool
}

func (v NullableAppPoolEditSuccess) Get() *AppPoolEditSuccess {
	return v.value
}

func (v *NullableAppPoolEditSuccess) Set(val *AppPoolEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPoolEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPoolEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPoolEditSuccess(val *AppPoolEditSuccess) *NullableAppPoolEditSuccess {
	return &NullableAppPoolEditSuccess{value: val, isSet: true}
}

func (v NullableAppPoolEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPoolEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
