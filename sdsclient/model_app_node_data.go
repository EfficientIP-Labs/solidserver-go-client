...
// checks if the AppNodeData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppNodeData{}

// AppNodeData struct for AppNodeData
type AppNodeData struct {
	...
	Data     []DataInnerAppNodeData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DataInnerAppNodeData and assigns it to the Data field.
func (o *AppNodeData) SetData(v []DataInnerAppNodeData) {
	o.Data = v
}

func (o AppNodeData) MarshalJSON() ([]byte, error) {
...
func (o AppNodeData) ToMap() (map[string]interface{}, error) {
...
type NullableAppNodeData struct {
	value *AppNodeData
	isSet bool
}

func (v NullableAppNodeData) Get() *AppNodeData {
	return v.value
}

func (v *NullableAppNodeData) Set(val *AppNodeData) {
	v.value = val
	v.isSet = true
}

func (v NullableAppNodeData) IsSet() bool {
	return v.isSet
}

func (v *NullableAppNodeData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppNodeData(val *AppNodeData) *NullableAppNodeData {
	return &NullableAppNodeData{value: val, isSet: true}
}

func (v NullableAppNodeData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppNodeData) UnmarshalJSON(src []byte) error {
	v.isSet = true
