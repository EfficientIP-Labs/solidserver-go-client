...
// checks if the DeviceDeviceDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceDeviceDeleteSuccess{}

// DeviceDeviceDeleteSuccess struct for DeviceDeviceDeleteSuccess
type DeviceDeviceDeleteSuccess struct {
	...
	Data     []DataInnerDeviceDeviceDeleteSuccess `json:"data,omitempty"`
}
...
func NewDeviceDeviceDeleteSuccess() *DeviceDeviceDeleteSuccess {
	this := DeviceDeviceDeleteSuccess{}
	return &this
}
...
func (o *DeviceDeviceDeleteSuccess) GetData() []DataInnerDeviceDeviceDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDeviceDeviceDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDeviceDeviceDeleteSuccess and assigns it to the Data field.
func (o *DeviceDeviceDeleteSuccess) SetData(v []DataInnerDeviceDeviceDeleteSuccess) {
	o.Data = v
}

func (o DeviceDeviceDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o DeviceDeviceDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceDeviceDeleteSuccess struct {
	value *DeviceDeviceDeleteSuccess
	isSet bool
}

func (v NullableDeviceDeviceDeleteSuccess) Get() *DeviceDeviceDeleteSuccess {
	return v.value
}

func (v *NullableDeviceDeviceDeleteSuccess) Set(val *DeviceDeviceDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceDeviceDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceDeviceDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceDeviceDeleteSuccess(val *DeviceDeviceDeleteSuccess) *NullableDeviceDeviceDeleteSuccess {
	return &NullableDeviceDeviceDeleteSuccess{value: val, isSet: true}
}

func (v NullableDeviceDeviceDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceDeviceDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
