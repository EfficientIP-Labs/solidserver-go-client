...
type DeviceDeviceDeleteSuccess struct {
	...
	Data *[]DeviceDeviceDeleteSuccessData `json:"data,omitempty"`
}
...
func (o *DeviceDeviceDeleteSuccess) GetData() []DeviceDeviceDeleteSuccessData {
	if o == nil || o.Data == nil {
		var ret []DeviceDeviceDeleteSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DeviceDeviceDeleteSuccessData and assigns it to the Data field.
