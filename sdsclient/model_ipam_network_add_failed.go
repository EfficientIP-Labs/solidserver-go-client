...
// checks if the IpamNetworkAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamNetworkAddFailed{}

// IpamNetworkAddFailed struct for IpamNetworkAddFailed
type IpamNetworkAddFailed struct {
...
func (o IpamNetworkAddFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamNetworkAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamNetworkAddFailed struct {
	value *IpamNetworkAddFailed
	isSet bool
}

func (v NullableIpamNetworkAddFailed) Get() *IpamNetworkAddFailed {
	return v.value
}

func (v *NullableIpamNetworkAddFailed) Set(val *IpamNetworkAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamNetworkAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamNetworkAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamNetworkAddFailed(val *IpamNetworkAddFailed) *NullableIpamNetworkAddFailed {
	return &NullableIpamNetworkAddFailed{value: val, isSet: true}
}

func (v NullableIpamNetworkAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamNetworkAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
