...
// checks if the IpamPool6DeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamPool6DeleteSuccess{}
...
type IpamPool6DeleteSuccess struct {
	...
	Data     []DataInnerIpamPool6DeleteSuccess `json:"data,omitempty"`
}
...
func (o *IpamPool6DeleteSuccess) GetData() []DataInnerIpamPool6DeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamPool6DeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamPool6DeleteSuccess and assigns it to the Data field.
...
func (o IpamPool6DeleteSuccess) ToMap() (map[string]interface{}, error) {
