...
// checks if the DnsViewAddInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsViewAddInput{}
...
func (o DnsViewAddInput) ToMap() (map[string]interface{}, error) {
