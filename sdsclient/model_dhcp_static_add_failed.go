...
// checks if the DhcpStaticAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStaticAddFailed{}

// DhcpStaticAddFailed struct for DhcpStaticAddFailed
type DhcpStaticAddFailed struct {
...
func (o DhcpStaticAddFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpStaticAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpStaticAddFailed struct {
	value *DhcpStaticAddFailed
	isSet bool
}

func (v NullableDhcpStaticAddFailed) Get() *DhcpStaticAddFailed {
	return v.value
}

func (v *NullableDhcpStaticAddFailed) Set(val *DhcpStaticAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpStaticAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpStaticAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpStaticAddFailed(val *DhcpStaticAddFailed) *NullableDhcpStaticAddFailed {
	return &NullableDhcpStaticAddFailed{value: val, isSet: true}
}

func (v NullableDhcpStaticAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpStaticAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
