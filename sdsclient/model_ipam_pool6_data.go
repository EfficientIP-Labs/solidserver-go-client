...
// checks if the IpamPool6Data type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamPool6Data{}

// IpamPool6Data struct for IpamPool6Data
type IpamPool6Data struct {
	...
	Data     []DataInnerIpamPool6Data `json:"data,omitempty"`
}
...
func (o *IpamPool6Data) GetData() []DataInnerIpamPool6Data {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamPool6Data
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamPool6Data and assigns it to the Data field.
func (o *IpamPool6Data) SetData(v []DataInnerIpamPool6Data) {
	o.Data = v
}

func (o IpamPool6Data) MarshalJSON() ([]byte, error) {
...
func (o IpamPool6Data) ToMap() (map[string]interface{}, error) {
...
type NullableIpamPool6Data struct {
	value *IpamPool6Data
	isSet bool
}

func (v NullableIpamPool6Data) Get() *IpamPool6Data {
	return v.value
}

func (v *NullableIpamPool6Data) Set(val *IpamPool6Data) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamPool6Data) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamPool6Data) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamPool6Data(val *IpamPool6Data) *NullableIpamPool6Data {
	return &NullableIpamPool6Data{value: val, isSet: true}
}

func (v NullableIpamPool6Data) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamPool6Data) UnmarshalJSON(src []byte) error {
	v.isSet = true
