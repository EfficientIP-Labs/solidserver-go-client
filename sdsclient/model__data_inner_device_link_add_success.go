...
// checks if the DataInnerDeviceLinkAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerDeviceLinkAddSuccess{}

// DataInnerDeviceLinkAddSuccess struct for DataInnerDeviceLinkAddSuccess
type DataInnerDeviceLinkAddSuccess struct {
...
func NewDataInnerDeviceLinkAddSuccess() *DataInnerDeviceLinkAddSuccess {
	this := DataInnerDeviceLinkAddSuccess{}
	return &this
}
...
func (o DataInnerDeviceLinkAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerDeviceLinkAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerDeviceLinkAddSuccess struct {
	value *DataInnerDeviceLinkAddSuccess
	isSet bool
}

func (v NullableDataInnerDeviceLinkAddSuccess) Get() *DataInnerDeviceLinkAddSuccess {
	return v.value
}

func (v *NullableDataInnerDeviceLinkAddSuccess) Set(val *DataInnerDeviceLinkAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerDeviceLinkAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerDeviceLinkAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerDeviceLinkAddSuccess(val *DataInnerDeviceLinkAddSuccess) *NullableDataInnerDeviceLinkAddSuccess {
	return &NullableDataInnerDeviceLinkAddSuccess{value: val, isSet: true}
}

func (v NullableDataInnerDeviceLinkAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerDeviceLinkAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
