...
// checks if the DhcpSharednetwork6EditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpSharednetwork6EditSuccess{}

// DhcpSharednetwork6EditSuccess struct for DhcpSharednetwork6EditSuccess
type DhcpSharednetwork6EditSuccess struct {
	...
	Data     []DataInnerDhcpSharednetwork6EditSuccess `json:"data,omitempty"`
}
...
func NewDhcpSharednetwork6EditSuccess() *DhcpSharednetwork6EditSuccess {
	this := DhcpSharednetwork6EditSuccess{}
	return &this
}
...
func (o *DhcpSharednetwork6EditSuccess) GetData() []DataInnerDhcpSharednetwork6EditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpSharednetwork6EditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpSharednetwork6EditSuccess and assigns it to the Data field.
func (o *DhcpSharednetwork6EditSuccess) SetData(v []DataInnerDhcpSharednetwork6EditSuccess) {
	o.Data = v
}

func (o DhcpSharednetwork6EditSuccess) MarshalJSON() ([]byte, error) {
...
func (o DhcpSharednetwork6EditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpSharednetwork6EditSuccess struct {
	value *DhcpSharednetwork6EditSuccess
	isSet bool
}

func (v NullableDhcpSharednetwork6EditSuccess) Get() *DhcpSharednetwork6EditSuccess {
	return v.value
}

func (v *NullableDhcpSharednetwork6EditSuccess) Set(val *DhcpSharednetwork6EditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpSharednetwork6EditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpSharednetwork6EditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpSharednetwork6EditSuccess(val *DhcpSharednetwork6EditSuccess) *NullableDhcpSharednetwork6EditSuccess {
	return &NullableDhcpSharednetwork6EditSuccess{value: val, isSet: true}
}

func (v NullableDhcpSharednetwork6EditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpSharednetwork6EditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
