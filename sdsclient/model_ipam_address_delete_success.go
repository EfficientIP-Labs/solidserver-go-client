...
// checks if the IpamAddressDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAddressDeleteSuccess{}
...
type IpamAddressDeleteSuccess struct {
	...
	Data     []DataInnerIpamAddressDeleteSuccess `json:"data,omitempty"`
}
...
func (o *IpamAddressDeleteSuccess) GetData() []DataInnerIpamAddressDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamAddressDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamAddressDeleteSuccess and assigns it to the Data field.
...
func (o IpamAddressDeleteSuccess) ToMap() (map[string]interface{}, error) {
