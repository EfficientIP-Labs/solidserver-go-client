...
// checks if the DnsZoneparamAddInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneparamAddInput{}
...
func (o DnsZoneparamAddInput) ToMap() (map[string]interface{}, error) {
