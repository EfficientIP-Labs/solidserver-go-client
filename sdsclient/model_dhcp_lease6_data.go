...
// checks if the DhcpLease6Data type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpLease6Data{}
...
type DhcpLease6Data struct {
	...
	Data     []DataInnerDhcpLease6Data `json:"data,omitempty"`
}
...
func (o *DhcpLease6Data) GetData() []DataInnerDhcpLease6Data {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpLease6Data
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpLease6Data and assigns it to the Data field.
...
func (o DhcpLease6Data) ToMap() (map[string]interface{}, error) {
