...
// checks if the VlanDomainAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanDomainAddFailed{}

// VlanDomainAddFailed struct for VlanDomainAddFailed
type VlanDomainAddFailed struct {
...
func (o VlanDomainAddFailed) MarshalJSON() ([]byte, error) {
...
func (o VlanDomainAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableVlanDomainAddFailed struct {
	value *VlanDomainAddFailed
	isSet bool
}

func (v NullableVlanDomainAddFailed) Get() *VlanDomainAddFailed {
	return v.value
}

func (v *NullableVlanDomainAddFailed) Set(val *VlanDomainAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanDomainAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanDomainAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanDomainAddFailed(val *VlanDomainAddFailed) *NullableVlanDomainAddFailed {
	return &NullableVlanDomainAddFailed{value: val, isSet: true}
}

func (v NullableVlanDomainAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanDomainAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
