...
// checks if the DhcpStatic6AddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStatic6AddSuccess{}

// DhcpStatic6AddSuccess struct for DhcpStatic6AddSuccess
type DhcpStatic6AddSuccess struct {
	...
	Data     []DataInnerDhcpStatic6AddSuccess `json:"data,omitempty"`
}
...
func (o *DhcpStatic6AddSuccess) GetData() []DataInnerDhcpStatic6AddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpStatic6AddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpStatic6AddSuccess and assigns it to the Data field.
func (o *DhcpStatic6AddSuccess) SetData(v []DataInnerDhcpStatic6AddSuccess) {
	o.Data = v
}

func (o DhcpStatic6AddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DhcpStatic6AddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpStatic6AddSuccess struct {
	value *DhcpStatic6AddSuccess
	isSet bool
}

func (v NullableDhcpStatic6AddSuccess) Get() *DhcpStatic6AddSuccess {
	return v.value
}

func (v *NullableDhcpStatic6AddSuccess) Set(val *DhcpStatic6AddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpStatic6AddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpStatic6AddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpStatic6AddSuccess(val *DhcpStatic6AddSuccess) *NullableDhcpStatic6AddSuccess {
	return &NullableDhcpStatic6AddSuccess{value: val, isSet: true}
}

func (v NullableDhcpStatic6AddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpStatic6AddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
