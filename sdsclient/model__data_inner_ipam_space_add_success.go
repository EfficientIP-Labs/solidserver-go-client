...
// checks if the DataInnerIpamSpaceAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerIpamSpaceAddSuccess{}

// DataInnerIpamSpaceAddSuccess struct for DataInnerIpamSpaceAddSuccess
type DataInnerIpamSpaceAddSuccess struct {
...
func NewDataInnerIpamSpaceAddSuccess() *DataInnerIpamSpaceAddSuccess {
	this := DataInnerIpamSpaceAddSuccess{}
	return &this
}
...
func (o DataInnerIpamSpaceAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerIpamSpaceAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerIpamSpaceAddSuccess struct {
	value *DataInnerIpamSpaceAddSuccess
	isSet bool
}

func (v NullableDataInnerIpamSpaceAddSuccess) Get() *DataInnerIpamSpaceAddSuccess {
	return v.value
}

func (v *NullableDataInnerIpamSpaceAddSuccess) Set(val *DataInnerIpamSpaceAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerIpamSpaceAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerIpamSpaceAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerIpamSpaceAddSuccess(val *DataInnerIpamSpaceAddSuccess) *NullableDataInnerIpamSpaceAddSuccess {
	return &NullableDataInnerIpamSpaceAddSuccess{value: val, isSet: true}
}

func (v NullableDataInnerIpamSpaceAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerIpamSpaceAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
