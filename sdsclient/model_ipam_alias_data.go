...
// checks if the IpamAliasData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAliasData{}
...
type IpamAliasData struct {
	...
	Data     []DataInnerIpamAliasData `json:"data,omitempty"`
}
...
func (o *IpamAliasData) GetData() []DataInnerIpamAliasData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamAliasData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamAliasData and assigns it to the Data field.
...
func (o IpamAliasData) ToMap() (map[string]interface{}, error) {
