...
// checks if the DnsViewAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsViewAddFailed{}

// DnsViewAddFailed struct for DnsViewAddFailed
type DnsViewAddFailed struct {
...
func (o DnsViewAddFailed) MarshalJSON() ([]byte, error) {
...
func (o DnsViewAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDnsViewAddFailed struct {
	value *DnsViewAddFailed
	isSet bool
}

func (v NullableDnsViewAddFailed) Get() *DnsViewAddFailed {
	return v.value
}

func (v *NullableDnsViewAddFailed) Set(val *DnsViewAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsViewAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsViewAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsViewAddFailed(val *DnsViewAddFailed) *NullableDnsViewAddFailed {
	return &NullableDnsViewAddFailed{value: val, isSet: true}
}

func (v NullableDnsViewAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsViewAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
