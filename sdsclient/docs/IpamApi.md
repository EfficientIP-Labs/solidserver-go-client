...
[**IpamNetworkCount**](IpamApi.md#IpamNetworkCount) | **Get** /ipam/network/count | Count the number of IPv4 block/subnet-type networks
...
[**IpamAliasData**](ipam_alias_data.md)
...
> IpamNetworkAddSuccess IpamNetworkAdd(ctx).IpamNetworkAddInput(ipamNetworkAddInput).Execute()

Add an IPv4 block/subnet-type network
...
func main() {
    ipamNetworkAddInput := *openapiclient.NewIpamNetworkAddInput() // IpamNetworkAddInput |  (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamNetworkAdd(context.Background()).IpamNetworkAddInput(ipamNetworkAddInput).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamNetworkAdd``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamNetworkAdd`: IpamNetworkAddSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamNetworkAdd`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamNetworkAddRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ipamNetworkAddInput** | [**IpamNetworkAddInput**](IpamNetworkAddInput.md) |  | 

### Return type

[**IpamNetworkAddSuccess**](ipam_network_add_success.md)
...
> ApiCountResponseSuccess IpamNetworkCount(ctx).Where(where).Tags(tags).Execute()

Count the number of IPv4 block/subnet-type networks
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamNetworkCount(context.Background()).Where(where).Tags(tags).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamNetworkCount``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamNetworkCount`: ApiCountResponseSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamNetworkCount`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamNetworkCountRequest struct via the builder pattern
...
> IpamNetworkDeleteSuccess IpamNetworkDelete(ctx).ParentNetworkId(parentNetworkId).SpaceId(spaceId).SpaceName(spaceName).NetworkAddr(networkAddr).NetworkEndAddr(networkEndAddr).NetworkId(networkId).NetworkMask(networkMask).NetworkPrefix(networkPrefix).NetworkSize(networkSize).RelativePosition(relativePosition).NetworkLevel(networkLevel).NetworkName(networkName).UseReversedRelativePosition(useReversedRelativePosition).Warnings(warnings).Execute()

Delete an IPv4 block/subnet-type network
...
func main() {
    parentNetworkId := int32(56) // int32 | The database identifier (ID) of the parent IPv4 network. Use the ID to specify the parent IPv4 network of your choice. (optional)
    spaceId := int32(56) // int32 | The database identifier (ID) of the space, a unique numeric key value automatically incremented when you add a space. Use the ID to specify the space of your choice. (optional)
    spaceName := "spaceName_example" // string | The name of the space. (optional)
    networkAddr := "networkAddr_example" // string | The start IP address of the IPv4 network, its first IP address. (optional)
    networkEndAddr := "networkEndAddr_example" // string | The end IP address of the IPv4 network, its last IP address. (optional)
    networkId := int32(56) // int32 | The database identifier (ID) of the IPv4 network, a unique numeric key value automatically incremented when you add an IPv4 network. Use the ID to specify the IPv4 network of your choice. (optional)
    networkMask := "networkMask_example" // string | The netmask of the IPv4 network. It is expressed in dot-decimal notation and defines the number of addresses the network contains. (optional)
    networkPrefix := "networkPrefix_example" // string | The prefix of the IPv4 network, an integer that defines the number of addresses the network contains. (optional)
    networkSize := int32(56) // int32 | The size of the IPv4 network, the number of IP addresses it contains. (optional)
    relativePosition := int32(56) // int32 | The position of the network within the hierarchy of networks of a VLSM organization. It calculates between <b>0</b> and <b>n</b> all the levels of the organization, its behavior depends on the value of the parameter <b>use_reversed_relative_position</b>:<ul class=dashed ><li><b>use_reversed_relative_position=0</b> where <b>0</b> indicates a block-type network at the highest level possible, in a space-based organization, it belongs to the top space. The levels increment from <b>0</b> down to <b>n</b>, the lowest level you set up, within networks or spaces.<br/>                                            </li><li><b>use_reversed_relative_position=1</b> where <b>1</b> indicates a network located at the lowest level of the organization, within networks or spaces. The levels increment from <b>0</b> up to <b>n</b>, the network at the highest level of the organization.<br/>                                            </li></ul> (optional)
    networkLevel := int32(56) // int32 | The level of the network within the space:<ul class=dashed ><li>                                                Set it to <b>0</b> for a block-type network.<br/>                                            </li><li>                                                Set it to a value between <b>1</b> and <b>n</b> for a subnet-type network.<br/>                                            </li></ul>If you set a value between <b>2</b> and <b>n</b>, you are setting a network-based VLSM organization where non terminal subnet-type networks can contain other subnet-type networks. (optional)
    networkName := "networkName_example" // string | The name of the IPv4 network. (optional)
    useReversedRelativePosition := int32(56) // int32 | A way to determine if the calculation of the parameter <b>relative_position</b> should start from the top (<b>0</b>) or the bottom (<b>1</b>) of the VLSM organization. (optional)
    warnings := "warnings_example" // string | A way to bypass <b>(accept) </b>any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamNetworkDelete(context.Background()).ParentNetworkId(parentNetworkId).SpaceId(spaceId).SpaceName(spaceName).NetworkAddr(networkAddr).NetworkEndAddr(networkEndAddr).NetworkId(networkId).NetworkMask(networkMask).NetworkPrefix(networkPrefix).NetworkSize(networkSize).RelativePosition(relativePosition).NetworkLevel(networkLevel).NetworkName(networkName).UseReversedRelativePosition(useReversedRelativePosition).Warnings(warnings).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamNetworkDelete``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamNetworkDelete`: IpamNetworkDeleteSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamNetworkDelete`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamNetworkDeleteRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **parentNetworkId** | **int32** | The database identifier (ID) of the parent IPv4 network. Use the ID to specify the parent IPv4 network of your choice. | 
 **spaceId** | **int32** | The database identifier (ID) of the space, a unique numeric key value automatically incremented when you add a space. Use the ID to specify the space of your choice. | 
 **spaceName** | **string** | The name of the space. | 
 **networkAddr** | **string** | The start IP address of the IPv4 network, its first IP address. | 
 **networkEndAddr** | **string** | The end IP address of the IPv4 network, its last IP address. | 
 **networkId** | **int32** | The database identifier (ID) of the IPv4 network, a unique numeric key value automatically incremented when you add an IPv4 network. Use the ID to specify the IPv4 network of your choice. | 
 **networkMask** | **string** | The netmask of the IPv4 network. It is expressed in dot-decimal notation and defines the number of addresses the network contains. | 
 **networkPrefix** | **string** | The prefix of the IPv4 network, an integer that defines the number of addresses the network contains. | 
 **networkSize** | **int32** | The size of the IPv4 network, the number of IP addresses it contains. | 
 **relativePosition** | **int32** | The position of the network within the hierarchy of networks of a VLSM organization. It calculates between &lt;b&gt;0&lt;/b&gt; and &lt;b&gt;n&lt;/b&gt; all the levels of the organization, its behavior depends on the value of the parameter &lt;b&gt;use_reversed_relative_position&lt;/b&gt;:&lt;ul class&#x3D;dashed &gt;&lt;li&gt;&lt;b&gt;use_reversed_relative_position&#x3D;0&lt;/b&gt; where &lt;b&gt;0&lt;/b&gt; indicates a block-type network at the highest level possible, in a space-based organization, it belongs to the top space. The levels increment from &lt;b&gt;0&lt;/b&gt; down to &lt;b&gt;n&lt;/b&gt;, the lowest level you set up, within networks or spaces.&lt;br/&gt;                                            &lt;/li&gt;&lt;li&gt;&lt;b&gt;use_reversed_relative_position&#x3D;1&lt;/b&gt; where &lt;b&gt;1&lt;/b&gt; indicates a network located at the lowest level of the organization, within networks or spaces. The levels increment from &lt;b&gt;0&lt;/b&gt; up to &lt;b&gt;n&lt;/b&gt;, the network at the highest level of the organization.&lt;br/&gt;                                            &lt;/li&gt;&lt;/ul&gt; | 
 **networkLevel** | **int32** | The level of the network within the space:&lt;ul class&#x3D;dashed &gt;&lt;li&gt;                                                Set it to &lt;b&gt;0&lt;/b&gt; for a block-type network.&lt;br/&gt;                                            &lt;/li&gt;&lt;li&gt;                                                Set it to a value between &lt;b&gt;1&lt;/b&gt; and &lt;b&gt;n&lt;/b&gt; for a subnet-type network.&lt;br/&gt;                                            &lt;/li&gt;&lt;/ul&gt;If you set a value between &lt;b&gt;2&lt;/b&gt; and &lt;b&gt;n&lt;/b&gt;, you are setting a network-based VLSM organization where non terminal subnet-type networks can contain other subnet-type networks. | 
 **networkName** | **string** | The name of the IPv4 network. | 
 **useReversedRelativePosition** | **int32** | A way to determine if the calculation of the parameter &lt;b&gt;relative_position&lt;/b&gt; should start from the top (&lt;b&gt;0&lt;/b&gt;) or the bottom (&lt;b&gt;1&lt;/b&gt;) of the VLSM organization. | 
 **warnings** | **string** | A way to bypass &lt;b&gt;(accept) &lt;/b&gt;any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. | 

### Return type

[**IpamNetworkDeleteSuccess**](ipam_network_delete_success.md)
...
> IpamNetworkEditSuccess IpamNetworkEdit(ctx).IpamNetworkEditInput(ipamNetworkEditInput).Execute()

Edit an IPv4 block/subnet-type network
...
func main() {
    ipamNetworkEditInput := *openapiclient.NewIpamNetworkEditInput() // IpamNetworkEditInput |  (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamNetworkEdit(context.Background()).IpamNetworkEditInput(ipamNetworkEditInput).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamNetworkEdit``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamNetworkEdit`: IpamNetworkEditSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamNetworkEdit`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamNetworkEditRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ipamNetworkEditInput** | [**IpamNetworkEditInput**](IpamNetworkEditInput.md) |  | 

### Return type

[**IpamNetworkEditSuccess**](ipam_network_edit_success.md)
...
> IpamNetworkData IpamNetworkInfo(ctx).NetworkId(networkId).Execute()

Display the properties of an IPv4 block/subnet-type network
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamNetworkInfo(context.Background()).NetworkId(networkId).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamNetworkInfo``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamNetworkInfo`: IpamNetworkData
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamNetworkInfo`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamNetworkInfoRequest struct via the builder pattern
...
[**IpamNetworkData**](ipam_network_data.md)
...
> IpamNetworkData IpamNetworkList(ctx).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()

List the IPv4 block/subnet-type networks
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamNetworkList(context.Background()).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamNetworkList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamNetworkList`: IpamNetworkData
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamNetworkList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamNetworkListRequest struct via the builder pattern
...
> IpamPool6AddSuccess IpamPool6Add(ctx).IpamPool6AddInput(ipamPool6AddInput).Execute()
...
func main() {
    ipamPool6AddInput := *openapiclient.NewIpamPool6AddInput() // IpamPool6AddInput |  (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamPool6Add(context.Background()).IpamPool6AddInput(ipamPool6AddInput).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamPool6Add``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamPool6Add`: IpamPool6AddSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamPool6Add`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamPool6AddRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ipamPool6AddInput** | [**IpamPool6AddInput**](IpamPool6AddInput.md) |  | 

### Return type

[**IpamPool6AddSuccess**](ipam_pool6_add_success.md)
...
> ApiCountResponseSuccess IpamPool6Count(ctx).Where(where).Tags(tags).Execute()

Count the number of IPv6 pools
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamPool6Count(context.Background()).Where(where).Tags(tags).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamPool6Count``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamPool6Count`: ApiCountResponseSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamPool6Count`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamPool6CountRequest struct via the builder pattern
...
> IpamPool6DeleteSuccess IpamPool6Delete(ctx).Pool6EndIpAddr(pool6EndIpAddr).Pool6Id(pool6Id).SpaceId(spaceId).SpaceName(spaceName).Pool6StartIpAddr(pool6StartIpAddr).Network6Id(network6Id).Warnings(warnings).Execute()
...
func main() {
    pool6EndIpAddr := "pool6EndIpAddr_example" // string | The last IP address of the pool. (optional)
    pool6Id := int32(56) // int32 | The database identifier (ID) of the IPv6 pool, a unique numeric key value automatically incremented when you add an IPv6 pool. Use the ID to specify the IPv6 pool of your choice. (optional)
    spaceId := int32(56) // int32 | The database identifier (ID) of the space, a unique numeric key value automatically incremented when you add a space. Use the ID to specify the space of your choice. (optional)
    spaceName := "spaceName_example" // string | The name of the space. (optional)
    pool6StartIpAddr := "pool6StartIpAddr_example" // string | The first IP address of the pool. (optional)
    network6Id := int32(56) // int32 | The database identifier (ID) of the IPv6 network, a unique numeric key value automatically incremented when you add an IPv6 network. Use the ID to specify the IPv6 network of your choice. (optional)
    warnings := "warnings_example" // string | A way to bypass <b>(accept) </b>any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamPool6Delete(context.Background()).Pool6EndIpAddr(pool6EndIpAddr).Pool6Id(pool6Id).SpaceId(spaceId).SpaceName(spaceName).Pool6StartIpAddr(pool6StartIpAddr).Network6Id(network6Id).Warnings(warnings).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamPool6Delete``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamPool6Delete`: IpamPool6DeleteSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamPool6Delete`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamPool6DeleteRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pool6EndIpAddr** | **string** | The last IP address of the pool. | 
 **pool6Id** | **int32** | The database identifier (ID) of the IPv6 pool, a unique numeric key value automatically incremented when you add an IPv6 pool. Use the ID to specify the IPv6 pool of your choice. | 
 **spaceId** | **int32** | The database identifier (ID) of the space, a unique numeric key value automatically incremented when you add a space. Use the ID to specify the space of your choice. | 
 **spaceName** | **string** | The name of the space. | 
 **pool6StartIpAddr** | **string** | The first IP address of the pool. | 
 **network6Id** | **int32** | The database identifier (ID) of the IPv6 network, a unique numeric key value automatically incremented when you add an IPv6 network. Use the ID to specify the IPv6 network of your choice. | 
 **warnings** | **string** | A way to bypass &lt;b&gt;(accept) &lt;/b&gt;any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. | 

### Return type

[**IpamPool6DeleteSuccess**](ipam_pool6_delete_success.md)
...
> IpamPool6EditSuccess IpamPool6Edit(ctx).IpamPool6EditInput(ipamPool6EditInput).Execute()
...
func main() {
    ipamPool6EditInput := *openapiclient.NewIpamPool6EditInput() // IpamPool6EditInput |  (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamPool6Edit(context.Background()).IpamPool6EditInput(ipamPool6EditInput).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamPool6Edit``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamPool6Edit`: IpamPool6EditSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamPool6Edit`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamPool6EditRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ipamPool6EditInput** | [**IpamPool6EditInput**](IpamPool6EditInput.md) |  | 

### Return type

[**IpamPool6EditSuccess**](ipam_pool6_edit_success.md)
...
> IpamPool6Data IpamPool6Info(ctx).Pool6Id(pool6Id).Execute()

Display the properties of an IPv6 pool
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamPool6Info(context.Background()).Pool6Id(pool6Id).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamPool6Info``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamPool6Info`: IpamPool6Data
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamPool6Info`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamPool6InfoRequest struct via the builder pattern
...
[**IpamPool6Data**](ipam_pool6_data.md)
...
> IpamPool6Data IpamPool6List(ctx).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamPool6List(context.Background()).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamPool6List``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamPool6List`: IpamPool6Data
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamPool6List`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamPool6ListRequest struct via the builder pattern
...
> IpamPoolAddSuccess IpamPoolAdd(ctx).IpamPoolAddInput(ipamPoolAddInput).Execute()
...
func main() {
    ipamPoolAddInput := *openapiclient.NewIpamPoolAddInput() // IpamPoolAddInput |  (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamPoolAdd(context.Background()).IpamPoolAddInput(ipamPoolAddInput).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamPoolAdd``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamPoolAdd`: IpamPoolAddSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamPoolAdd`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamPoolAddRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ipamPoolAddInput** | [**IpamPoolAddInput**](IpamPoolAddInput.md) |  | 

### Return type

[**IpamPoolAddSuccess**](ipam_pool_add_success.md)
...
> ApiCountResponseSuccess IpamPoolCount(ctx).Where(where).Tags(tags).Execute()

Count the number of IPv4 pools
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamPoolCount(context.Background()).Where(where).Tags(tags).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamPoolCount``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamPoolCount`: ApiCountResponseSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamPoolCount`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamPoolCountRequest struct via the builder pattern
...
> IpamPoolDeleteSuccess IpamPoolDelete(ctx).PoolEndIpAddr(poolEndIpAddr).PoolId(poolId).PoolSize(poolSize).SpaceId(spaceId).SpaceName(spaceName).PoolStartIpAddr(poolStartIpAddr).NetworkId(networkId).Warnings(warnings).Execute()
...
func main() {
    poolEndIpAddr := "poolEndIpAddr_example" // string | The last IP address of the pool. (optional)
    poolId := int32(56) // int32 | The database identifier (ID) of the IPv4 pool, a unique numeric key value automatically incremented when you add an IPv4 pool. Use the ID to specify the IPv4 pool of your choice. (optional)
    poolSize := int32(56) // int32 | The size of the pool, the number of IP addresses it contains. (optional)
    spaceId := int32(56) // int32 | The database identifier (ID) of the space, a unique numeric key value automatically incremented when you add a space. Use the ID to specify the space of your choice. (optional)
    spaceName := "spaceName_example" // string | The name of the space. (optional)
    poolStartIpAddr := "poolStartIpAddr_example" // string | The first IP address of the pool. (optional)
    networkId := int32(56) // int32 | The database identifier (ID) of the IPv4 network, a unique numeric key value automatically incremented when you add an IPv4 network. Use the ID to specify the IPv4 network of your choice. (optional)
    warnings := "warnings_example" // string | A way to bypass <b>(accept) </b>any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamPoolDelete(context.Background()).PoolEndIpAddr(poolEndIpAddr).PoolId(poolId).PoolSize(poolSize).SpaceId(spaceId).SpaceName(spaceName).PoolStartIpAddr(poolStartIpAddr).NetworkId(networkId).Warnings(warnings).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamPoolDelete``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamPoolDelete`: IpamPoolDeleteSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamPoolDelete`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamPoolDeleteRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **poolEndIpAddr** | **string** | The last IP address of the pool. | 
 **poolId** | **int32** | The database identifier (ID) of the IPv4 pool, a unique numeric key value automatically incremented when you add an IPv4 pool. Use the ID to specify the IPv4 pool of your choice. | 
 **poolSize** | **int32** | The size of the pool, the number of IP addresses it contains. | 
 **spaceId** | **int32** | The database identifier (ID) of the space, a unique numeric key value automatically incremented when you add a space. Use the ID to specify the space of your choice. | 
 **spaceName** | **string** | The name of the space. | 
 **poolStartIpAddr** | **string** | The first IP address of the pool. | 
 **networkId** | **int32** | The database identifier (ID) of the IPv4 network, a unique numeric key value automatically incremented when you add an IPv4 network. Use the ID to specify the IPv4 network of your choice. | 
 **warnings** | **string** | A way to bypass &lt;b&gt;(accept) &lt;/b&gt;any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. | 

### Return type

[**IpamPoolDeleteSuccess**](ipam_pool_delete_success.md)
...
> IpamPoolEditSuccess IpamPoolEdit(ctx).IpamPoolEditInput(ipamPoolEditInput).Execute()
...
func main() {
    ipamPoolEditInput := *openapiclient.NewIpamPoolEditInput() // IpamPoolEditInput |  (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamPoolEdit(context.Background()).IpamPoolEditInput(ipamPoolEditInput).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamPoolEdit``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamPoolEdit`: IpamPoolEditSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamPoolEdit`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamPoolEditRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ipamPoolEditInput** | [**IpamPoolEditInput**](IpamPoolEditInput.md) |  | 

### Return type

[**IpamPoolEditSuccess**](ipam_pool_edit_success.md)
...
> IpamPoolData IpamPoolInfo(ctx).PoolId(poolId).Execute()

Display the properties of an IPv4 pool
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamPoolInfo(context.Background()).PoolId(poolId).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamPoolInfo``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamPoolInfo`: IpamPoolData
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamPoolInfo`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamPoolInfoRequest struct via the builder pattern
...
[**IpamPoolData**](ipam_pool_data.md)
...
> IpamPoolData IpamPoolList(ctx).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamPoolList(context.Background()).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamPoolList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamPoolList`: IpamPoolData
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamPoolList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamPoolListRequest struct via the builder pattern
...
> IpamSpaceAddSuccess IpamSpaceAdd(ctx).IpamSpaceAddInput(ipamSpaceAddInput).Execute()
...
func main() {
    ipamSpaceAddInput := *openapiclient.NewIpamSpaceAddInput() // IpamSpaceAddInput |  (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamSpaceAdd(context.Background()).IpamSpaceAddInput(ipamSpaceAddInput).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamSpaceAdd``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamSpaceAdd`: IpamSpaceAddSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamSpaceAdd`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamSpaceAddRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ipamSpaceAddInput** | [**IpamSpaceAddInput**](IpamSpaceAddInput.md) |  | 

### Return type

[**IpamSpaceAddSuccess**](ipam_space_add_success.md)
...
> ApiCountResponseSuccess IpamSpaceCount(ctx).Where(where).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamSpaceCount(context.Background()).Where(where).Tags(tags).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamSpaceCount``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamSpaceCount`: ApiCountResponseSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamSpaceCount`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamSpaceCountRequest struct via the builder pattern
...
> IpamSpaceDeleteSuccess IpamSpaceDelete(ctx).SpaceId(spaceId).SpaceName(spaceName).Warnings(warnings).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamSpaceDelete(context.Background()).SpaceId(spaceId).SpaceName(spaceName).Warnings(warnings).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamSpaceDelete``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamSpaceDelete`: IpamSpaceDeleteSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamSpaceDelete`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamSpaceDeleteRequest struct via the builder pattern
...
[**IpamSpaceDeleteSuccess**](ipam_space_delete_success.md)
...
> IpamSpaceEditSuccess IpamSpaceEdit(ctx).IpamSpaceEditInput(ipamSpaceEditInput).Execute()
...
func main() {
    ipamSpaceEditInput := *openapiclient.NewIpamSpaceEditInput() // IpamSpaceEditInput |  (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamSpaceEdit(context.Background()).IpamSpaceEditInput(ipamSpaceEditInput).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamSpaceEdit``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamSpaceEdit`: IpamSpaceEditSuccess
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamSpaceEdit`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamSpaceEditRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ipamSpaceEditInput** | [**IpamSpaceEditInput**](IpamSpaceEditInput.md) |  | 

### Return type

[**IpamSpaceEditSuccess**](ipam_space_edit_success.md)
...
> IpamSpaceData IpamSpaceInfo(ctx).SpaceId(spaceId).Execute()

Display the properties of a space
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamSpaceInfo(context.Background()).SpaceId(spaceId).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamSpaceInfo``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamSpaceInfo`: IpamSpaceData
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamSpaceInfo`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamSpaceInfoRequest struct via the builder pattern
...
[**IpamSpaceData**](ipam_space_data.md)
...
> IpamSpaceData IpamSpaceList(ctx).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.IpamApi.IpamSpaceList(context.Background()).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()
    if err.Error() != "" {
        fmt.Fprintf(os.Stderr, "Error when calling `IpamApi.IpamSpaceList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IpamSpaceList`: IpamSpaceData
    fmt.Fprintf(os.Stdout, "Response from `IpamApi.IpamSpaceList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIpamSpaceListRequest struct via the builder pattern
