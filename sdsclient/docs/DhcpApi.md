...
[**DhcpRange6List**](DhcpApi.md#DhcpRange6List) | **Get** /dhcp/range6/list | List the DHCPv6 ranges
...
[**DhcpSharednetworkList**](DhcpApi.md#DhcpSharednetworkList) | **Get** /dhcp/sharednetwork/list | List the DHCPv4 shared networks
...
> DhcpGroup6Data DhcpGroup6List(ctx).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()
...
Other parameters are passed through a pointer to a apiDhcpRange6AddRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpRange6AddInput** | [**DhcpRange6AddInput**](DhcpRange6AddInput.md) |  | 

### Return type

[**DhcpRange6AddSuccess**](dhcp_range6_add_success.md)
...
> ApiCountResponseSuccess DhcpRange6Count(ctx).Where(where).Tags(tags).Execute()

Count the number of DHCPv6 ranges
...
func main() {
    ...
    // response from `DhcpRange6Count`: ApiCountResponseSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpRange6Count`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpRange6CountRequest struct via the builder pattern
...
> DhcpRange6DeleteSuccess DhcpRange6Delete(ctx).Server6Id(server6Id).Server6Name(server6Name).Range6EndAddr(range6EndAddr).Range6Id(range6Id).Range6StartAddr(range6StartAddr).Scope6Id(scope6Id).Server6Hostaddr(server6Hostaddr).Warnings(warnings).Execute()

Delete a DHCPv6 range
...
func main() {
    ...
    server6Name := "server6Name_example" // string | The name of the DHCPv6 server. (optional)
    range6EndAddr := "range6EndAddr_example" // string | The last IP address of the DHCPv6 range. (optional)
    ...
    range6StartAddr := "range6StartAddr_example" // string | The first IP address of the DHCPv6 range. (optional)
    ...
    // response from `DhcpRange6Delete`: DhcpRange6DeleteSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpRange6Delete`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpRange6DeleteRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **server6Id** | **int32** | The database identifier (ID) of the DHCPv6 server, a unique numeric key value automatically incremented when you add a DHCPv6 server. Use the ID to specify the DHCPv6 server of your choice. | 
 **server6Name** | **string** | The name of the DHCPv6 server. | 
 **range6EndAddr** | **string** | The last IP address of the DHCPv6 range. | 
 **range6Id** | **int32** | The database identifier (ID) of the DHCPv6 range, a unique numeric key value automatically incremented when you add a DHCPv6 range. Use the ID to specify the DHCPv6 of your choice. | 
 **range6StartAddr** | **string** | The first IP address of the DHCPv6 range. | 
 **scope6Id** | **int32** | The database identifier (ID) of the DHCPv6 scope, a unique numeric key value automatically incremented when you add a DHCPv6 scope. Use the ID to specify the DHCPv6 scope of your choice. | 
 **server6Hostaddr** | **string** | The IP address of the DHCP server. | 
 **warnings** | **string** | A way to bypass &lt;b&gt;(accept) &lt;/b&gt;any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. | 

### Return type

[**DhcpRange6DeleteSuccess**](dhcp_range6_delete_success.md)
...
> DhcpRange6EditSuccess DhcpRange6Edit(ctx).DhcpRange6EditInput(dhcpRange6EditInput).Execute()
...
func main() {
    ...
    // response from `DhcpRange6Edit`: DhcpRange6EditSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpRange6Edit`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpRange6EditRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpRange6EditInput** | [**DhcpRange6EditInput**](DhcpRange6EditInput.md) |  | 

### Return type

[**DhcpRange6EditSuccess**](dhcp_range6_edit_success.md)
...
> DhcpRange6Data DhcpRange6Info(ctx).Range6Id(range6Id).Execute()

Display the properties of a DHCPv6 range
...
func main() {
    ...
    // response from `DhcpRange6Info`: DhcpRange6Data
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpRange6Info`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpRange6InfoRequest struct via the builder pattern
...
[**DhcpRange6Data**](dhcp_range6_data.md)
...
> DhcpRange6Data DhcpRange6List(ctx).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()

List the DHCPv6 ranges
...
func main() {
    ...
    // response from `DhcpRange6List`: DhcpRange6Data
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpRange6List`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpRange6ListRequest struct via the builder pattern
...
> DhcpRangeAddSuccess DhcpRangeAdd(ctx).DhcpRangeAddInput(dhcpRangeAddInput).Execute()
...
func main() {
    ...
    // response from `DhcpRangeAdd`: DhcpRangeAddSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpRangeAdd`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpRangeAddRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpRangeAddInput** | [**DhcpRangeAddInput**](DhcpRangeAddInput.md) |  | 

### Return type

[**DhcpRangeAddSuccess**](dhcp_range_add_success.md)
...
> ApiCountResponseSuccess DhcpRangeCount(ctx).Where(where).Tags(tags).Execute()

Count the number of DHCPv4 ranges
...
func main() {
    ...
    // response from `DhcpRangeCount`: ApiCountResponseSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpRangeCount`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpRangeCountRequest struct via the builder pattern
...
> DhcpRangeDeleteSuccess DhcpRangeDelete(ctx).ServerId(serverId).ServerName(serverName).RangeEndAddr(rangeEndAddr).RangeId(rangeId).RangeName(rangeName).RangeStartAddr(rangeStartAddr).ScopeId(scopeId).ServerHostaddr(serverHostaddr).Warnings(warnings).Execute()

Delete a DHCPv4 range
...
func main() {
    serverId := int32(56) // int32 | The database identifier (ID) of the DHCPv4 server, a unique numeric key value automatically incremented when you add a DHCPv4 server. Use the ID to specify the DHCPv4 server of your choice. (optional)
    serverName := "serverName_example" // string | The name of the DHCPv4 server. (optional)
    rangeEndAddr := "rangeEndAddr_example" // string | The last IP address of the DHCPv4 range. (optional)
    ...
    rangeName := "rangeName_example" // string | The name of the DHCPv4 range. (optional)
    rangeStartAddr := "rangeStartAddr_example" // string | The first IP address of the DHCPv4 range. (optional)
    ...
    // response from `DhcpRangeDelete`: DhcpRangeDeleteSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpRangeDelete`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpRangeDeleteRequest struct via the builder pattern
 ...
 **serverId** | **int32** | The database identifier (ID) of the DHCPv4 server, a unique numeric key value automatically incremented when you add a DHCPv4 server. Use the ID to specify the DHCPv4 server of your choice. | 
 **serverName** | **string** | The name of the DHCPv4 server. | 
 **rangeEndAddr** | **string** | The last IP address of the DHCPv4 range. | 
 **rangeId** | **int32** | The database identifier (ID) of the DHCPv4 range, a unique numeric key value automatically incremented when you add a DHCPv4 range. Use the ID to specify the DHCPv4 range of your choice. | 
 **rangeName** | **string** | The name of the DHCPv4 range. | 
 **rangeStartAddr** | **string** | The first IP address of the DHCPv4 range. | 
 **scopeId** | **int32** | The database identifier (ID) of the DHCPv4 scope, a unique numeric key value automatically incremented when you add a DHCPv4 scope. Use the ID to specify the DHCPv4 scope of your choice. | 
 **serverHostaddr** | **string** | The IP address of the DHCP server. | 
 **warnings** | **string** | A way to bypass &lt;b&gt;(accept) &lt;/b&gt;any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. | 

### Return type

[**DhcpRangeDeleteSuccess**](dhcp_range_delete_success.md)
...
> DhcpRangeEditSuccess DhcpRangeEdit(ctx).DhcpRangeEditInput(dhcpRangeEditInput).Execute()
...
func main() {
    ...
    // response from `DhcpRangeEdit`: DhcpRangeEditSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpRangeEdit`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpRangeEditRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpRangeEditInput** | [**DhcpRangeEditInput**](DhcpRangeEditInput.md) |  | 

### Return type

[**DhcpRangeEditSuccess**](dhcp_range_edit_success.md)
...
> DhcpRangeData DhcpRangeInfo(ctx).RangeId(rangeId).Execute()

Display the properties of a DHCPv4 range
...
func main() {
    ...
    // response from `DhcpRangeInfo`: DhcpRangeData
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpRangeInfo`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpRangeInfoRequest struct via the builder pattern
...
[**DhcpRangeData**](dhcp_range_data.md)
...
> DhcpRangeData DhcpRangeList(ctx).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()

List the DHCPv4 ranges
...
func main() {
    ...
    // response from `DhcpRangeList`: DhcpRangeData
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpRangeList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpRangeListRequest struct via the builder pattern
...
> DhcpScope6AddSuccess DhcpScope6Add(ctx).DhcpScope6AddInput(dhcpScope6AddInput).Execute()
...
func main() {
    ...
    // response from `DhcpScope6Add`: DhcpScope6AddSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpScope6Add`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpScope6AddRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpScope6AddInput** | [**DhcpScope6AddInput**](DhcpScope6AddInput.md) |  | 

### Return type

[**DhcpScope6AddSuccess**](dhcp_scope6_add_success.md)
...
> ApiCountResponseSuccess DhcpScope6Count(ctx).Where(where).Tags(tags).Execute()

Count the number of DHCPv6 scopes
...
func main() {
    ...
    // response from `DhcpScope6Count`: ApiCountResponseSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpScope6Count`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpScope6CountRequest struct via the builder pattern
...
> DhcpScope6DeleteSuccess DhcpScope6Delete(ctx).Server6Id(server6Id).Server6Name(server6Name).Scope6Id(scope6Id).Scope6StartAddr(scope6StartAddr).Server6Hostaddr(server6Hostaddr).Warnings(warnings).Execute()

Delete a DHCPv6 scope
...
func main() {
    ...
    server6Name := "server6Name_example" // string | The name of the DHCPv6 server. (optional)
    scope6Id := int32(56) // int32 | The database identifier (ID) of the DHCPv6 scope, a unique numeric key value automatically incremented when you add a DHCPv6 scope. Use the ID to specify the DHCPv6 scope of your choice. (optional)
    scope6StartAddr := "scope6StartAddr_example" // string | The first IP address of the DHCPv6 scope. (optional)
    server6Hostaddr := "server6Hostaddr_example" // string | The IP address of the DHCP server. (optional)
    warnings := "warnings_example" // string | A way to bypass <b>(accept) </b>any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. (optional)
    ...
    // response from `DhcpScope6Delete`: DhcpScope6DeleteSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpScope6Delete`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpScope6DeleteRequest struct via the builder pattern
 ...
 **server6Name** | **string** | The name of the DHCPv6 server. | 
 **scope6Id** | **int32** | The database identifier (ID) of the DHCPv6 scope, a unique numeric key value automatically incremented when you add a DHCPv6 scope. Use the ID to specify the DHCPv6 scope of your choice. | 
 **scope6StartAddr** | **string** | The first IP address of the DHCPv6 scope. | 
 **server6Hostaddr** | **string** | The IP address of the DHCP server. | 
 **warnings** | **string** | A way to bypass &lt;b&gt;(accept) &lt;/b&gt;any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. | 

### Return type

[**DhcpScope6DeleteSuccess**](dhcp_scope6_delete_success.md)
...
> DhcpScope6EditSuccess DhcpScope6Edit(ctx).DhcpScope6EditInput(dhcpScope6EditInput).Execute()
...
func main() {
    ...
    // response from `DhcpScope6Edit`: DhcpScope6EditSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpScope6Edit`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpScope6EditRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpScope6EditInput** | [**DhcpScope6EditInput**](DhcpScope6EditInput.md) |  | 

### Return type

[**DhcpScope6EditSuccess**](dhcp_scope6_edit_success.md)
...
> DhcpScope6Data DhcpScope6Info(ctx).Scope6Id(scope6Id).Execute()

Display the properties of a DHCPv6 scope
...
func main() {
    ...
    // response from `DhcpScope6Info`: DhcpScope6Data
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpScope6Info`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpScope6InfoRequest struct via the builder pattern
...
[**DhcpScope6Data**](dhcp_scope6_data.md)
...
> DhcpScope6Data DhcpScope6List(ctx).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()

List the DHCPv6 scopes
...
func main() {
    ...
    // response from `DhcpScope6List`: DhcpScope6Data
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpScope6List`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpScope6ListRequest struct via the builder pattern
...
> DhcpScopeAddSuccess DhcpScopeAdd(ctx).DhcpScopeAddInput(dhcpScopeAddInput).Execute()
...
func main() {
    ...
    // response from `DhcpScopeAdd`: DhcpScopeAddSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpScopeAdd`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpScopeAddRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpScopeAddInput** | [**DhcpScopeAddInput**](DhcpScopeAddInput.md) |  | 

### Return type

[**DhcpScopeAddSuccess**](dhcp_scope_add_success.md)
...
> ApiCountResponseSuccess DhcpScopeCount(ctx).Where(where).Tags(tags).Execute()

Count the number of DHCPv4 scopes
...
func main() {
    ...
    // response from `DhcpScopeCount`: ApiCountResponseSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpScopeCount`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpScopeCountRequest struct via the builder pattern
...
> DhcpScopeDeleteSuccess DhcpScopeDelete(ctx).ServerId(serverId).ServerName(serverName).ScopeId(scopeId).ScopeNetAddr(scopeNetAddr).ServerHostaddr(serverHostaddr).Warnings(warnings).Execute()

Delete a DHCPv4 scope
...
func main() {
    ...
    serverName := "serverName_example" // string | The name of the DHCPv4 server. (optional)
    scopeId := int32(56) // int32 | The database identifier (ID) of the DHCPv4 scope, a unique numeric key value automatically incremented when you add a DHCPv4 scope. Use the ID to specify the DHCPv4 scope of your choice. (optional)
    scopeNetAddr := "scopeNetAddr_example" // string | The first IP address of the DHCPv4 scope. (optional)
    serverHostaddr := "serverHostaddr_example" // string | The IP address of the DHCP server. (optional)
    warnings := "warnings_example" // string | A way to bypass <b>(accept) </b>any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. (optional)
    ...
    // response from `DhcpScopeDelete`: DhcpScopeDeleteSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpScopeDelete`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpScopeDeleteRequest struct via the builder pattern
 ...
 **serverName** | **string** | The name of the DHCPv4 server. | 
 **scopeId** | **int32** | The database identifier (ID) of the DHCPv4 scope, a unique numeric key value automatically incremented when you add a DHCPv4 scope. Use the ID to specify the DHCPv4 scope of your choice. | 
 **scopeNetAddr** | **string** | The first IP address of the DHCPv4 scope. | 
 **serverHostaddr** | **string** | The IP address of the DHCP server. | 
 **warnings** | **string** | A way to bypass &lt;b&gt;(accept) &lt;/b&gt;any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. | 

### Return type

[**DhcpScopeDeleteSuccess**](dhcp_scope_delete_success.md)
...
> DhcpScopeEditSuccess DhcpScopeEdit(ctx).DhcpScopeEditInput(dhcpScopeEditInput).Execute()
...
func main() {
    ...
    // response from `DhcpScopeEdit`: DhcpScopeEditSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpScopeEdit`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpScopeEditRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpScopeEditInput** | [**DhcpScopeEditInput**](DhcpScopeEditInput.md) |  | 

### Return type

[**DhcpScopeEditSuccess**](dhcp_scope_edit_success.md)
...
> DhcpScopeData DhcpScopeInfo(ctx).ScopeId(scopeId).Execute()

Display the properties of a DHCPv4 scope
...
func main() {
    ...
    // response from `DhcpScopeInfo`: DhcpScopeData
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpScopeInfo`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpScopeInfoRequest struct via the builder pattern
...
[**DhcpScopeData**](dhcp_scope_data.md)
...
> DhcpScopeData DhcpScopeList(ctx).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()

List the DHCPv4 scopes
...
func main() {
    ...
    // response from `DhcpScopeList`: DhcpScopeData
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpScopeList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpScopeListRequest struct via the builder pattern
...
> ApiCountResponseSuccess DhcpServer6Count(ctx).Where(where).Tags(tags).Execute()

Count the number of DHCPv6 servers
...
func main() {
    ...
    // response from `DhcpServer6Count`: ApiCountResponseSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpServer6Count`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpServer6CountRequest struct via the builder pattern
...
> DhcpServer6Data DhcpServer6Info(ctx).Server6Id(server6Id).Execute()

Display the properties of a DHCPv6 server
...
func main() {
    ...
    // response from `DhcpServer6Info`: DhcpServer6Data
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpServer6Info`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpServer6InfoRequest struct via the builder pattern
...
[**DhcpServer6Data**](dhcp_server6_data.md)
...
> DhcpServer6Data DhcpServer6List(ctx).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()

List the DHCPv6 servers
...
func main() {
    ...
    // response from `DhcpServer6List`: DhcpServer6Data
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpServer6List`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpServer6ListRequest struct via the builder pattern
...
> ApiCountResponseSuccess DhcpServerCount(ctx).Where(where).Tags(tags).Execute()

Count the number of DHCPv4 servers
...
func main() {
    ...
    // response from `DhcpServerCount`: ApiCountResponseSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpServerCount`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpServerCountRequest struct via the builder pattern
...
> DhcpServerData DhcpServerInfo(ctx).ServerId(serverId).Execute()

Display the properties of a DHCPv4 server
...
func main() {
    ...
    // response from `DhcpServerInfo`: DhcpServerData
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpServerInfo`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpServerInfoRequest struct via the builder pattern
...
[**DhcpServerData**](dhcp_server_data.md)
...
> DhcpServerData DhcpServerList(ctx).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()

List the DHCPv4 servers
...
func main() {
    ...
    // response from `DhcpServerList`: DhcpServerData
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpServerList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpServerListRequest struct via the builder pattern
...
## DhcpSharednetwork6Add

> DhcpSharednetwork6AddSuccess DhcpSharednetwork6Add(ctx).DhcpSharednetwork6AddInput(dhcpSharednetwork6AddInput).Execute()

Add a DHCPv6 shared network
...
func main() {
    ...
    // response from `DhcpSharednetwork6Add`: DhcpSharednetwork6AddSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpSharednetwork6Add`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpSharednetwork6AddRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpSharednetwork6AddInput** | [**DhcpSharednetwork6AddInput**](DhcpSharednetwork6AddInput.md) |  | 

### Return type

[**DhcpSharednetwork6AddSuccess**](dhcp_sharednetwork6_add_success.md)
...
## DhcpSharednetwork6Count

> ApiCountResponseSuccess DhcpSharednetwork6Count(ctx).Where(where).Execute()

Count the number of DHCPv6 shared networks
...
func main() {
    ...
    // response from `DhcpSharednetwork6Count`: ApiCountResponseSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpSharednetwork6Count`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpSharednetwork6CountRequest struct via the builder pattern
...
## DhcpSharednetwork6Delete

> DhcpSharednetwork6DeleteSuccess DhcpSharednetwork6Delete(ctx).Server6Id(server6Id).Server6Name(server6Name).Sharednetwork6Id(sharednetwork6Id).Sharednetwork6Name(sharednetwork6Name).Server6Hostaddr(server6Hostaddr).Warnings(warnings).Execute()
...
func main() {
    ...
    sharednetwork6Name := "sharednetwork6Name_example" // string | The name of the DHCPv6 shared network. (optional)
    server6Hostaddr := "server6Hostaddr_example" // string | The IP address of the DHCP server. (optional)
    warnings := "warnings_example" // string | A way to bypass <b>(accept) </b>any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. (optional)
    ...
    // response from `DhcpSharednetwork6Delete`: DhcpSharednetwork6DeleteSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpSharednetwork6Delete`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpSharednetwork6DeleteRequest struct via the builder pattern
 ...
 **server6Id** | **int32** | The database identifier (ID) of the DHCPv6 server, a unique numeric key value automatically incremented when you add a DHCPv6 server. Use the ID to specify the DHCPv6 server of your choice. | 
 **server6Name** | **string** | The name of the DHCPv6 server. | 
 **sharednetwork6Id** | **int32** | The database identifier (ID) of the DHCPv6 shared network, a unique numeric key value automatically incremented when you add a DHCPv6 shared network. Use the ID to specify the DHCPv6 shared network of your choice. | 
 **sharednetwork6Name** | **string** | The name of the DHCPv6 shared network. | 
 **server6Hostaddr** | **string** | The IP address of the DHCP server. | 
 **warnings** | **string** | A way to bypass &lt;b&gt;(accept) &lt;/b&gt;any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. | 

### Return type

[**DhcpSharednetwork6DeleteSuccess**](dhcp_sharednetwork6_delete_success.md)
...
## DhcpSharednetwork6Edit

> DhcpSharednetwork6EditSuccess DhcpSharednetwork6Edit(ctx).DhcpSharednetwork6EditInput(dhcpSharednetwork6EditInput).Execute()
...
func main() {
    ...
    // response from `DhcpSharednetwork6Edit`: DhcpSharednetwork6EditSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpSharednetwork6Edit`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpSharednetwork6EditRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpSharednetwork6EditInput** | [**DhcpSharednetwork6EditInput**](DhcpSharednetwork6EditInput.md) |  | 

### Return type

[**DhcpSharednetwork6EditSuccess**](dhcp_sharednetwork6_edit_success.md)
...
## DhcpSharednetwork6Info

> DhcpSharednetwork6Data DhcpSharednetwork6Info(ctx).Sharednetwork6Id(sharednetwork6Id).Execute()

Display the properties of a DHCPv6 shared network
...
func main() {
    ...
    // response from `DhcpSharednetwork6Info`: DhcpSharednetwork6Data
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpSharednetwork6Info`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpSharednetwork6InfoRequest struct via the builder pattern
...
[**DhcpSharednetwork6Data**](dhcp_sharednetwork6_data.md)
...
## DhcpSharednetwork6List

> DhcpSharednetwork6Data DhcpSharednetwork6List(ctx).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Execute()

List the DHCPv6 shared networks
...
func main() {
    ...
    // response from `DhcpSharednetwork6List`: DhcpSharednetwork6Data
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpSharednetwork6List`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpSharednetwork6ListRequest struct via the builder pattern
...
## DhcpSharednetworkAdd

> DhcpSharednetworkAddSuccess DhcpSharednetworkAdd(ctx).DhcpSharednetworkAddInput(dhcpSharednetworkAddInput).Execute()

Add a DHCPv4 shared network
...
func main() {
    ...
    // response from `DhcpSharednetworkAdd`: DhcpSharednetworkAddSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpSharednetworkAdd`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpSharednetworkAddRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpSharednetworkAddInput** | [**DhcpSharednetworkAddInput**](DhcpSharednetworkAddInput.md) |  | 

### Return type

[**DhcpSharednetworkAddSuccess**](dhcp_sharednetwork_add_success.md)
...
## DhcpSharednetworkCount

> ApiCountResponseSuccess DhcpSharednetworkCount(ctx).Where(where).Execute()

Count the number of DHCPv4 shared networks
...
func main() {
    ...
    // response from `DhcpSharednetworkCount`: ApiCountResponseSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpSharednetworkCount`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpSharednetworkCountRequest struct via the builder pattern
...
## DhcpSharednetworkDelete

> DhcpSharednetworkDeleteSuccess DhcpSharednetworkDelete(ctx).ServerId(serverId).ServerName(serverName).SharednetworkId(sharednetworkId).SharednetworkName(sharednetworkName).ServerHostaddr(serverHostaddr).Warnings(warnings).Execute()
...
func main() {
    ...
    sharednetworkName := "sharednetworkName_example" // string | The name of the DHCPv4 shared network. (optional)
    serverHostaddr := "serverHostaddr_example" // string | The IP address of the DHCP server. (optional)
    warnings := "warnings_example" // string | A way to bypass <b>(accept) </b>any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. (optional)
    ...
    // response from `DhcpSharednetworkDelete`: DhcpSharednetworkDeleteSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpSharednetworkDelete`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpSharednetworkDeleteRequest struct via the builder pattern
 ...
 **serverId** | **int32** | The database identifier (ID) of the DHCPv4 server, a unique numeric key value automatically incremented when you add a DHCPv4 server. Use the ID to specify the DHCPv4 server of your choice. | 
 **serverName** | **string** | The name of the DHCPv4 server. | 
 **sharednetworkId** | **int32** | The database identifier (ID) of the DHCPv4 shared network, a unique numeric key value automatically incremented when you add a DHCPv4 shared network. Use the ID to specify the DHCPv4 shared network of your choice. | 
 **sharednetworkName** | **string** | The name of the DHCPv4 shared network. | 
 **serverHostaddr** | **string** | The IP address of the DHCP server. | 
 **warnings** | **string** | A way to bypass &lt;b&gt;(accept) &lt;/b&gt;any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. | 

### Return type

[**DhcpSharednetworkDeleteSuccess**](dhcp_sharednetwork_delete_success.md)
...
## DhcpSharednetworkEdit

> DhcpSharednetworkEditSuccess DhcpSharednetworkEdit(ctx).DhcpSharednetworkEditInput(dhcpSharednetworkEditInput).Execute()
...
func main() {
    ...
    // response from `DhcpSharednetworkEdit`: DhcpSharednetworkEditSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpSharednetworkEdit`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpSharednetworkEditRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpSharednetworkEditInput** | [**DhcpSharednetworkEditInput**](DhcpSharednetworkEditInput.md) |  | 

### Return type

[**DhcpSharednetworkEditSuccess**](dhcp_sharednetwork_edit_success.md)
...
## DhcpSharednetworkInfo

> DhcpSharednetworkData DhcpSharednetworkInfo(ctx).SharednetworkId(sharednetworkId).Execute()

Display the properties of a DHCPv4 shared network
...
func main() {
    ...
    // response from `DhcpSharednetworkInfo`: DhcpSharednetworkData
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpSharednetworkInfo`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpSharednetworkInfoRequest struct via the builder pattern
...
[**DhcpSharednetworkData**](dhcp_sharednetwork_data.md)
...
## DhcpSharednetworkList

> DhcpSharednetworkData DhcpSharednetworkList(ctx).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Execute()

List the DHCPv4 shared networks
...
func main() {
    ...
    // response from `DhcpSharednetworkList`: DhcpSharednetworkData
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpSharednetworkList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpSharednetworkListRequest struct via the builder pattern
...
> DhcpStatic6AddSuccess DhcpStatic6Add(ctx).DhcpStatic6AddInput(dhcpStatic6AddInput).Execute()
...
func main() {
    ...
    // response from `DhcpStatic6Add`: DhcpStatic6AddSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpStatic6Add`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpStatic6AddRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpStatic6AddInput** | [**DhcpStatic6AddInput**](DhcpStatic6AddInput.md) |  | 

### Return type

[**DhcpStatic6AddSuccess**](dhcp_static6_add_success.md)
...
> ApiCountResponseSuccess DhcpStatic6Count(ctx).Where(where).Tags(tags).Execute()

Count the number of DHCPv6 statics
...
func main() {
    ...
    // response from `DhcpStatic6Count`: ApiCountResponseSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpStatic6Count`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpStatic6CountRequest struct via the builder pattern
...
> DhcpStatic6DeleteSuccess DhcpStatic6Delete(ctx).Server6Id(server6Id).Server6Name(server6Name).Static6Addr(static6Addr).Static6Id(static6Id).Static6Name(static6Name).Scope6Id(scope6Id).Server6Hostaddr(server6Hostaddr).Warnings(warnings).Execute()

Delete a DHCPv6 static
...
func main() {
    server6Id := int32(56) // int32 | The database identifier (ID) of the DHCPv6 server, a unique numeric key value automatically incremented when you add a DHCPv6 server. Use the ID to specify the DHCPv6 server of your choice. (optional)
    server6Name := "server6Name_example" // string | The name of the DHCPv6 server. (optional)
    static6Addr := "static6Addr_example" // string | The IP address associated with the DHCPv6 static. (optional)
    static6Id := int32(56) // int32 | The database identifier (ID) of the DHCPv6 static, a unique numeric key value automatically incremented when you add a DHCPv6 static. Use the ID to specify the DHCPv6 static of your choice. (optional)
    static6Name := "static6Name_example" // string | The name of the DHCPv6 static. (optional)
    scope6Id := int32(56) // int32 | The database identifier (ID) of the DHCPv6 scope, a unique numeric key value automatically incremented when you add a DHCPv6 scope. Use the ID to specify the DHCPv6 scope of your choice. (optional)
    server6Hostaddr := "server6Hostaddr_example" // string | The IP address of the DHCP server. (optional)
    warnings := "warnings_example" // string | A way to bypass <b>(accept) </b>any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. (optional)
    ...
    // response from `DhcpStatic6Delete`: DhcpStatic6DeleteSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpStatic6Delete`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpStatic6DeleteRequest struct via the builder pattern
 ...
 **server6Id** | **int32** | The database identifier (ID) of the DHCPv6 server, a unique numeric key value automatically incremented when you add a DHCPv6 server. Use the ID to specify the DHCPv6 server of your choice. | 
 **server6Name** | **string** | The name of the DHCPv6 server. | 
 **static6Addr** | **string** | The IP address associated with the DHCPv6 static. | 
 **static6Id** | **int32** | The database identifier (ID) of the DHCPv6 static, a unique numeric key value automatically incremented when you add a DHCPv6 static. Use the ID to specify the DHCPv6 static of your choice. | 
 **static6Name** | **string** | The name of the DHCPv6 static. | 
 **scope6Id** | **int32** | The database identifier (ID) of the DHCPv6 scope, a unique numeric key value automatically incremented when you add a DHCPv6 scope. Use the ID to specify the DHCPv6 scope of your choice. | 
 **server6Hostaddr** | **string** | The IP address of the DHCP server. | 
 **warnings** | **string** | A way to bypass &lt;b&gt;(accept) &lt;/b&gt;any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. | 
...
[**DhcpStatic6DeleteSuccess**](dhcp_static6_delete_success.md)
...
> DhcpStatic6EditSuccess DhcpStatic6Edit(ctx).DhcpStatic6EditInput(dhcpStatic6EditInput).Execute()

Edit a DHCPv6 static
...
func main() {
    ...
    // response from `DhcpStatic6Edit`: DhcpStatic6EditSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpStatic6Edit`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpStatic6EditRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpStatic6EditInput** | [**DhcpStatic6EditInput**](DhcpStatic6EditInput.md) |  | 

### Return type

[**DhcpStatic6EditSuccess**](dhcp_static6_edit_success.md)
...
> DhcpStatic6Data DhcpStatic6Info(ctx).Static6Id(static6Id).Execute()

Display the properties of a DHCPv6 static
...
func main() {
    ...
    // response from `DhcpStatic6Info`: DhcpStatic6Data
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpStatic6Info`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpStatic6InfoRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **static6Id** | **int32** | The database identifier (ID) of the DHCP static, a unique numeric key value automatically incremented when you add a DHCP static. Use the ID to specify the DHCP static of your choice. | 

### Return type

[**DhcpStatic6Data**](dhcp_static6_data.md)
...
> DhcpStatic6Data DhcpStatic6List(ctx).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()

List the DHCPv6 statics
...
func main() {
    ...
    // response from `DhcpStatic6List`: DhcpStatic6Data
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpStatic6List`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpStatic6ListRequest struct via the builder pattern
...
> DhcpStaticAddSuccess DhcpStaticAdd(ctx).DhcpStaticAddInput(dhcpStaticAddInput).Execute()
...
func main() {
    ...
    // response from `DhcpStaticAdd`: DhcpStaticAddSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpStaticAdd`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpStaticAddRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpStaticAddInput** | [**DhcpStaticAddInput**](DhcpStaticAddInput.md) |  | 

### Return type

[**DhcpStaticAddSuccess**](dhcp_static_add_success.md)
...
> ApiCountResponseSuccess DhcpStaticCount(ctx).Where(where).Tags(tags).Execute()

Count the number of DHCPv4 statics
...
func main() {
    ...
    // response from `DhcpStaticCount`: ApiCountResponseSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpStaticCount`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpStaticCountRequest struct via the builder pattern
...
> DhcpStaticDeleteSuccess DhcpStaticDelete(ctx).ServerId(serverId).ServerName(serverName).StaticAddr(staticAddr).StaticId(staticId).StaticIdentifier(staticIdentifier).ScopeId(scopeId).ServerHostaddr(serverHostaddr).StaticMacAddr(staticMacAddr).StaticName(staticName).Warnings(warnings).Execute()

Delete a DHCPv4 static
...
func main() {
    serverId := int32(56) // int32 | The database identifier (ID) of the DHCPv4 server, a unique numeric key value automatically incremented when you add a DHCPv4 server. Use the ID to specify the DHCPv4 server of your choice. (optional)
    serverName := "serverName_example" // string | The name of the DHCPv4 server. (optional)
    staticAddr := "staticAddr_example" // string | The IP address associated with the DHCPv4 static. (optional)
    staticId := int32(56) // int32 | The database identifier (ID) of the DHCPv4 static, a unique numeric key value automatically incremented when you add a DHCPv4 static. Use the ID to specify the DHCPv4 static of your choice. (optional)
    staticIdentifier := "staticIdentifier_example" // string | TODO:dhcp_static_delete.input.static_identifier (optional)
    scopeId := int32(56) // int32 | The database identifier (ID) of the DHCPv4 scope, a unique numeric key value automatically incremented when you add a DHCPv4 scope. Use the ID to specify the DHCPv4 scope of your choice. (optional)
    serverHostaddr := "serverHostaddr_example" // string | The IP address of the DHCP server. (optional)
    staticMacAddr := "staticMacAddr_example" // string | The MAC address you want to associate with the IPv4 static, it must include the MAC address type. The address has 7 sections, <b>00:11:22:33:44:55:66</b> , where <b>00</b> indicates the type. For Ethernet, specify <b>01</b>. (optional)
    ...
    // response from `DhcpStaticDelete`: DhcpStaticDeleteSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpStaticDelete`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpStaticDeleteRequest struct via the builder pattern
 ...
 **serverId** | **int32** | The database identifier (ID) of the DHCPv4 server, a unique numeric key value automatically incremented when you add a DHCPv4 server. Use the ID to specify the DHCPv4 server of your choice. | 
 **serverName** | **string** | The name of the DHCPv4 server. | 
 **staticAddr** | **string** | The IP address associated with the DHCPv4 static. | 
 **staticId** | **int32** | The database identifier (ID) of the DHCPv4 static, a unique numeric key value automatically incremented when you add a DHCPv4 static. Use the ID to specify the DHCPv4 static of your choice. | 
 **staticIdentifier** | **string** | TODO:dhcp_static_delete.input.static_identifier | 
 **scopeId** | **int32** | The database identifier (ID) of the DHCPv4 scope, a unique numeric key value automatically incremented when you add a DHCPv4 scope. Use the ID to specify the DHCPv4 scope of your choice. | 
 **serverHostaddr** | **string** | The IP address of the DHCP server. | 
 **staticMacAddr** | **string** | The MAC address you want to associate with the IPv4 static, it must include the MAC address type. The address has 7 sections, &lt;b&gt;00:11:22:33:44:55:66&lt;/b&gt; , where &lt;b&gt;00&lt;/b&gt; indicates the type. For Ethernet, specify &lt;b&gt;01&lt;/b&gt;. | 
 **staticName** | **string** | The name of the DHCPv4 static. | 
 **warnings** | **string** | A way to bypass &lt;b&gt;(accept) &lt;/b&gt;any enabled rule that would return warning messages. If the service returns an error message, you cannot bypass the enabled rules. | 

### Return type

[**DhcpStaticDeleteSuccess**](dhcp_static_delete_success.md)
...
> DhcpStaticEditSuccess DhcpStaticEdit(ctx).DhcpStaticEditInput(dhcpStaticEditInput).Execute()

Edit a DHCPv4 static
...
func main() {
    ...
    // response from `DhcpStaticEdit`: DhcpStaticEditSuccess
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpStaticEdit`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpStaticEditRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **dhcpStaticEditInput** | [**DhcpStaticEditInput**](DhcpStaticEditInput.md) |  | 

### Return type

[**DhcpStaticEditSuccess**](dhcp_static_edit_success.md)
...
> DhcpStaticData DhcpStaticInfo(ctx).StaticId(staticId).Execute()

Display the properties of a DHCPv4 static
...
func main() {
    ...
    // response from `DhcpStaticInfo`: DhcpStaticData
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpStaticInfo`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpStaticInfoRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **staticId** | **int32** | The database identifier (ID) of the DHCP static, a unique numeric key value automatically incremented when you add a DHCP sttestatic. Use the ID to specify the DHCP static of your choice. | 

### Return type

[**DhcpStaticData**](dhcp_static_data.md)
...
> DhcpStaticData DhcpStaticList(ctx).Orderby(orderby).Where(where).Limit(limit).Offset(offset).Tags(tags).Execute()

List the DHCPv4 statics
...
func main() {
    ...
    // response from `DhcpStaticList`: DhcpStaticData
    fmt.Fprintf(os.Stdout, "Response from `DhcpApi.DhcpStaticList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDhcpStaticListRequest struct via the builder pattern
