...
// checks if the DhcpScopeDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpScopeDeleteFailed{}

// DhcpScopeDeleteFailed struct for DhcpScopeDeleteFailed
type DhcpScopeDeleteFailed struct {
...
func (o DhcpScopeDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpScopeDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpScopeDeleteFailed struct {
	value *DhcpScopeDeleteFailed
	isSet bool
}

func (v NullableDhcpScopeDeleteFailed) Get() *DhcpScopeDeleteFailed {
	return v.value
}

func (v *NullableDhcpScopeDeleteFailed) Set(val *DhcpScopeDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpScopeDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpScopeDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpScopeDeleteFailed(val *DhcpScopeDeleteFailed) *NullableDhcpScopeDeleteFailed {
	return &NullableDhcpScopeDeleteFailed{value: val, isSet: true}
}

func (v NullableDhcpScopeDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpScopeDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
