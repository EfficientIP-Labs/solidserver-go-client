...
type DnsRrDeleteSuccess struct {
	...
	Data *[]DnsRrDeleteSuccessData `json:"data,omitempty"`
}
...
func (o *DnsRrDeleteSuccess) GetData() []DnsRrDeleteSuccessData {
	if o == nil || o.Data == nil {
		var ret []DnsRrDeleteSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DnsRrDeleteSuccessData and assigns it to the Data field.
