...
// checks if the DnsRrDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsRrDeleteSuccess{}

// DnsRrDeleteSuccess struct for DnsRrDeleteSuccess
type DnsRrDeleteSuccess struct {
	...
	Data     []DataInnerDnsRrDeleteSuccess `json:"data,omitempty"`
}
...
func (o *DnsRrDeleteSuccess) GetData() []DataInnerDnsRrDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsRrDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsRrDeleteSuccess and assigns it to the Data field.
func (o *DnsRrDeleteSuccess) SetData(v []DataInnerDnsRrDeleteSuccess) {
	o.Data = v
}

func (o DnsRrDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o DnsRrDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDnsRrDeleteSuccess struct {
	value *DnsRrDeleteSuccess
	isSet bool
}

func (v NullableDnsRrDeleteSuccess) Get() *DnsRrDeleteSuccess {
	return v.value
}

func (v *NullableDnsRrDeleteSuccess) Set(val *DnsRrDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsRrDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsRrDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsRrDeleteSuccess(val *DnsRrDeleteSuccess) *NullableDnsRrDeleteSuccess {
	return &NullableDnsRrDeleteSuccess{value: val, isSet: true}
}

func (v NullableDnsRrDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsRrDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
