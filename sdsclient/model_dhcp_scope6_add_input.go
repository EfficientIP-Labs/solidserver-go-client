...
// checks if the DhcpScope6AddInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpScope6AddInput{}
...
func (o DhcpScope6AddInput) ToMap() (map[string]interface{}, error) {
