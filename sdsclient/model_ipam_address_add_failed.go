...
// checks if the IpamAddressAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAddressAddFailed{}

// IpamAddressAddFailed struct for IpamAddressAddFailed
type IpamAddressAddFailed struct {
...
func (o IpamAddressAddFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamAddressAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAddressAddFailed struct {
	value *IpamAddressAddFailed
	isSet bool
}

func (v NullableIpamAddressAddFailed) Get() *IpamAddressAddFailed {
	return v.value
}

func (v *NullableIpamAddressAddFailed) Set(val *IpamAddressAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAddressAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAddressAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAddressAddFailed(val *IpamAddressAddFailed) *NullableIpamAddressAddFailed {
	return &NullableIpamAddressAddFailed{value: val, isSet: true}
}

func (v NullableIpamAddressAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAddressAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
