...
// checks if the IpamNetwork6EditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamNetwork6EditSuccess{}
...
type IpamNetwork6EditSuccess struct {
	...
	Data     []DataInnerIpamNetwork6EditSuccess `json:"data,omitempty"`
}
...
func (o *IpamNetwork6EditSuccess) GetData() []DataInnerIpamNetwork6EditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamNetwork6EditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamNetwork6EditSuccess and assigns it to the Data field.
...
func (o IpamNetwork6EditSuccess) ToMap() (map[string]interface{}, error) {
