...
var (
	...
	// ContextEipApiTokenAuth takes EipApiTokenAuth as authentication for the request.
	ContextEipApiTokenAuth = contextKey("eipApiToken")

	// ContextAPIKeys takes a string apikey as authentication for the request *DO NOT USE*
...
// EipApiTokenAuth provide API Token authentication to a request passed via context using ContextEipApiTokenAuth
type EipApiTokenAuth struct {
	Token  string `json:"token,omitempty"`
	Secret string `json:"Secret,omitempty"`
}

// APIKey provides API key based authentication to a request passed via context using ContextAPIKey *DO NOT USE*
type APIKey struct {
	Key    string
	Prefix string
}
...
func NewConfiguration() *Configuration {
	cfg := &Configuration{
		...
		UserAgent:     "OpenAPI-Generator/8.4.0/go",
		Debug:         false,
		Servers: ServerConfigurations{
			{
