...
// checks if the VlanVlanEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanVlanEditFailed{}
...
func (o VlanVlanEditFailed) ToMap() (map[string]interface{}, error) {
