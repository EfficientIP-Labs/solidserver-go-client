...
// checks if the DhcpSharednetwork6EditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpSharednetwork6EditFailed{}

// DhcpSharednetwork6EditFailed struct for DhcpSharednetwork6EditFailed
type DhcpSharednetwork6EditFailed struct {
...
func NewDhcpSharednetwork6EditFailed() *DhcpSharednetwork6EditFailed {
	this := DhcpSharednetwork6EditFailed{}
	return &this
}
...
func (o DhcpSharednetwork6EditFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpSharednetwork6EditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpSharednetwork6EditFailed struct {
	value *DhcpSharednetwork6EditFailed
	isSet bool
}

func (v NullableDhcpSharednetwork6EditFailed) Get() *DhcpSharednetwork6EditFailed {
	return v.value
}

func (v *NullableDhcpSharednetwork6EditFailed) Set(val *DhcpSharednetwork6EditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpSharednetwork6EditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpSharednetwork6EditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpSharednetwork6EditFailed(val *DhcpSharednetwork6EditFailed) *NullableDhcpSharednetwork6EditFailed {
	return &NullableDhcpSharednetwork6EditFailed{value: val, isSet: true}
}

func (v NullableDhcpSharednetwork6EditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpSharednetwork6EditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
