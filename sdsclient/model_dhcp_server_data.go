...
// checks if the DhcpServerData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpServerData{}

// DhcpServerData struct for DhcpServerData
type DhcpServerData struct {
	...
	Data     []DataInnerDhcpServerData `json:"data,omitempty"`
}
...
func (o *DhcpServerData) GetData() []DataInnerDhcpServerData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpServerData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpServerData and assigns it to the Data field.
func (o *DhcpServerData) SetData(v []DataInnerDhcpServerData) {
	o.Data = v
}

func (o DhcpServerData) MarshalJSON() ([]byte, error) {
...
func (o DhcpServerData) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpServerData struct {
	value *DhcpServerData
	isSet bool
}

func (v NullableDhcpServerData) Get() *DhcpServerData {
	return v.value
}

func (v *NullableDhcpServerData) Set(val *DhcpServerData) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpServerData) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpServerData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpServerData(val *DhcpServerData) *NullableDhcpServerData {
	return &NullableDhcpServerData{value: val, isSet: true}
}

func (v NullableDhcpServerData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpServerData) UnmarshalJSON(src []byte) error {
	v.isSet = true
