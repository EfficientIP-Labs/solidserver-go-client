...
// checks if the DnsAclEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsAclEditSuccess{}
...
type DnsAclEditSuccess struct {
	...
	Data     []DataInnerDnsAclEditSuccess `json:"data,omitempty"`
}
...
func (o *DnsAclEditSuccess) GetData() []DataInnerDnsAclEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsAclEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsAclEditSuccess and assigns it to the Data field.
...
func (o DnsAclEditSuccess) ToMap() (map[string]interface{}, error) {
