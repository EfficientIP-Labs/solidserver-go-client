...
// checks if the IpamAlias6DeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAlias6DeleteFailed{}

// IpamAlias6DeleteFailed struct for IpamAlias6DeleteFailed
type IpamAlias6DeleteFailed struct {
...
func (o IpamAlias6DeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamAlias6DeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAlias6DeleteFailed struct {
	value *IpamAlias6DeleteFailed
	isSet bool
}

func (v NullableIpamAlias6DeleteFailed) Get() *IpamAlias6DeleteFailed {
	return v.value
}

func (v *NullableIpamAlias6DeleteFailed) Set(val *IpamAlias6DeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAlias6DeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAlias6DeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAlias6DeleteFailed(val *IpamAlias6DeleteFailed) *NullableIpamAlias6DeleteFailed {
	return &NullableIpamAlias6DeleteFailed{value: val, isSet: true}
}

func (v NullableIpamAlias6DeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAlias6DeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
