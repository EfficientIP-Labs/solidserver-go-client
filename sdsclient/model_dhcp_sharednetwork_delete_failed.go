...
// checks if the DhcpSharednetworkDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpSharednetworkDeleteFailed{}

// DhcpSharednetworkDeleteFailed struct for DhcpSharednetworkDeleteFailed
type DhcpSharednetworkDeleteFailed struct {
...
func NewDhcpSharednetworkDeleteFailed() *DhcpSharednetworkDeleteFailed {
	this := DhcpSharednetworkDeleteFailed{}
	return &this
}
...
func (o DhcpSharednetworkDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpSharednetworkDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpSharednetworkDeleteFailed struct {
	value *DhcpSharednetworkDeleteFailed
	isSet bool
}

func (v NullableDhcpSharednetworkDeleteFailed) Get() *DhcpSharednetworkDeleteFailed {
	return v.value
}

func (v *NullableDhcpSharednetworkDeleteFailed) Set(val *DhcpSharednetworkDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpSharednetworkDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpSharednetworkDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpSharednetworkDeleteFailed(val *DhcpSharednetworkDeleteFailed) *NullableDhcpSharednetworkDeleteFailed {
	return &NullableDhcpSharednetworkDeleteFailed{value: val, isSet: true}
}

func (v NullableDhcpSharednetworkDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpSharednetworkDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
