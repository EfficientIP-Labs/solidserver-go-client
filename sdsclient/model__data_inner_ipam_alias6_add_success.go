...
// checks if the DataInnerIpamAlias6AddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerIpamAlias6AddSuccess{}

// DataInnerIpamAlias6AddSuccess struct for DataInnerIpamAlias6AddSuccess
type DataInnerIpamAlias6AddSuccess struct {
...
func NewDataInnerIpamAlias6AddSuccess() *DataInnerIpamAlias6AddSuccess {
	this := DataInnerIpamAlias6AddSuccess{}
	return &this
}
...
func (o DataInnerIpamAlias6AddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerIpamAlias6AddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerIpamAlias6AddSuccess struct {
	value *DataInnerIpamAlias6AddSuccess
	isSet bool
}

func (v NullableDataInnerIpamAlias6AddSuccess) Get() *DataInnerIpamAlias6AddSuccess {
	return v.value
}

func (v *NullableDataInnerIpamAlias6AddSuccess) Set(val *DataInnerIpamAlias6AddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerIpamAlias6AddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerIpamAlias6AddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerIpamAlias6AddSuccess(val *DataInnerIpamAlias6AddSuccess) *NullableDataInnerIpamAlias6AddSuccess {
	return &NullableDataInnerIpamAlias6AddSuccess{value: val, isSet: true}
}

func (v NullableDataInnerIpamAlias6AddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerIpamAlias6AddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
