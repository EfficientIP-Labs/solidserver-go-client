...
// checks if the DhcpRange6DeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpRange6DeleteFailed{}

// DhcpRange6DeleteFailed struct for DhcpRange6DeleteFailed
type DhcpRange6DeleteFailed struct {
...
func (o DhcpRange6DeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpRange6DeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpRange6DeleteFailed struct {
	value *DhcpRange6DeleteFailed
	isSet bool
}

func (v NullableDhcpRange6DeleteFailed) Get() *DhcpRange6DeleteFailed {
	return v.value
}

func (v *NullableDhcpRange6DeleteFailed) Set(val *DhcpRange6DeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpRange6DeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpRange6DeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpRange6DeleteFailed(val *DhcpRange6DeleteFailed) *NullableDhcpRange6DeleteFailed {
	return &NullableDhcpRange6DeleteFailed{value: val, isSet: true}
}

func (v NullableDhcpRange6DeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpRange6DeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
