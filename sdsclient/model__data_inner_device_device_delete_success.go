...
// checks if the DataInnerDeviceDeviceDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerDeviceDeviceDeleteSuccess{}

// DataInnerDeviceDeviceDeleteSuccess struct for DataInnerDeviceDeviceDeleteSuccess
type DataInnerDeviceDeviceDeleteSuccess struct {
...
func NewDataInnerDeviceDeviceDeleteSuccess() *DataInnerDeviceDeviceDeleteSuccess {
	this := DataInnerDeviceDeviceDeleteSuccess{}
	return &this
}
...
func (o DataInnerDeviceDeviceDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerDeviceDeviceDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerDeviceDeviceDeleteSuccess struct {
	value *DataInnerDeviceDeviceDeleteSuccess
	isSet bool
}

func (v NullableDataInnerDeviceDeviceDeleteSuccess) Get() *DataInnerDeviceDeviceDeleteSuccess {
	return v.value
}

func (v *NullableDataInnerDeviceDeviceDeleteSuccess) Set(val *DataInnerDeviceDeviceDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerDeviceDeviceDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerDeviceDeviceDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerDeviceDeviceDeleteSuccess(val *DataInnerDeviceDeviceDeleteSuccess) *NullableDataInnerDeviceDeviceDeleteSuccess {
	return &NullableDataInnerDeviceDeviceDeleteSuccess{value: val, isSet: true}
}

func (v NullableDataInnerDeviceDeviceDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerDeviceDeviceDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
