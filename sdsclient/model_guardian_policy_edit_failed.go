...
// checks if the GuardianPolicyEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuardianPolicyEditFailed{}

// GuardianPolicyEditFailed struct for GuardianPolicyEditFailed
type GuardianPolicyEditFailed struct {
...
func (o GuardianPolicyEditFailed) MarshalJSON() ([]byte, error) {
...
func (o GuardianPolicyEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableGuardianPolicyEditFailed struct {
	value *GuardianPolicyEditFailed
	isSet bool
}

func (v NullableGuardianPolicyEditFailed) Get() *GuardianPolicyEditFailed {
	return v.value
}

func (v *NullableGuardianPolicyEditFailed) Set(val *GuardianPolicyEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableGuardianPolicyEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableGuardianPolicyEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuardianPolicyEditFailed(val *GuardianPolicyEditFailed) *NullableGuardianPolicyEditFailed {
	return &NullableGuardianPolicyEditFailed{value: val, isSet: true}
}

func (v NullableGuardianPolicyEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuardianPolicyEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
