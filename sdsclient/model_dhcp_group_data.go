...
// checks if the DhcpGroupData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpGroupData{}

// DhcpGroupData struct for DhcpGroupData
type DhcpGroupData struct {
	...
	Data     []DataInnerDhcpGroupData `json:"data,omitempty"`
}
...
func (o *DhcpGroupData) GetData() []DataInnerDhcpGroupData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpGroupData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpGroupData and assigns it to the Data field.
func (o *DhcpGroupData) SetData(v []DataInnerDhcpGroupData) {
	o.Data = v
}

func (o DhcpGroupData) MarshalJSON() ([]byte, error) {
...
func (o DhcpGroupData) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpGroupData struct {
	value *DhcpGroupData
	isSet bool
}

func (v NullableDhcpGroupData) Get() *DhcpGroupData {
	return v.value
}

func (v *NullableDhcpGroupData) Set(val *DhcpGroupData) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpGroupData) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpGroupData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpGroupData(val *DhcpGroupData) *NullableDhcpGroupData {
	return &NullableDhcpGroupData{value: val, isSet: true}
}

func (v NullableDhcpGroupData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpGroupData) UnmarshalJSON(src []byte) error {
	v.isSet = true
