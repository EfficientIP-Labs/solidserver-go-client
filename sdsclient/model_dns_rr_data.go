...
// checks if the DnsRrData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsRrData{}

// DnsRrData struct for DnsRrData
type DnsRrData struct {
	...
	Data     []DataInnerDnsRrData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DataInnerDnsRrData and assigns it to the Data field.
func (o *DnsRrData) SetData(v []DataInnerDnsRrData) {
	o.Data = v
}

func (o DnsRrData) MarshalJSON() ([]byte, error) {
...
func (o DnsRrData) ToMap() (map[string]interface{}, error) {
...
type NullableDnsRrData struct {
	value *DnsRrData
	isSet bool
}

func (v NullableDnsRrData) Get() *DnsRrData {
	return v.value
}

func (v *NullableDnsRrData) Set(val *DnsRrData) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsRrData) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsRrData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsRrData(val *DnsRrData) *NullableDnsRrData {
	return &NullableDnsRrData{value: val, isSet: true}
}

func (v NullableDnsRrData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsRrData) UnmarshalJSON(src []byte) error {
	v.isSet = true
