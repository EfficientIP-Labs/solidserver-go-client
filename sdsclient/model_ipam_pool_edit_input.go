...
// checks if the IpamPoolEditInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamPoolEditInput{}

// IpamPoolEditInput struct for IpamPoolEditInput
type IpamPoolEditInput struct {
...
func (o IpamPoolEditInput) MarshalJSON() ([]byte, error) {
...
func (o IpamPoolEditInput) ToMap() (map[string]interface{}, error) {
...
type NullableIpamPoolEditInput struct {
	value *IpamPoolEditInput
	isSet bool
}

func (v NullableIpamPoolEditInput) Get() *IpamPoolEditInput {
	return v.value
}

func (v *NullableIpamPoolEditInput) Set(val *IpamPoolEditInput) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamPoolEditInput) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamPoolEditInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamPoolEditInput(val *IpamPoolEditInput) *NullableIpamPoolEditInput {
	return &NullableIpamPoolEditInput{value: val, isSet: true}
}

func (v NullableIpamPoolEditInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamPoolEditInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
