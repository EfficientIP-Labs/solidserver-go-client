...
// checks if the IpamAliasEditInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAliasEditInput{}

// IpamAliasEditInput struct for IpamAliasEditInput
type IpamAliasEditInput struct {
	// The IP address.
	...
	// The database identifier (ID) of the IPv4 alias, a unique numeric key value automatically incremented when you add an IPv4 alias. Use the ID to specify the IPv4 alias of your choice.
	AliasId *int32 `json:"alias_id,omitempty"`
...
// SetAliasId gets a reference to the given int32 and assigns it to the AliasId field.
...
func (o IpamAliasEditInput) MarshalJSON() ([]byte, error) {
...
func (o IpamAliasEditInput) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAliasEditInput struct {
	value *IpamAliasEditInput
	isSet bool
}

func (v NullableIpamAliasEditInput) Get() *IpamAliasEditInput {
	return v.value
}

func (v *NullableIpamAliasEditInput) Set(val *IpamAliasEditInput) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAliasEditInput) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAliasEditInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAliasEditInput(val *IpamAliasEditInput) *NullableIpamAliasEditInput {
	return &NullableIpamAliasEditInput{value: val, isSet: true}
}

func (v NullableIpamAliasEditInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAliasEditInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
