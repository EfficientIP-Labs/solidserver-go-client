...
// checks if the IpamAliasEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAliasEditFailed{}

// IpamAliasEditFailed struct for IpamAliasEditFailed
type IpamAliasEditFailed struct {
...
func (o IpamAliasEditFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamAliasEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAliasEditFailed struct {
	value *IpamAliasEditFailed
	isSet bool
}

func (v NullableIpamAliasEditFailed) Get() *IpamAliasEditFailed {
	return v.value
}

func (v *NullableIpamAliasEditFailed) Set(val *IpamAliasEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAliasEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAliasEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAliasEditFailed(val *IpamAliasEditFailed) *NullableIpamAliasEditFailed {
	return &NullableIpamAliasEditFailed{value: val, isSet: true}
}

func (v NullableIpamAliasEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAliasEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
