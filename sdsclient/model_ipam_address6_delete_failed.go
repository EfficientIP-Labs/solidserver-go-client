...
// checks if the IpamAddress6DeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAddress6DeleteFailed{}

// IpamAddress6DeleteFailed struct for IpamAddress6DeleteFailed
type IpamAddress6DeleteFailed struct {
...
func (o IpamAddress6DeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamAddress6DeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAddress6DeleteFailed struct {
	value *IpamAddress6DeleteFailed
	isSet bool
}

func (v NullableIpamAddress6DeleteFailed) Get() *IpamAddress6DeleteFailed {
	return v.value
}

func (v *NullableIpamAddress6DeleteFailed) Set(val *IpamAddress6DeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAddress6DeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAddress6DeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAddress6DeleteFailed(val *IpamAddress6DeleteFailed) *NullableIpamAddress6DeleteFailed {
	return &NullableIpamAddress6DeleteFailed{value: val, isSet: true}
}

func (v NullableIpamAddress6DeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAddress6DeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
