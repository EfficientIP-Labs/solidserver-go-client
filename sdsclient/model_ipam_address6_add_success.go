...
// checks if the IpamAddress6AddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAddress6AddSuccess{}

// IpamAddress6AddSuccess struct for IpamAddress6AddSuccess
type IpamAddress6AddSuccess struct {
	...
	Data     []DataInnerIpamAddress6AddSuccess `json:"data,omitempty"`
}
...
func (o *IpamAddress6AddSuccess) GetData() []DataInnerIpamAddress6AddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamAddress6AddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamAddress6AddSuccess and assigns it to the Data field.
func (o *IpamAddress6AddSuccess) SetData(v []DataInnerIpamAddress6AddSuccess) {
	o.Data = v
}

func (o IpamAddress6AddSuccess) MarshalJSON() ([]byte, error) {
...
func (o IpamAddress6AddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAddress6AddSuccess struct {
	value *IpamAddress6AddSuccess
	isSet bool
}

func (v NullableIpamAddress6AddSuccess) Get() *IpamAddress6AddSuccess {
	return v.value
}

func (v *NullableIpamAddress6AddSuccess) Set(val *IpamAddress6AddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAddress6AddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAddress6AddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAddress6AddSuccess(val *IpamAddress6AddSuccess) *NullableIpamAddress6AddSuccess {
	return &NullableIpamAddress6AddSuccess{value: val, isSet: true}
}

func (v NullableIpamAddress6AddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAddress6AddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
