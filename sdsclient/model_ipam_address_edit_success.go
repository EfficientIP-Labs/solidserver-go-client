...
// checks if the IpamAddressEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAddressEditSuccess{}

// IpamAddressEditSuccess struct for IpamAddressEditSuccess
type IpamAddressEditSuccess struct {
	...
	Data     []DataInnerIpamAddressEditSuccess `json:"data,omitempty"`
}
...
func (o *IpamAddressEditSuccess) GetData() []DataInnerIpamAddressEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamAddressEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamAddressEditSuccess and assigns it to the Data field.
func (o *IpamAddressEditSuccess) SetData(v []DataInnerIpamAddressEditSuccess) {
	o.Data = v
}

func (o IpamAddressEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o IpamAddressEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAddressEditSuccess struct {
	value *IpamAddressEditSuccess
	isSet bool
}

func (v NullableIpamAddressEditSuccess) Get() *IpamAddressEditSuccess {
	return v.value
}

func (v *NullableIpamAddressEditSuccess) Set(val *IpamAddressEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAddressEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAddressEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAddressEditSuccess(val *IpamAddressEditSuccess) *NullableIpamAddressEditSuccess {
	return &NullableIpamAddressEditSuccess{value: val, isSet: true}
}

func (v NullableIpamAddressEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAddressEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
