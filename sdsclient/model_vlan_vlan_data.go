...
// checks if the VlanVlanData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanVlanData{}

// VlanVlanData struct for VlanVlanData
type VlanVlanData struct {
	...
	Data     []DataInnerVlanVlanData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DataInnerVlanVlanData and assigns it to the Data field.
func (o *VlanVlanData) SetData(v []DataInnerVlanVlanData) {
	o.Data = v
}

func (o VlanVlanData) MarshalJSON() ([]byte, error) {
...
func (o VlanVlanData) ToMap() (map[string]interface{}, error) {
...
type NullableVlanVlanData struct {
	value *VlanVlanData
	isSet bool
}

func (v NullableVlanVlanData) Get() *VlanVlanData {
	return v.value
}

func (v *NullableVlanVlanData) Set(val *VlanVlanData) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanVlanData) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanVlanData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanVlanData(val *VlanVlanData) *NullableVlanVlanData {
	return &NullableVlanVlanData{value: val, isSet: true}
}

func (v NullableVlanVlanData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanVlanData) UnmarshalJSON(src []byte) error {
	v.isSet = true
