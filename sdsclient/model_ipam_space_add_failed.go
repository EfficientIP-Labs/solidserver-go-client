...
// checks if the IpamSpaceAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamSpaceAddFailed{}
...
func (o IpamSpaceAddFailed) ToMap() (map[string]interface{}, error) {
