...
// checks if the DhcpRange6EditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpRange6EditSuccess{}
...
type DhcpRange6EditSuccess struct {
	...
	Data     []DataInnerDhcpRange6EditSuccess `json:"data,omitempty"`
}
...
func (o *DhcpRange6EditSuccess) GetData() []DataInnerDhcpRange6EditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpRange6EditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpRange6EditSuccess and assigns it to the Data field.
...
func (o DhcpRange6EditSuccess) ToMap() (map[string]interface{}, error) {
