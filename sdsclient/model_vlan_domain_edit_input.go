...
// checks if the VlanDomainEditInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanDomainEditInput{}
...
func (o VlanDomainEditInput) ToMap() (map[string]interface{}, error) {
