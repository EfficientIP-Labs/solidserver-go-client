...
// checks if the VlanVlanAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanVlanAddFailed{}

// VlanVlanAddFailed struct for VlanVlanAddFailed
type VlanVlanAddFailed struct {
...
func (o VlanVlanAddFailed) MarshalJSON() ([]byte, error) {
...
func (o VlanVlanAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableVlanVlanAddFailed struct {
	value *VlanVlanAddFailed
	isSet bool
}

func (v NullableVlanVlanAddFailed) Get() *VlanVlanAddFailed {
	return v.value
}

func (v *NullableVlanVlanAddFailed) Set(val *VlanVlanAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanVlanAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanVlanAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanVlanAddFailed(val *VlanVlanAddFailed) *NullableVlanVlanAddFailed {
	return &NullableVlanVlanAddFailed{value: val, isSet: true}
}

func (v NullableVlanVlanAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanVlanAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
