...
// checks if the IpamAliasDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAliasDeleteFailed{}

// IpamAliasDeleteFailed struct for IpamAliasDeleteFailed
type IpamAliasDeleteFailed struct {
...
func (o IpamAliasDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamAliasDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAliasDeleteFailed struct {
	value *IpamAliasDeleteFailed
	isSet bool
}

func (v NullableIpamAliasDeleteFailed) Get() *IpamAliasDeleteFailed {
	return v.value
}

func (v *NullableIpamAliasDeleteFailed) Set(val *IpamAliasDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAliasDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAliasDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAliasDeleteFailed(val *IpamAliasDeleteFailed) *NullableIpamAliasDeleteFailed {
	return &NullableIpamAliasDeleteFailed{value: val, isSet: true}
}

func (v NullableIpamAliasDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAliasDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
