...
// checks if the DhcpRangeDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpRangeDeleteFailed{}
...
func (o DhcpRangeDeleteFailed) ToMap() (map[string]interface{}, error) {
