...
// checks if the DnsZoneparamData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneparamData{}

// DnsZoneparamData struct for DnsZoneparamData
type DnsZoneparamData struct {
	...
	Data     []DataInnerDnsZoneparamData `json:"data,omitempty"`
}
...
func (o *DnsZoneparamData) GetData() []DataInnerDnsZoneparamData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsZoneparamData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsZoneparamData and assigns it to the Data field.
func (o *DnsZoneparamData) SetData(v []DataInnerDnsZoneparamData) {
	o.Data = v
}

func (o DnsZoneparamData) MarshalJSON() ([]byte, error) {
...
func (o DnsZoneparamData) ToMap() (map[string]interface{}, error) {
...
type NullableDnsZoneparamData struct {
	value *DnsZoneparamData
	isSet bool
}

func (v NullableDnsZoneparamData) Get() *DnsZoneparamData {
	return v.value
}

func (v *NullableDnsZoneparamData) Set(val *DnsZoneparamData) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsZoneparamData) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsZoneparamData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsZoneparamData(val *DnsZoneparamData) *NullableDnsZoneparamData {
	return &NullableDnsZoneparamData{value: val, isSet: true}
}

func (v NullableDnsZoneparamData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsZoneparamData) UnmarshalJSON(src []byte) error {
	v.isSet = true
