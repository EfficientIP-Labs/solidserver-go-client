...
type DnsZoneparamData struct {
	...
	Data *[]DnsZoneparamDataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DnsZoneparamDataData and assigns it to the Data field.
