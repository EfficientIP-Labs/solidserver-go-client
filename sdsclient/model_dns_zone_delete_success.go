...
// checks if the DnsZoneDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneDeleteSuccess{}
...
type DnsZoneDeleteSuccess struct {
	...
	Data     []DataInnerDnsZoneDeleteSuccess `json:"data,omitempty"`
}
...
func (o *DnsZoneDeleteSuccess) GetData() []DataInnerDnsZoneDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsZoneDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsZoneDeleteSuccess and assigns it to the Data field.
...
func (o DnsZoneDeleteSuccess) ToMap() (map[string]interface{}, error) {
