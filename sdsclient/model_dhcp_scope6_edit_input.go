...
// checks if the DhcpScope6EditInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpScope6EditInput{}

// DhcpScope6EditInput struct for DhcpScope6EditInput
type DhcpScope6EditInput struct {
...
func (o *DhcpScope6EditInput) GetScope6EndAddr() string {
	if o == nil || IsNil(o.Scope6EndAddr) {
		var ret string
		return ret
	}
...
func (o *DhcpScope6EditInput) GetScope6StartAddr() string {
	if o == nil || IsNil(o.Scope6StartAddr) {
		var ret string
		return ret
	}
...
func (o DhcpScope6EditInput) MarshalJSON() ([]byte, error) {
...
func (o DhcpScope6EditInput) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpScope6EditInput struct {
	value *DhcpScope6EditInput
	isSet bool
}

func (v NullableDhcpScope6EditInput) Get() *DhcpScope6EditInput {
	return v.value
}

func (v *NullableDhcpScope6EditInput) Set(val *DhcpScope6EditInput) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpScope6EditInput) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpScope6EditInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpScope6EditInput(val *DhcpScope6EditInput) *NullableDhcpScope6EditInput {
	return &NullableDhcpScope6EditInput{value: val, isSet: true}
}

func (v NullableDhcpScope6EditInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpScope6EditInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
