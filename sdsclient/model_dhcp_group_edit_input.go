...
// checks if the DhcpGroupEditInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpGroupEditInput{}
...
func (o DhcpGroupEditInput) ToMap() (map[string]interface{}, error) {
