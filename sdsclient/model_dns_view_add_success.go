...
type DnsViewAddSuccess struct {
	...
	Data *[]DnsViewAddSuccessData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DnsViewAddSuccessData and assigns it to the Data field.
