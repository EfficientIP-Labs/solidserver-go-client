...
// checks if the DhcpStatic6EditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStatic6EditSuccess{}

// DhcpStatic6EditSuccess struct for DhcpStatic6EditSuccess
type DhcpStatic6EditSuccess struct {
	...
	Data     []DataInnerDhcpStatic6EditSuccess `json:"data,omitempty"`
}
...
func (o *DhcpStatic6EditSuccess) GetData() []DataInnerDhcpStatic6EditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpStatic6EditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpStatic6EditSuccess and assigns it to the Data field.
func (o *DhcpStatic6EditSuccess) SetData(v []DataInnerDhcpStatic6EditSuccess) {
	o.Data = v
}

func (o DhcpStatic6EditSuccess) MarshalJSON() ([]byte, error) {
...
func (o DhcpStatic6EditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpStatic6EditSuccess struct {
	value *DhcpStatic6EditSuccess
	isSet bool
}

func (v NullableDhcpStatic6EditSuccess) Get() *DhcpStatic6EditSuccess {
	return v.value
}

func (v *NullableDhcpStatic6EditSuccess) Set(val *DhcpStatic6EditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpStatic6EditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpStatic6EditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpStatic6EditSuccess(val *DhcpStatic6EditSuccess) *NullableDhcpStatic6EditSuccess {
	return &NullableDhcpStatic6EditSuccess{value: val, isSet: true}
}

func (v NullableDhcpStatic6EditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpStatic6EditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
