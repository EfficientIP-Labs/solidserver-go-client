...
type DhcpScopeData struct {
	...
	Data *[]DhcpScopeDataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DhcpScopeDataData and assigns it to the Data field.
