...
// checks if the AppPoolAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPoolAddFailed{}

// AppPoolAddFailed struct for AppPoolAddFailed
type AppPoolAddFailed struct {
...
func (o AppPoolAddFailed) MarshalJSON() ([]byte, error) {
...
func (o AppPoolAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableAppPoolAddFailed struct {
	value *AppPoolAddFailed
	isSet bool
}

func (v NullableAppPoolAddFailed) Get() *AppPoolAddFailed {
	return v.value
}

func (v *NullableAppPoolAddFailed) Set(val *AppPoolAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPoolAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPoolAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPoolAddFailed(val *AppPoolAddFailed) *NullableAppPoolAddFailed {
	return &NullableAppPoolAddFailed{value: val, isSet: true}
}

func (v NullableAppPoolAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPoolAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
