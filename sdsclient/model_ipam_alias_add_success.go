...
// checks if the IpamAliasAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAliasAddSuccess{}
...
type IpamAliasAddSuccess struct {
	...
	Data     []DataInnerIpamAliasAddSuccess `json:"data,omitempty"`
}
...
func (o *IpamAliasAddSuccess) GetData() []DataInnerIpamAliasAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamAliasAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamAliasAddSuccess and assigns it to the Data field.
...
func (o IpamAliasAddSuccess) ToMap() (map[string]interface{}, error) {
