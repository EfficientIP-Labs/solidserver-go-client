...
// checks if the IpamAlias6AddInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAlias6AddInput{}
...
func (o IpamAlias6AddInput) ToMap() (map[string]interface{}, error) {
