...
// checks if the DhcpStaticDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStaticDeleteSuccess{}

// DhcpStaticDeleteSuccess struct for DhcpStaticDeleteSuccess
type DhcpStaticDeleteSuccess struct {
	...
	Data     []DataInnerDhcpStaticDeleteSuccess `json:"data,omitempty"`
}
...
func (o *DhcpStaticDeleteSuccess) GetData() []DataInnerDhcpStaticDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpStaticDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpStaticDeleteSuccess and assigns it to the Data field.
func (o *DhcpStaticDeleteSuccess) SetData(v []DataInnerDhcpStaticDeleteSuccess) {
	o.Data = v
}

func (o DhcpStaticDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o DhcpStaticDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpStaticDeleteSuccess struct {
	value *DhcpStaticDeleteSuccess
	isSet bool
}

func (v NullableDhcpStaticDeleteSuccess) Get() *DhcpStaticDeleteSuccess {
	return v.value
}

func (v *NullableDhcpStaticDeleteSuccess) Set(val *DhcpStaticDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpStaticDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpStaticDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpStaticDeleteSuccess(val *DhcpStaticDeleteSuccess) *NullableDhcpStaticDeleteSuccess {
	return &NullableDhcpStaticDeleteSuccess{value: val, isSet: true}
}

func (v NullableDhcpStaticDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpStaticDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
