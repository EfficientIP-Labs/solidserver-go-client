...
// checks if the DnsViewparamDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsViewparamDeleteSuccess{}

// DnsViewparamDeleteSuccess struct for DnsViewparamDeleteSuccess
type DnsViewparamDeleteSuccess struct {
	...
	Data     []DataInnerDnsViewparamDeleteSuccess `json:"data,omitempty"`
}
...
func NewDnsViewparamDeleteSuccess() *DnsViewparamDeleteSuccess {
	this := DnsViewparamDeleteSuccess{}
	return &this
}
...
func (o *DnsViewparamDeleteSuccess) GetData() []DataInnerDnsViewparamDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsViewparamDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsViewparamDeleteSuccess and assigns it to the Data field.
func (o *DnsViewparamDeleteSuccess) SetData(v []DataInnerDnsViewparamDeleteSuccess) {
	o.Data = v
}

func (o DnsViewparamDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o DnsViewparamDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDnsViewparamDeleteSuccess struct {
	value *DnsViewparamDeleteSuccess
	isSet bool
}

func (v NullableDnsViewparamDeleteSuccess) Get() *DnsViewparamDeleteSuccess {
	return v.value
}

func (v *NullableDnsViewparamDeleteSuccess) Set(val *DnsViewparamDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsViewparamDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsViewparamDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsViewparamDeleteSuccess(val *DnsViewparamDeleteSuccess) *NullableDnsViewparamDeleteSuccess {
	return &NullableDnsViewparamDeleteSuccess{value: val, isSet: true}
}

func (v NullableDnsViewparamDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsViewparamDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
