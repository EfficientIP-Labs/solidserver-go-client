...
type DnsViewparamDeleteSuccess struct {
	...
	Data *[]DnsViewparamDeleteSuccessData `json:"data,omitempty"`
}
...
func (o *DnsViewparamDeleteSuccess) GetData() []DnsViewparamDeleteSuccessData {
	if o == nil || o.Data == nil {
		var ret []DnsViewparamDeleteSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DnsViewparamDeleteSuccessData and assigns it to the Data field.
