...
// checks if the DhcpAclData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpAclData{}

// DhcpAclData struct for DhcpAclData
type DhcpAclData struct {
	...
	Data     []DataInnerDhcpAclData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DataInnerDhcpAclData and assigns it to the Data field.
func (o *DhcpAclData) SetData(v []DataInnerDhcpAclData) {
	o.Data = v
}

func (o DhcpAclData) MarshalJSON() ([]byte, error) {
...
func (o DhcpAclData) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpAclData struct {
	value *DhcpAclData
	isSet bool
}

func (v NullableDhcpAclData) Get() *DhcpAclData {
	return v.value
}

func (v *NullableDhcpAclData) Set(val *DhcpAclData) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpAclData) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpAclData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpAclData(val *DhcpAclData) *NullableDhcpAclData {
	return &NullableDhcpAclData{value: val, isSet: true}
}

func (v NullableDhcpAclData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpAclData) UnmarshalJSON(src []byte) error {
	v.isSet = true
