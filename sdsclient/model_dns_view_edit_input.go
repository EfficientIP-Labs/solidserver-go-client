...
type DnsViewEditInput struct {
	...
	// The database identifier (ID) of the DNS view, a unique numeric key value automatically incremented when you add a DNS view. Use the ID to specify which DNS view to edit.
