...
// checks if the VlanDomainEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanDomainEditFailed{}

// VlanDomainEditFailed struct for VlanDomainEditFailed
type VlanDomainEditFailed struct {
...
func (o VlanDomainEditFailed) MarshalJSON() ([]byte, error) {
...
func (o VlanDomainEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableVlanDomainEditFailed struct {
	value *VlanDomainEditFailed
	isSet bool
}

func (v NullableVlanDomainEditFailed) Get() *VlanDomainEditFailed {
	return v.value
}

func (v *NullableVlanDomainEditFailed) Set(val *VlanDomainEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanDomainEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanDomainEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanDomainEditFailed(val *VlanDomainEditFailed) *NullableVlanDomainEditFailed {
	return &NullableVlanDomainEditFailed{value: val, isSet: true}
}

func (v NullableVlanDomainEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanDomainEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
