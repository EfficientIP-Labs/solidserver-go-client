...
// checks if the DhcpSharednetwork6AddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpSharednetwork6AddFailed{}

// DhcpSharednetwork6AddFailed struct for DhcpSharednetwork6AddFailed
type DhcpSharednetwork6AddFailed struct {
...
func NewDhcpSharednetwork6AddFailed() *DhcpSharednetwork6AddFailed {
	this := DhcpSharednetwork6AddFailed{}
	return &this
}
...
func (o DhcpSharednetwork6AddFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpSharednetwork6AddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpSharednetwork6AddFailed struct {
	value *DhcpSharednetwork6AddFailed
	isSet bool
}

func (v NullableDhcpSharednetwork6AddFailed) Get() *DhcpSharednetwork6AddFailed {
	return v.value
}

func (v *NullableDhcpSharednetwork6AddFailed) Set(val *DhcpSharednetwork6AddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpSharednetwork6AddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpSharednetwork6AddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpSharednetwork6AddFailed(val *DhcpSharednetwork6AddFailed) *NullableDhcpSharednetwork6AddFailed {
	return &NullableDhcpSharednetwork6AddFailed{value: val, isSet: true}
}

func (v NullableDhcpSharednetwork6AddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpSharednetwork6AddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
