...
// checks if the DnsRrEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsRrEditFailed{}

// DnsRrEditFailed struct for DnsRrEditFailed
type DnsRrEditFailed struct {
...
func (o DnsRrEditFailed) MarshalJSON() ([]byte, error) {
...
func (o DnsRrEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDnsRrEditFailed struct {
	value *DnsRrEditFailed
	isSet bool
}

func (v NullableDnsRrEditFailed) Get() *DnsRrEditFailed {
	return v.value
}

func (v *NullableDnsRrEditFailed) Set(val *DnsRrEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsRrEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsRrEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsRrEditFailed(val *DnsRrEditFailed) *NullableDnsRrEditFailed {
	return &NullableDnsRrEditFailed{value: val, isSet: true}
}

func (v NullableDnsRrEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsRrEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
