...
// checks if the IpamAlias6EditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAlias6EditSuccess{}

// IpamAlias6EditSuccess struct for IpamAlias6EditSuccess
type IpamAlias6EditSuccess struct {
	...
	Data     []DataInnerIpamAlias6EditSuccess `json:"data,omitempty"`
}
...
func (o *IpamAlias6EditSuccess) GetData() []DataInnerIpamAlias6EditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamAlias6EditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamAlias6EditSuccess and assigns it to the Data field.
func (o *IpamAlias6EditSuccess) SetData(v []DataInnerIpamAlias6EditSuccess) {
	o.Data = v
}

func (o IpamAlias6EditSuccess) MarshalJSON() ([]byte, error) {
...
func (o IpamAlias6EditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAlias6EditSuccess struct {
	value *IpamAlias6EditSuccess
	isSet bool
}

func (v NullableIpamAlias6EditSuccess) Get() *IpamAlias6EditSuccess {
	return v.value
}

func (v *NullableIpamAlias6EditSuccess) Set(val *IpamAlias6EditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAlias6EditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAlias6EditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAlias6EditSuccess(val *IpamAlias6EditSuccess) *NullableIpamAlias6EditSuccess {
	return &NullableIpamAlias6EditSuccess{value: val, isSet: true}
}

func (v NullableIpamAlias6EditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAlias6EditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
