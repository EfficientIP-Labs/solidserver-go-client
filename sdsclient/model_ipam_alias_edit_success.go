...
// checks if the IpamAliasEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAliasEditSuccess{}

// IpamAliasEditSuccess struct for IpamAliasEditSuccess
type IpamAliasEditSuccess struct {
	...
	Data     []DataInnerIpamAliasEditSuccess `json:"data,omitempty"`
}
...
func (o *IpamAliasEditSuccess) GetData() []DataInnerIpamAliasEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamAliasEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamAliasEditSuccess and assigns it to the Data field.
func (o *IpamAliasEditSuccess) SetData(v []DataInnerIpamAliasEditSuccess) {
	o.Data = v
}

func (o IpamAliasEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o IpamAliasEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAliasEditSuccess struct {
	value *IpamAliasEditSuccess
	isSet bool
}

func (v NullableIpamAliasEditSuccess) Get() *IpamAliasEditSuccess {
	return v.value
}

func (v *NullableIpamAliasEditSuccess) Set(val *IpamAliasEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAliasEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAliasEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAliasEditSuccess(val *IpamAliasEditSuccess) *NullableIpamAliasEditSuccess {
	return &NullableIpamAliasEditSuccess{value: val, isSet: true}
}

func (v NullableIpamAliasEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAliasEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
