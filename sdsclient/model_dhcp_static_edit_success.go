...
// checks if the DhcpStaticEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStaticEditSuccess{}

// DhcpStaticEditSuccess struct for DhcpStaticEditSuccess
type DhcpStaticEditSuccess struct {
	...
	Data     []DataInnerDhcpStaticEditSuccess `json:"data,omitempty"`
}
...
func (o *DhcpStaticEditSuccess) GetData() []DataInnerDhcpStaticEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpStaticEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpStaticEditSuccess and assigns it to the Data field.
func (o *DhcpStaticEditSuccess) SetData(v []DataInnerDhcpStaticEditSuccess) {
	o.Data = v
}

func (o DhcpStaticEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o DhcpStaticEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpStaticEditSuccess struct {
	value *DhcpStaticEditSuccess
	isSet bool
}

func (v NullableDhcpStaticEditSuccess) Get() *DhcpStaticEditSuccess {
	return v.value
}

func (v *NullableDhcpStaticEditSuccess) Set(val *DhcpStaticEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpStaticEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpStaticEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpStaticEditSuccess(val *DhcpStaticEditSuccess) *NullableDhcpStaticEditSuccess {
	return &NullableDhcpStaticEditSuccess{value: val, isSet: true}
}

func (v NullableDhcpStaticEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpStaticEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
