...
// checks if the AppApplicationAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppApplicationAddSuccess{}

// AppApplicationAddSuccess struct for AppApplicationAddSuccess
type AppApplicationAddSuccess struct {
	...
	Data     []DataInnerAppApplicationAddSuccess `json:"data,omitempty"`
}
...
func (o *AppApplicationAddSuccess) GetData() []DataInnerAppApplicationAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerAppApplicationAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerAppApplicationAddSuccess and assigns it to the Data field.
func (o *AppApplicationAddSuccess) SetData(v []DataInnerAppApplicationAddSuccess) {
	o.Data = v
}

func (o AppApplicationAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o AppApplicationAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableAppApplicationAddSuccess struct {
	value *AppApplicationAddSuccess
	isSet bool
}

func (v NullableAppApplicationAddSuccess) Get() *AppApplicationAddSuccess {
	return v.value
}

func (v *NullableAppApplicationAddSuccess) Set(val *AppApplicationAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableAppApplicationAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableAppApplicationAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppApplicationAddSuccess(val *AppApplicationAddSuccess) *NullableAppApplicationAddSuccess {
	return &NullableAppApplicationAddSuccess{value: val, isSet: true}
}

func (v NullableAppApplicationAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppApplicationAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
