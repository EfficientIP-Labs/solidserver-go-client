...
type AppApplicationAddSuccess struct {
	...
	Data *[]AppApplicationAddSuccessData `json:"data,omitempty"`
}
...
func (o *AppApplicationAddSuccess) GetData() []AppApplicationAddSuccessData {
	if o == nil || o.Data == nil {
		var ret []AppApplicationAddSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []AppApplicationAddSuccessData and assigns it to the Data field.
