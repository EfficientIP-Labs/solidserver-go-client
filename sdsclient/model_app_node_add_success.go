...
type AppNodeAddSuccess struct {
	...
	Data *[]AppNodeAddSuccessData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []AppNodeAddSuccessData and assigns it to the Data field.
