...
// checks if the AppNodeAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppNodeAddSuccess{}

// AppNodeAddSuccess struct for AppNodeAddSuccess
type AppNodeAddSuccess struct {
	...
	Data     []DataInnerAppNodeAddSuccess `json:"data,omitempty"`
}
...
func (o *AppNodeAddSuccess) GetData() []DataInnerAppNodeAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerAppNodeAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerAppNodeAddSuccess and assigns it to the Data field.
func (o *AppNodeAddSuccess) SetData(v []DataInnerAppNodeAddSuccess) {
	o.Data = v
}

func (o AppNodeAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o AppNodeAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableAppNodeAddSuccess struct {
	value *AppNodeAddSuccess
	isSet bool
}

func (v NullableAppNodeAddSuccess) Get() *AppNodeAddSuccess {
	return v.value
}

func (v *NullableAppNodeAddSuccess) Set(val *AppNodeAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableAppNodeAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableAppNodeAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppNodeAddSuccess(val *AppNodeAddSuccess) *NullableAppNodeAddSuccess {
	return &NullableAppNodeAddSuccess{value: val, isSet: true}
}

func (v NullableAppNodeAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppNodeAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
