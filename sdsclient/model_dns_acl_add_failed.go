...
// checks if the DnsAclAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsAclAddFailed{}

// DnsAclAddFailed struct for DnsAclAddFailed
type DnsAclAddFailed struct {
...
func (o DnsAclAddFailed) MarshalJSON() ([]byte, error) {
...
func (o DnsAclAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDnsAclAddFailed struct {
	value *DnsAclAddFailed
	isSet bool
}

func (v NullableDnsAclAddFailed) Get() *DnsAclAddFailed {
	return v.value
}

func (v *NullableDnsAclAddFailed) Set(val *DnsAclAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsAclAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsAclAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsAclAddFailed(val *DnsAclAddFailed) *NullableDnsAclAddFailed {
	return &NullableDnsAclAddFailed{value: val, isSet: true}
}

func (v NullableDnsAclAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsAclAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
