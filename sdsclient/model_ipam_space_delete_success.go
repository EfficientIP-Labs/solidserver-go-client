...
// checks if the IpamSpaceDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamSpaceDeleteSuccess{}
...
type IpamSpaceDeleteSuccess struct {
	...
	Data     []DataInnerIpamSpaceDeleteSuccess `json:"data,omitempty"`
}
...
func (o *IpamSpaceDeleteSuccess) GetData() []DataInnerIpamSpaceDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamSpaceDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamSpaceDeleteSuccess and assigns it to the Data field.
...
func (o IpamSpaceDeleteSuccess) ToMap() (map[string]interface{}, error) {
