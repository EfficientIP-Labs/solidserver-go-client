...
// checks if the DeviceInterfaceDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceInterfaceDeleteSuccess{}
...
type DeviceInterfaceDeleteSuccess struct {
	...
	Data     []DataInnerDeviceInterfaceDeleteSuccess `json:"data,omitempty"`
}
...
func (o *DeviceInterfaceDeleteSuccess) GetData() []DataInnerDeviceInterfaceDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDeviceInterfaceDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDeviceInterfaceDeleteSuccess and assigns it to the Data field.
...
func (o DeviceInterfaceDeleteSuccess) ToMap() (map[string]interface{}, error) {
