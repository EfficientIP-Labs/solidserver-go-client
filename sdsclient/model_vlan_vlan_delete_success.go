...
// checks if the VlanVlanDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanVlanDeleteSuccess{}

// VlanVlanDeleteSuccess struct for VlanVlanDeleteSuccess
type VlanVlanDeleteSuccess struct {
	...
	Data     []DataInnerVlanVlanDeleteSuccess `json:"data,omitempty"`
}
...
func (o *VlanVlanDeleteSuccess) GetData() []DataInnerVlanVlanDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerVlanVlanDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerVlanVlanDeleteSuccess and assigns it to the Data field.
func (o *VlanVlanDeleteSuccess) SetData(v []DataInnerVlanVlanDeleteSuccess) {
	o.Data = v
}

func (o VlanVlanDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o VlanVlanDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableVlanVlanDeleteSuccess struct {
	value *VlanVlanDeleteSuccess
	isSet bool
}

func (v NullableVlanVlanDeleteSuccess) Get() *VlanVlanDeleteSuccess {
	return v.value
}

func (v *NullableVlanVlanDeleteSuccess) Set(val *VlanVlanDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanVlanDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanVlanDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanVlanDeleteSuccess(val *VlanVlanDeleteSuccess) *NullableVlanVlanDeleteSuccess {
	return &NullableVlanVlanDeleteSuccess{value: val, isSet: true}
}

func (v NullableVlanVlanDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanVlanDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
