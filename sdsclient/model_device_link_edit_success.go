...
type DeviceLinkEditSuccess struct {
	...
	Data *[]DeviceLinkEditSuccessData `json:"data,omitempty"`
}
...
func (o *DeviceLinkEditSuccess) GetData() []DeviceLinkEditSuccessData {
	if o == nil || o.Data == nil {
		var ret []DeviceLinkEditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DeviceLinkEditSuccessData and assigns it to the Data field.
