...
// checks if the DeviceLinkEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceLinkEditSuccess{}

// DeviceLinkEditSuccess struct for DeviceLinkEditSuccess
type DeviceLinkEditSuccess struct {
	...
	Data     []DataInnerDeviceLinkEditSuccess `json:"data,omitempty"`
}
...
func (o *DeviceLinkEditSuccess) GetData() []DataInnerDeviceLinkEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDeviceLinkEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDeviceLinkEditSuccess and assigns it to the Data field.
func (o *DeviceLinkEditSuccess) SetData(v []DataInnerDeviceLinkEditSuccess) {
	o.Data = v
}

func (o DeviceLinkEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o DeviceLinkEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceLinkEditSuccess struct {
	value *DeviceLinkEditSuccess
	isSet bool
}

func (v NullableDeviceLinkEditSuccess) Get() *DeviceLinkEditSuccess {
	return v.value
}

func (v *NullableDeviceLinkEditSuccess) Set(val *DeviceLinkEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceLinkEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceLinkEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceLinkEditSuccess(val *DeviceLinkEditSuccess) *NullableDeviceLinkEditSuccess {
	return &NullableDeviceLinkEditSuccess{value: val, isSet: true}
}

func (v NullableDeviceLinkEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceLinkEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
