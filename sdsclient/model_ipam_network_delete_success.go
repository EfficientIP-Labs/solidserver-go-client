...
// checks if the IpamNetworkDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamNetworkDeleteSuccess{}

// IpamNetworkDeleteSuccess struct for IpamNetworkDeleteSuccess
type IpamNetworkDeleteSuccess struct {
	...
	Data     []DataInnerIpamNetworkDeleteSuccess `json:"data,omitempty"`
}
...
func (o *IpamNetworkDeleteSuccess) GetData() []DataInnerIpamNetworkDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamNetworkDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamNetworkDeleteSuccess and assigns it to the Data field.
func (o *IpamNetworkDeleteSuccess) SetData(v []DataInnerIpamNetworkDeleteSuccess) {
	o.Data = v
}

func (o IpamNetworkDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o IpamNetworkDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableIpamNetworkDeleteSuccess struct {
	value *IpamNetworkDeleteSuccess
	isSet bool
}

func (v NullableIpamNetworkDeleteSuccess) Get() *IpamNetworkDeleteSuccess {
	return v.value
}

func (v *NullableIpamNetworkDeleteSuccess) Set(val *IpamNetworkDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamNetworkDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamNetworkDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamNetworkDeleteSuccess(val *IpamNetworkDeleteSuccess) *NullableIpamNetworkDeleteSuccess {
	return &NullableIpamNetworkDeleteSuccess{value: val, isSet: true}
}

func (v NullableIpamNetworkDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamNetworkDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
