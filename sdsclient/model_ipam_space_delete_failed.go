...
// checks if the IpamSpaceDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamSpaceDeleteFailed{}

// IpamSpaceDeleteFailed struct for IpamSpaceDeleteFailed
type IpamSpaceDeleteFailed struct {
...
func (o IpamSpaceDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamSpaceDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamSpaceDeleteFailed struct {
	value *IpamSpaceDeleteFailed
	isSet bool
}

func (v NullableIpamSpaceDeleteFailed) Get() *IpamSpaceDeleteFailed {
	return v.value
}

func (v *NullableIpamSpaceDeleteFailed) Set(val *IpamSpaceDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamSpaceDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamSpaceDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamSpaceDeleteFailed(val *IpamSpaceDeleteFailed) *NullableIpamSpaceDeleteFailed {
	return &NullableIpamSpaceDeleteFailed{value: val, isSet: true}
}

func (v NullableIpamSpaceDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamSpaceDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
