...
// checks if the GuardianPolicyEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuardianPolicyEditSuccess{}

// GuardianPolicyEditSuccess struct for GuardianPolicyEditSuccess
type GuardianPolicyEditSuccess struct {
	...
	Data     []DataInnerGuardianPolicyEditSuccess `json:"data,omitempty"`
}
...
func NewGuardianPolicyEditSuccess() *GuardianPolicyEditSuccess {
	this := GuardianPolicyEditSuccess{}
	return &this
}
...
func (o *GuardianPolicyEditSuccess) GetData() []DataInnerGuardianPolicyEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerGuardianPolicyEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerGuardianPolicyEditSuccess and assigns it to the Data field.
func (o *GuardianPolicyEditSuccess) SetData(v []DataInnerGuardianPolicyEditSuccess) {
	o.Data = v
}

func (o GuardianPolicyEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o GuardianPolicyEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableGuardianPolicyEditSuccess struct {
	value *GuardianPolicyEditSuccess
	isSet bool
}

func (v NullableGuardianPolicyEditSuccess) Get() *GuardianPolicyEditSuccess {
	return v.value
}

func (v *NullableGuardianPolicyEditSuccess) Set(val *GuardianPolicyEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableGuardianPolicyEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableGuardianPolicyEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuardianPolicyEditSuccess(val *GuardianPolicyEditSuccess) *NullableGuardianPolicyEditSuccess {
	return &NullableGuardianPolicyEditSuccess{value: val, isSet: true}
}

func (v NullableGuardianPolicyEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuardianPolicyEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
