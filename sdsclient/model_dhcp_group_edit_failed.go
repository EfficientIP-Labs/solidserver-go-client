...
// checks if the DhcpGroupEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpGroupEditFailed{}

// DhcpGroupEditFailed struct for DhcpGroupEditFailed
type DhcpGroupEditFailed struct {
...
func (o DhcpGroupEditFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpGroupEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpGroupEditFailed struct {
	value *DhcpGroupEditFailed
	isSet bool
}

func (v NullableDhcpGroupEditFailed) Get() *DhcpGroupEditFailed {
	return v.value
}

func (v *NullableDhcpGroupEditFailed) Set(val *DhcpGroupEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpGroupEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpGroupEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpGroupEditFailed(val *DhcpGroupEditFailed) *NullableDhcpGroupEditFailed {
	return &NullableDhcpGroupEditFailed{value: val, isSet: true}
}

func (v NullableDhcpGroupEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpGroupEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
