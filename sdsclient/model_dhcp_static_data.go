...
// checks if the DhcpStaticData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStaticData{}
...
type DhcpStaticData struct {
	...
	Data     []DataInnerDhcpStaticData `json:"data,omitempty"`
}
...
func (o *DhcpStaticData) GetData() []DataInnerDhcpStaticData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpStaticData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpStaticData and assigns it to the Data field.
...
func (o DhcpStaticData) ToMap() (map[string]interface{}, error) {
