...
// checks if the DnsZoneAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneAddSuccess{}
...
type DnsZoneAddSuccess struct {
	...
	Data     []DataInnerDnsZoneAddSuccess `json:"data,omitempty"`
}
...
func (o *DnsZoneAddSuccess) GetData() []DataInnerDnsZoneAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsZoneAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsZoneAddSuccess and assigns it to the Data field.
...
func (o DnsZoneAddSuccess) ToMap() (map[string]interface{}, error) {
