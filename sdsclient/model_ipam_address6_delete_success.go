...
// checks if the IpamAddress6DeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAddress6DeleteSuccess{}
...
type IpamAddress6DeleteSuccess struct {
	...
	Data     []DataInnerIpamAddress6DeleteSuccess `json:"data,omitempty"`
}
...
func (o *IpamAddress6DeleteSuccess) GetData() []DataInnerIpamAddress6DeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamAddress6DeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamAddress6DeleteSuccess and assigns it to the Data field.
...
func (o IpamAddress6DeleteSuccess) ToMap() (map[string]interface{}, error) {
