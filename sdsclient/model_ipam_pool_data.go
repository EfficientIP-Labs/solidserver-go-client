...
// checks if the IpamPoolData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamPoolData{}
...
type IpamPoolData struct {
	...
	Data     []DataInnerIpamPoolData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DataInnerIpamPoolData and assigns it to the Data field.
...
func (o IpamPoolData) ToMap() (map[string]interface{}, error) {
