...
// checks if the DhcpRangeEditInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpRangeEditInput{}
...
func (o DhcpRangeEditInput) ToMap() (map[string]interface{}, error) {
