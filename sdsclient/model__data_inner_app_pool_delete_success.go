...
// checks if the DataInnerAppPoolDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerAppPoolDeleteSuccess{}

// DataInnerAppPoolDeleteSuccess struct for DataInnerAppPoolDeleteSuccess
type DataInnerAppPoolDeleteSuccess struct {
...
func NewDataInnerAppPoolDeleteSuccess() *DataInnerAppPoolDeleteSuccess {
	this := DataInnerAppPoolDeleteSuccess{}
	return &this
}
...
func (o DataInnerAppPoolDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerAppPoolDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerAppPoolDeleteSuccess struct {
	value *DataInnerAppPoolDeleteSuccess
	isSet bool
}

func (v NullableDataInnerAppPoolDeleteSuccess) Get() *DataInnerAppPoolDeleteSuccess {
	return v.value
}

func (v *NullableDataInnerAppPoolDeleteSuccess) Set(val *DataInnerAppPoolDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerAppPoolDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerAppPoolDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerAppPoolDeleteSuccess(val *DataInnerAppPoolDeleteSuccess) *NullableDataInnerAppPoolDeleteSuccess {
	return &NullableDataInnerAppPoolDeleteSuccess{value: val, isSet: true}
}

func (v NullableDataInnerAppPoolDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerAppPoolDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
