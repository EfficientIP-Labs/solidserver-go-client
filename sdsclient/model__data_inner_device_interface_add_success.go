...
// checks if the DataInnerDeviceInterfaceAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerDeviceInterfaceAddSuccess{}

// DataInnerDeviceInterfaceAddSuccess struct for DataInnerDeviceInterfaceAddSuccess
type DataInnerDeviceInterfaceAddSuccess struct {
...
func NewDataInnerDeviceInterfaceAddSuccess() *DataInnerDeviceInterfaceAddSuccess {
	this := DataInnerDeviceInterfaceAddSuccess{}
	return &this
}
...
func (o DataInnerDeviceInterfaceAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerDeviceInterfaceAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerDeviceInterfaceAddSuccess struct {
	value *DataInnerDeviceInterfaceAddSuccess
	isSet bool
}

func (v NullableDataInnerDeviceInterfaceAddSuccess) Get() *DataInnerDeviceInterfaceAddSuccess {
	return v.value
}

func (v *NullableDataInnerDeviceInterfaceAddSuccess) Set(val *DataInnerDeviceInterfaceAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerDeviceInterfaceAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerDeviceInterfaceAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerDeviceInterfaceAddSuccess(val *DataInnerDeviceInterfaceAddSuccess) *NullableDataInnerDeviceInterfaceAddSuccess {
	return &NullableDataInnerDeviceInterfaceAddSuccess{value: val, isSet: true}
}

func (v NullableDataInnerDeviceInterfaceAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerDeviceInterfaceAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
