...
// checks if the DhcpAclentry6Data type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpAclentry6Data{}

// DhcpAclentry6Data struct for DhcpAclentry6Data
type DhcpAclentry6Data struct {
	...
	Data     []DataInnerDhcpAclentry6Data `json:"data,omitempty"`
}
...
func (o *DhcpAclentry6Data) GetData() []DataInnerDhcpAclentry6Data {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpAclentry6Data
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpAclentry6Data and assigns it to the Data field.
func (o *DhcpAclentry6Data) SetData(v []DataInnerDhcpAclentry6Data) {
	o.Data = v
}

func (o DhcpAclentry6Data) MarshalJSON() ([]byte, error) {
...
func (o DhcpAclentry6Data) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpAclentry6Data struct {
	value *DhcpAclentry6Data
	isSet bool
}

func (v NullableDhcpAclentry6Data) Get() *DhcpAclentry6Data {
	return v.value
}

func (v *NullableDhcpAclentry6Data) Set(val *DhcpAclentry6Data) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpAclentry6Data) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpAclentry6Data) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpAclentry6Data(val *DhcpAclentry6Data) *NullableDhcpAclentry6Data {
	return &NullableDhcpAclentry6Data{value: val, isSet: true}
}

func (v NullableDhcpAclentry6Data) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpAclentry6Data) UnmarshalJSON(src []byte) error {
	v.isSet = true
