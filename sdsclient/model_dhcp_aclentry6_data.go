...
type DhcpAclentry6Data struct {
	...
	Data *[]DhcpAclentry6DataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DhcpAclentry6DataData and assigns it to the Data field.
