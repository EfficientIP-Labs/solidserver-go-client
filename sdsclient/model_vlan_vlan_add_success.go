...
// checks if the VlanVlanAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanVlanAddSuccess{}
...
type VlanVlanAddSuccess struct {
	...
	Data     []DataInnerVlanVlanAddSuccess `json:"data,omitempty"`
}
...
func (o *VlanVlanAddSuccess) GetData() []DataInnerVlanVlanAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerVlanVlanAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerVlanVlanAddSuccess and assigns it to the Data field.
...
func (o VlanVlanAddSuccess) ToMap() (map[string]interface{}, error) {
