...
// checks if the DeviceDeviceAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceDeviceAddSuccess{}

// DeviceDeviceAddSuccess struct for DeviceDeviceAddSuccess
type DeviceDeviceAddSuccess struct {
	...
	Data     []DataInnerDeviceDeviceAddSuccess `json:"data,omitempty"`
}
...
func (o *DeviceDeviceAddSuccess) GetData() []DataInnerDeviceDeviceAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDeviceDeviceAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDeviceDeviceAddSuccess and assigns it to the Data field.
func (o *DeviceDeviceAddSuccess) SetData(v []DataInnerDeviceDeviceAddSuccess) {
	o.Data = v
}

func (o DeviceDeviceAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DeviceDeviceAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceDeviceAddSuccess struct {
	value *DeviceDeviceAddSuccess
	isSet bool
}

func (v NullableDeviceDeviceAddSuccess) Get() *DeviceDeviceAddSuccess {
	return v.value
}

func (v *NullableDeviceDeviceAddSuccess) Set(val *DeviceDeviceAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceDeviceAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceDeviceAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceDeviceAddSuccess(val *DeviceDeviceAddSuccess) *NullableDeviceDeviceAddSuccess {
	return &NullableDeviceDeviceAddSuccess{value: val, isSet: true}
}

func (v NullableDeviceDeviceAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceDeviceAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
