...
// checks if the AppNodeEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppNodeEditFailed{}

// AppNodeEditFailed struct for AppNodeEditFailed
type AppNodeEditFailed struct {
...
func (o AppNodeEditFailed) MarshalJSON() ([]byte, error) {
...
func (o AppNodeEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableAppNodeEditFailed struct {
	value *AppNodeEditFailed
	isSet bool
}

func (v NullableAppNodeEditFailed) Get() *AppNodeEditFailed {
	return v.value
}

func (v *NullableAppNodeEditFailed) Set(val *AppNodeEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableAppNodeEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableAppNodeEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppNodeEditFailed(val *AppNodeEditFailed) *NullableAppNodeEditFailed {
	return &NullableAppNodeEditFailed{value: val, isSet: true}
}

func (v NullableAppNodeEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppNodeEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
