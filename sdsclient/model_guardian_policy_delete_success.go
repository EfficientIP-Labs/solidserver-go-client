...
// checks if the GuardianPolicyDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuardianPolicyDeleteSuccess{}
...
type GuardianPolicyDeleteSuccess struct {
	...
	Data     []DataInnerGuardianPolicyDeleteSuccess `json:"data,omitempty"`
}
...
func (o *GuardianPolicyDeleteSuccess) GetData() []DataInnerGuardianPolicyDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerGuardianPolicyDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerGuardianPolicyDeleteSuccess and assigns it to the Data field.
...
func (o GuardianPolicyDeleteSuccess) ToMap() (map[string]interface{}, error) {
