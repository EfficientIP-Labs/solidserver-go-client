...
// checks if the VlanRangeEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanRangeEditFailed{}
...
func (o VlanRangeEditFailed) ToMap() (map[string]interface{}, error) {
