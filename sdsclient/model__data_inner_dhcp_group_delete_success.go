...
// checks if the DataInnerDhcpGroupDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerDhcpGroupDeleteSuccess{}

// DataInnerDhcpGroupDeleteSuccess struct for DataInnerDhcpGroupDeleteSuccess
type DataInnerDhcpGroupDeleteSuccess struct {
...
func NewDataInnerDhcpGroupDeleteSuccess() *DataInnerDhcpGroupDeleteSuccess {
	this := DataInnerDhcpGroupDeleteSuccess{}
	return &this
}
...
func (o DataInnerDhcpGroupDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerDhcpGroupDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerDhcpGroupDeleteSuccess struct {
	value *DataInnerDhcpGroupDeleteSuccess
	isSet bool
}

func (v NullableDataInnerDhcpGroupDeleteSuccess) Get() *DataInnerDhcpGroupDeleteSuccess {
	return v.value
}

func (v *NullableDataInnerDhcpGroupDeleteSuccess) Set(val *DataInnerDhcpGroupDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerDhcpGroupDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerDhcpGroupDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerDhcpGroupDeleteSuccess(val *DataInnerDhcpGroupDeleteSuccess) *NullableDataInnerDhcpGroupDeleteSuccess {
	return &NullableDataInnerDhcpGroupDeleteSuccess{value: val, isSet: true}
}

func (v NullableDataInnerDhcpGroupDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerDhcpGroupDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
