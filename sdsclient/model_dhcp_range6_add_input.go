...
// checks if the DhcpRange6AddInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpRange6AddInput{}
...
func (o DhcpRange6AddInput) ToMap() (map[string]interface{}, error) {
