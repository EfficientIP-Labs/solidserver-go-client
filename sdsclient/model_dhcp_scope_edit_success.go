...
type DhcpScopeEditSuccess struct {
	...
	Data *[]DhcpScopeEditSuccessData `json:"data,omitempty"`
}
...
func (o *DhcpScopeEditSuccess) GetData() []DhcpScopeEditSuccessData {
	if o == nil || o.Data == nil {
		var ret []DhcpScopeEditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DhcpScopeEditSuccessData and assigns it to the Data field.
