...
// checks if the DhcpRange6AddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpRange6AddSuccess{}
...
type DhcpRange6AddSuccess struct {
	...
	Data     []DataInnerDhcpRange6AddSuccess `json:"data,omitempty"`
}
...
func (o *DhcpRange6AddSuccess) GetData() []DataInnerDhcpRange6AddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpRange6AddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpRange6AddSuccess and assigns it to the Data field.
...
func (o DhcpRange6AddSuccess) ToMap() (map[string]interface{}, error) {
