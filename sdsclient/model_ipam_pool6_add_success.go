...
// checks if the IpamPool6AddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamPool6AddSuccess{}

// IpamPool6AddSuccess struct for IpamPool6AddSuccess
type IpamPool6AddSuccess struct {
	...
	Data     []DataInnerIpamPool6AddSuccess `json:"data,omitempty"`
}
...
func (o *IpamPool6AddSuccess) GetData() []DataInnerIpamPool6AddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamPool6AddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamPool6AddSuccess and assigns it to the Data field.
func (o *IpamPool6AddSuccess) SetData(v []DataInnerIpamPool6AddSuccess) {
	o.Data = v
}

func (o IpamPool6AddSuccess) MarshalJSON() ([]byte, error) {
...
func (o IpamPool6AddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableIpamPool6AddSuccess struct {
	value *IpamPool6AddSuccess
	isSet bool
}

func (v NullableIpamPool6AddSuccess) Get() *IpamPool6AddSuccess {
	return v.value
}

func (v *NullableIpamPool6AddSuccess) Set(val *IpamPool6AddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamPool6AddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamPool6AddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamPool6AddSuccess(val *IpamPool6AddSuccess) *NullableIpamPool6AddSuccess {
	return &NullableIpamPool6AddSuccess{value: val, isSet: true}
}

func (v NullableIpamPool6AddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamPool6AddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
