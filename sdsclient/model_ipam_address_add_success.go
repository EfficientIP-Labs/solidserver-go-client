...
type IpamAddressAddSuccess struct {
	...
	Data *[]IpamAddressAddSuccessData `json:"data,omitempty"`
}
...
func (o *IpamAddressAddSuccess) GetData() []IpamAddressAddSuccessData {
	if o == nil || o.Data == nil {
		var ret []IpamAddressAddSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []IpamAddressAddSuccessData and assigns it to the Data field.
