...
// checks if the IpamAddressAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAddressAddSuccess{}

// IpamAddressAddSuccess struct for IpamAddressAddSuccess
type IpamAddressAddSuccess struct {
	...
	Data     []DataInnerIpamAddressAddSuccess `json:"data,omitempty"`
}
...
func (o *IpamAddressAddSuccess) GetData() []DataInnerIpamAddressAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamAddressAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamAddressAddSuccess and assigns it to the Data field.
func (o *IpamAddressAddSuccess) SetData(v []DataInnerIpamAddressAddSuccess) {
	o.Data = v
}

func (o IpamAddressAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o IpamAddressAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAddressAddSuccess struct {
	value *IpamAddressAddSuccess
	isSet bool
}

func (v NullableIpamAddressAddSuccess) Get() *IpamAddressAddSuccess {
	return v.value
}

func (v *NullableIpamAddressAddSuccess) Set(val *IpamAddressAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAddressAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAddressAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAddressAddSuccess(val *IpamAddressAddSuccess) *NullableIpamAddressAddSuccess {
	return &NullableIpamAddressAddSuccess{value: val, isSet: true}
}

func (v NullableIpamAddressAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAddressAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
