...
// checks if the DnsViewparamDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsViewparamDeleteFailed{}

// DnsViewparamDeleteFailed struct for DnsViewparamDeleteFailed
type DnsViewparamDeleteFailed struct {
...
func (o DnsViewparamDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o DnsViewparamDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDnsViewparamDeleteFailed struct {
	value *DnsViewparamDeleteFailed
	isSet bool
}

func (v NullableDnsViewparamDeleteFailed) Get() *DnsViewparamDeleteFailed {
	return v.value
}

func (v *NullableDnsViewparamDeleteFailed) Set(val *DnsViewparamDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsViewparamDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsViewparamDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsViewparamDeleteFailed(val *DnsViewparamDeleteFailed) *NullableDnsViewparamDeleteFailed {
	return &NullableDnsViewparamDeleteFailed{value: val, isSet: true}
}

func (v NullableDnsViewparamDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsViewparamDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
