...
// checks if the DnsServerData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsServerData{}

// DnsServerData struct for DnsServerData
type DnsServerData struct {
	...
	Data     []DataInnerDnsServerData `json:"data,omitempty"`
}
...
func (o *DnsServerData) GetData() []DataInnerDnsServerData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsServerData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsServerData and assigns it to the Data field.
func (o *DnsServerData) SetData(v []DataInnerDnsServerData) {
	o.Data = v
}

func (o DnsServerData) MarshalJSON() ([]byte, error) {
...
func (o DnsServerData) ToMap() (map[string]interface{}, error) {
...
type NullableDnsServerData struct {
	value *DnsServerData
	isSet bool
}

func (v NullableDnsServerData) Get() *DnsServerData {
	return v.value
}

func (v *NullableDnsServerData) Set(val *DnsServerData) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsServerData) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsServerData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsServerData(val *DnsServerData) *NullableDnsServerData {
	return &NullableDnsServerData{value: val, isSet: true}
}

func (v NullableDnsServerData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsServerData) UnmarshalJSON(src []byte) error {
	v.isSet = true
