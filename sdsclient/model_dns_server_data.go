...
type DnsServerData struct {
	...
	Data *[]DnsServerDataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DnsServerDataData and assigns it to the Data field.
