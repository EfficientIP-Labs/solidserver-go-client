...
// checks if the DhcpScopeEditInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpScopeEditInput{}
...
func (o DhcpScopeEditInput) ToMap() (map[string]interface{}, error) {
