...
// checks if the DataInnerIpamPool6AddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerIpamPool6AddSuccess{}

// DataInnerIpamPool6AddSuccess struct for DataInnerIpamPool6AddSuccess
type DataInnerIpamPool6AddSuccess struct {
...
func NewDataInnerIpamPool6AddSuccess() *DataInnerIpamPool6AddSuccess {
	this := DataInnerIpamPool6AddSuccess{}
	return &this
}
...
func (o DataInnerIpamPool6AddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerIpamPool6AddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerIpamPool6AddSuccess struct {
	value *DataInnerIpamPool6AddSuccess
	isSet bool
}

func (v NullableDataInnerIpamPool6AddSuccess) Get() *DataInnerIpamPool6AddSuccess {
	return v.value
}

func (v *NullableDataInnerIpamPool6AddSuccess) Set(val *DataInnerIpamPool6AddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerIpamPool6AddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerIpamPool6AddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerIpamPool6AddSuccess(val *DataInnerIpamPool6AddSuccess) *NullableDataInnerIpamPool6AddSuccess {
	return &NullableDataInnerIpamPool6AddSuccess{value: val, isSet: true}
}

func (v NullableDataInnerIpamPool6AddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerIpamPool6AddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
