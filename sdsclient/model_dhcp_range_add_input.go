...
// checks if the DhcpRangeAddInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpRangeAddInput{}
...
func (o DhcpRangeAddInput) ToMap() (map[string]interface{}, error) {
