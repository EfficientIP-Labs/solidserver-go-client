...
// checks if the AppApplicationDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppApplicationDeleteFailed{}

// AppApplicationDeleteFailed struct for AppApplicationDeleteFailed
type AppApplicationDeleteFailed struct {
...
func NewAppApplicationDeleteFailed() *AppApplicationDeleteFailed {
	this := AppApplicationDeleteFailed{}
	return &this
}
...
func (o AppApplicationDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o AppApplicationDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableAppApplicationDeleteFailed struct {
	value *AppApplicationDeleteFailed
	isSet bool
}

func (v NullableAppApplicationDeleteFailed) Get() *AppApplicationDeleteFailed {
	return v.value
}

func (v *NullableAppApplicationDeleteFailed) Set(val *AppApplicationDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableAppApplicationDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableAppApplicationDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppApplicationDeleteFailed(val *AppApplicationDeleteFailed) *NullableAppApplicationDeleteFailed {
	return &NullableAppApplicationDeleteFailed{value: val, isSet: true}
}

func (v NullableAppApplicationDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppApplicationDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
