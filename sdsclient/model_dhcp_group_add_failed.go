...
// checks if the DhcpGroupAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpGroupAddFailed{}

// DhcpGroupAddFailed struct for DhcpGroupAddFailed
type DhcpGroupAddFailed struct {
...
func (o DhcpGroupAddFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpGroupAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpGroupAddFailed struct {
	value *DhcpGroupAddFailed
	isSet bool
}

func (v NullableDhcpGroupAddFailed) Get() *DhcpGroupAddFailed {
	return v.value
}

func (v *NullableDhcpGroupAddFailed) Set(val *DhcpGroupAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpGroupAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpGroupAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpGroupAddFailed(val *DhcpGroupAddFailed) *NullableDhcpGroupAddFailed {
	return &NullableDhcpGroupAddFailed{value: val, isSet: true}
}

func (v NullableDhcpGroupAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpGroupAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
