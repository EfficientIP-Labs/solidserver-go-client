...
// checks if the VlanDomainEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanDomainEditSuccess{}
...
type VlanDomainEditSuccess struct {
	...
	Data     []DataInnerVlanDomainEditSuccess `json:"data,omitempty"`
}
...
func (o *VlanDomainEditSuccess) GetData() []DataInnerVlanDomainEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerVlanDomainEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerVlanDomainEditSuccess and assigns it to the Data field.
...
func (o VlanDomainEditSuccess) ToMap() (map[string]interface{}, error) {
