...
// checks if the DnsAclAddInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsAclAddInput{}
...
func (o DnsAclAddInput) ToMap() (map[string]interface{}, error) {
