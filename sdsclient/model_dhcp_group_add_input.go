...
// checks if the DhcpGroupAddInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpGroupAddInput{}
...
func (o DhcpGroupAddInput) ToMap() (map[string]interface{}, error) {
