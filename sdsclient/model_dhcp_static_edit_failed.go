...
// checks if the DhcpStaticEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStaticEditFailed{}

// DhcpStaticEditFailed struct for DhcpStaticEditFailed
type DhcpStaticEditFailed struct {
...
func (o DhcpStaticEditFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpStaticEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpStaticEditFailed struct {
	value *DhcpStaticEditFailed
	isSet bool
}

func (v NullableDhcpStaticEditFailed) Get() *DhcpStaticEditFailed {
	return v.value
}

func (v *NullableDhcpStaticEditFailed) Set(val *DhcpStaticEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpStaticEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpStaticEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpStaticEditFailed(val *DhcpStaticEditFailed) *NullableDhcpStaticEditFailed {
	return &NullableDhcpStaticEditFailed{value: val, isSet: true}
}

func (v NullableDhcpStaticEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpStaticEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
