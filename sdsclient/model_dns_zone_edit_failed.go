...
// checks if the DnsZoneEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneEditFailed{}

// DnsZoneEditFailed struct for DnsZoneEditFailed
type DnsZoneEditFailed struct {
...
func (o DnsZoneEditFailed) MarshalJSON() ([]byte, error) {
...
func (o DnsZoneEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDnsZoneEditFailed struct {
	value *DnsZoneEditFailed
	isSet bool
}

func (v NullableDnsZoneEditFailed) Get() *DnsZoneEditFailed {
	return v.value
}

func (v *NullableDnsZoneEditFailed) Set(val *DnsZoneEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsZoneEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsZoneEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsZoneEditFailed(val *DnsZoneEditFailed) *NullableDnsZoneEditFailed {
	return &NullableDnsZoneEditFailed{value: val, isSet: true}
}

func (v NullableDnsZoneEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsZoneEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
