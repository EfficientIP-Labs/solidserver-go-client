...
// checks if the DnsZoneData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneData{}

// DnsZoneData struct for DnsZoneData
type DnsZoneData struct {
	...
	Data     []DataInnerDnsZoneData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DataInnerDnsZoneData and assigns it to the Data field.
func (o *DnsZoneData) SetData(v []DataInnerDnsZoneData) {
	o.Data = v
}

func (o DnsZoneData) MarshalJSON() ([]byte, error) {
...
func (o DnsZoneData) ToMap() (map[string]interface{}, error) {
...
type NullableDnsZoneData struct {
	value *DnsZoneData
	isSet bool
}

func (v NullableDnsZoneData) Get() *DnsZoneData {
	return v.value
}

func (v *NullableDnsZoneData) Set(val *DnsZoneData) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsZoneData) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsZoneData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsZoneData(val *DnsZoneData) *NullableDnsZoneData {
	return &NullableDnsZoneData{value: val, isSet: true}
}

func (v NullableDnsZoneData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsZoneData) UnmarshalJSON(src []byte) error {
	v.isSet = true
