...
// checks if the DhcpRange6EditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpRange6EditFailed{}

// DhcpRange6EditFailed struct for DhcpRange6EditFailed
type DhcpRange6EditFailed struct {
...
func (o DhcpRange6EditFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpRange6EditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpRange6EditFailed struct {
	value *DhcpRange6EditFailed
	isSet bool
}

func (v NullableDhcpRange6EditFailed) Get() *DhcpRange6EditFailed {
	return v.value
}

func (v *NullableDhcpRange6EditFailed) Set(val *DhcpRange6EditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpRange6EditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpRange6EditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpRange6EditFailed(val *DhcpRange6EditFailed) *NullableDhcpRange6EditFailed {
	return &NullableDhcpRange6EditFailed{value: val, isSet: true}
}

func (v NullableDhcpRange6EditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpRange6EditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
