...
// checks if the DhcpStaticEditInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStaticEditInput{}
...
func (o DhcpStaticEditInput) ToMap() (map[string]interface{}, error) {
