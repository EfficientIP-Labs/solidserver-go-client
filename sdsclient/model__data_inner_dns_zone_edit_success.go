...
// checks if the DataInnerDnsZoneEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerDnsZoneEditSuccess{}

// DataInnerDnsZoneEditSuccess struct for DataInnerDnsZoneEditSuccess
type DataInnerDnsZoneEditSuccess struct {
...
func NewDataInnerDnsZoneEditSuccess() *DataInnerDnsZoneEditSuccess {
	this := DataInnerDnsZoneEditSuccess{}
	return &this
}
...
func (o DataInnerDnsZoneEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerDnsZoneEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerDnsZoneEditSuccess struct {
	value *DataInnerDnsZoneEditSuccess
	isSet bool
}

func (v NullableDataInnerDnsZoneEditSuccess) Get() *DataInnerDnsZoneEditSuccess {
	return v.value
}

func (v *NullableDataInnerDnsZoneEditSuccess) Set(val *DataInnerDnsZoneEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerDnsZoneEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerDnsZoneEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerDnsZoneEditSuccess(val *DataInnerDnsZoneEditSuccess) *NullableDataInnerDnsZoneEditSuccess {
	return &NullableDataInnerDnsZoneEditSuccess{value: val, isSet: true}
}

func (v NullableDataInnerDnsZoneEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerDnsZoneEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
