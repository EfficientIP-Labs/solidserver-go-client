...
// checks if the IpamAddressEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAddressEditFailed{}

// IpamAddressEditFailed struct for IpamAddressEditFailed
type IpamAddressEditFailed struct {
...
func (o IpamAddressEditFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamAddressEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAddressEditFailed struct {
	value *IpamAddressEditFailed
	isSet bool
}

func (v NullableIpamAddressEditFailed) Get() *IpamAddressEditFailed {
	return v.value
}

func (v *NullableIpamAddressEditFailed) Set(val *IpamAddressEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAddressEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAddressEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAddressEditFailed(val *IpamAddressEditFailed) *NullableIpamAddressEditFailed {
	return &NullableIpamAddressEditFailed{value: val, isSet: true}
}

func (v NullableIpamAddressEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAddressEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
