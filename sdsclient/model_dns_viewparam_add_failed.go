...
// checks if the DnsViewparamAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsViewparamAddFailed{}

// DnsViewparamAddFailed struct for DnsViewparamAddFailed
type DnsViewparamAddFailed struct {
...
func (o DnsViewparamAddFailed) MarshalJSON() ([]byte, error) {
...
func (o DnsViewparamAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDnsViewparamAddFailed struct {
	value *DnsViewparamAddFailed
	isSet bool
}

func (v NullableDnsViewparamAddFailed) Get() *DnsViewparamAddFailed {
	return v.value
}

func (v *NullableDnsViewparamAddFailed) Set(val *DnsViewparamAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsViewparamAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsViewparamAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsViewparamAddFailed(val *DnsViewparamAddFailed) *NullableDnsViewparamAddFailed {
	return &NullableDnsViewparamAddFailed{value: val, isSet: true}
}

func (v NullableDnsViewparamAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsViewparamAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
