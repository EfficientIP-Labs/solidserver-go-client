...
// checks if the DnsZoneparamDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneparamDeleteFailed{}

// DnsZoneparamDeleteFailed struct for DnsZoneparamDeleteFailed
type DnsZoneparamDeleteFailed struct {
...
func (o DnsZoneparamDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o DnsZoneparamDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDnsZoneparamDeleteFailed struct {
	value *DnsZoneparamDeleteFailed
	isSet bool
}

func (v NullableDnsZoneparamDeleteFailed) Get() *DnsZoneparamDeleteFailed {
	return v.value
}

func (v *NullableDnsZoneparamDeleteFailed) Set(val *DnsZoneparamDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsZoneparamDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsZoneparamDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsZoneparamDeleteFailed(val *DnsZoneparamDeleteFailed) *NullableDnsZoneparamDeleteFailed {
	return &NullableDnsZoneparamDeleteFailed{value: val, isSet: true}
}

func (v NullableDnsZoneparamDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsZoneparamDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
