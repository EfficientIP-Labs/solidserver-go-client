...
// checks if the GuardianPolicyAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuardianPolicyAddFailed{}

// GuardianPolicyAddFailed struct for GuardianPolicyAddFailed
type GuardianPolicyAddFailed struct {
...
func (o GuardianPolicyAddFailed) MarshalJSON() ([]byte, error) {
...
func (o GuardianPolicyAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableGuardianPolicyAddFailed struct {
	value *GuardianPolicyAddFailed
	isSet bool
}

func (v NullableGuardianPolicyAddFailed) Get() *GuardianPolicyAddFailed {
	return v.value
}

func (v *NullableGuardianPolicyAddFailed) Set(val *GuardianPolicyAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableGuardianPolicyAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableGuardianPolicyAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuardianPolicyAddFailed(val *GuardianPolicyAddFailed) *NullableGuardianPolicyAddFailed {
	return &NullableGuardianPolicyAddFailed{value: val, isSet: true}
}

func (v NullableGuardianPolicyAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuardianPolicyAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
