...
// checks if the DnsZoneAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneAddFailed{}

// DnsZoneAddFailed struct for DnsZoneAddFailed
type DnsZoneAddFailed struct {
...
func (o DnsZoneAddFailed) MarshalJSON() ([]byte, error) {
...
func (o DnsZoneAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDnsZoneAddFailed struct {
	value *DnsZoneAddFailed
	isSet bool
}

func (v NullableDnsZoneAddFailed) Get() *DnsZoneAddFailed {
	return v.value
}

func (v *NullableDnsZoneAddFailed) Set(val *DnsZoneAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsZoneAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsZoneAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsZoneAddFailed(val *DnsZoneAddFailed) *NullableDnsZoneAddFailed {
	return &NullableDnsZoneAddFailed{value: val, isSet: true}
}

func (v NullableDnsZoneAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsZoneAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
