...
type IpamPoolEditSuccess struct {
	...
	Data *[]AppPoolEditSuccessData `json:"data,omitempty"`
}
...
func (o *IpamPoolEditSuccess) GetData() []AppPoolEditSuccessData {
	if o == nil || o.Data == nil {
		var ret []AppPoolEditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []AppPoolEditSuccessData and assigns it to the Data field.
