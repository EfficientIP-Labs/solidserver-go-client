...
// checks if the IpamPoolEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamPoolEditSuccess{}

// IpamPoolEditSuccess struct for IpamPoolEditSuccess
type IpamPoolEditSuccess struct {
	...
	Data     []DataInnerIpamPoolEditSuccess `json:"data,omitempty"`
}
...
func (o *IpamPoolEditSuccess) GetData() []DataInnerIpamPoolEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamPoolEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamPoolEditSuccess and assigns it to the Data field.
func (o *IpamPoolEditSuccess) SetData(v []DataInnerIpamPoolEditSuccess) {
	o.Data = v
}

func (o IpamPoolEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o IpamPoolEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableIpamPoolEditSuccess struct {
	value *IpamPoolEditSuccess
	isSet bool
}

func (v NullableIpamPoolEditSuccess) Get() *IpamPoolEditSuccess {
	return v.value
}

func (v *NullableIpamPoolEditSuccess) Set(val *IpamPoolEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamPoolEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamPoolEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamPoolEditSuccess(val *IpamPoolEditSuccess) *NullableIpamPoolEditSuccess {
	return &NullableIpamPoolEditSuccess{value: val, isSet: true}
}

func (v NullableIpamPoolEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamPoolEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
