...
// checks if the AppNodeDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppNodeDeleteSuccess{}

// AppNodeDeleteSuccess struct for AppNodeDeleteSuccess
type AppNodeDeleteSuccess struct {
	...
	Data     []DataInnerAppNodeDeleteSuccess `json:"data,omitempty"`
}
...
func (o *AppNodeDeleteSuccess) GetData() []DataInnerAppNodeDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerAppNodeDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerAppNodeDeleteSuccess and assigns it to the Data field.
func (o *AppNodeDeleteSuccess) SetData(v []DataInnerAppNodeDeleteSuccess) {
	o.Data = v
}

func (o AppNodeDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o AppNodeDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableAppNodeDeleteSuccess struct {
	value *AppNodeDeleteSuccess
	isSet bool
}

func (v NullableAppNodeDeleteSuccess) Get() *AppNodeDeleteSuccess {
	return v.value
}

func (v *NullableAppNodeDeleteSuccess) Set(val *AppNodeDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableAppNodeDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableAppNodeDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppNodeDeleteSuccess(val *AppNodeDeleteSuccess) *NullableAppNodeDeleteSuccess {
	return &NullableAppNodeDeleteSuccess{value: val, isSet: true}
}

func (v NullableAppNodeDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppNodeDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
