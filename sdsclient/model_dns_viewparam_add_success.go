...
// checks if the DnsViewparamAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsViewparamAddSuccess{}

// DnsViewparamAddSuccess struct for DnsViewparamAddSuccess
type DnsViewparamAddSuccess struct {
	...
	Data     []DataInnerDnsViewparamAddSuccess `json:"data,omitempty"`
}
...
func (o *DnsViewparamAddSuccess) GetData() []DataInnerDnsViewparamAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsViewparamAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsViewparamAddSuccess and assigns it to the Data field.
func (o *DnsViewparamAddSuccess) SetData(v []DataInnerDnsViewparamAddSuccess) {
	o.Data = v
}

func (o DnsViewparamAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DnsViewparamAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDnsViewparamAddSuccess struct {
	value *DnsViewparamAddSuccess
	isSet bool
}

func (v NullableDnsViewparamAddSuccess) Get() *DnsViewparamAddSuccess {
	return v.value
}

func (v *NullableDnsViewparamAddSuccess) Set(val *DnsViewparamAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsViewparamAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsViewparamAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsViewparamAddSuccess(val *DnsViewparamAddSuccess) *NullableDnsViewparamAddSuccess {
	return &NullableDnsViewparamAddSuccess{value: val, isSet: true}
}

func (v NullableDnsViewparamAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsViewparamAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
