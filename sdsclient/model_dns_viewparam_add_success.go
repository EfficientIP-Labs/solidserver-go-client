...
type DnsViewparamAddSuccess struct {
	...
	Data *[]DnsViewparamAddSuccessData `json:"data,omitempty"`
}
...
func (o *DnsViewparamAddSuccess) GetData() []DnsViewparamAddSuccessData {
	if o == nil || o.Data == nil {
		var ret []DnsViewparamAddSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DnsViewparamAddSuccessData and assigns it to the Data field.
