...
// checks if the DhcpAcl6Data type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpAcl6Data{}
...
type DhcpAcl6Data struct {
	...
	Data     []DataInnerDhcpAcl6Data `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DataInnerDhcpAcl6Data and assigns it to the Data field.
...
func (o DhcpAcl6Data) ToMap() (map[string]interface{}, error) {
