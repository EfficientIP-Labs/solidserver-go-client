...
type IpamNetworkAddInput struct {
	...
	// The database identifier (ID) of a VLSM child space of the space specified in <b>site_id</b>. If you specify an ID, the subnet-type network you are adding is duplicated as a VLSM block-type network in the child space, with the same name but a different ID. This parameter serves the same purpose as <b>vlsm_site_name</b>.
	VlsmSpaceId *int32 `json:"vlsm_space_id,omitempty"`
	// The name of a VLSM child space of the space specified in <b>site_id</b>. If you specify a name, the subnet-type network you are adding is duplicated as a VLSM block-type network in the child space, with the same name but a different ID. This parameter serves the same purpose as <b>vlsm_site_id</b>.
