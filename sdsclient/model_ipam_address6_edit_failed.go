...
// checks if the IpamAddress6EditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAddress6EditFailed{}
...
func (o IpamAddress6EditFailed) ToMap() (map[string]interface{}, error) {
