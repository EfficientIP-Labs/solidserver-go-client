...
// checks if the IpamAddressAddInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAddressAddInput{}
...
func (o IpamAddressAddInput) ToMap() (map[string]interface{}, error) {
