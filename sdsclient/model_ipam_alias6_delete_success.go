...
// checks if the IpamAlias6DeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAlias6DeleteSuccess{}

// IpamAlias6DeleteSuccess struct for IpamAlias6DeleteSuccess
type IpamAlias6DeleteSuccess struct {
	...
	Data     []DataInnerIpamAlias6DeleteSuccess `json:"data,omitempty"`
}
...
func (o *IpamAlias6DeleteSuccess) GetData() []DataInnerIpamAlias6DeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamAlias6DeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamAlias6DeleteSuccess and assigns it to the Data field.
func (o *IpamAlias6DeleteSuccess) SetData(v []DataInnerIpamAlias6DeleteSuccess) {
	o.Data = v
}

func (o IpamAlias6DeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o IpamAlias6DeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAlias6DeleteSuccess struct {
	value *IpamAlias6DeleteSuccess
	isSet bool
}

func (v NullableIpamAlias6DeleteSuccess) Get() *IpamAlias6DeleteSuccess {
	return v.value
}

func (v *NullableIpamAlias6DeleteSuccess) Set(val *IpamAlias6DeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAlias6DeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAlias6DeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAlias6DeleteSuccess(val *IpamAlias6DeleteSuccess) *NullableIpamAlias6DeleteSuccess {
	return &NullableIpamAlias6DeleteSuccess{value: val, isSet: true}
}

func (v NullableIpamAlias6DeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAlias6DeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
