...
type IpamAlias6DeleteSuccess struct {
	...
	Data *[]IpamAlias6DeleteSuccessData `json:"data,omitempty"`
}
...
func (o *IpamAlias6DeleteSuccess) GetData() []IpamAlias6DeleteSuccessData {
	if o == nil || o.Data == nil {
		var ret []IpamAlias6DeleteSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []IpamAlias6DeleteSuccessData and assigns it to the Data field.
