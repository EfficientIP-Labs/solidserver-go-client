...
// checks if the VlanRangeDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanRangeDeleteSuccess{}

// VlanRangeDeleteSuccess struct for VlanRangeDeleteSuccess
type VlanRangeDeleteSuccess struct {
	...
	Data     []DataInnerVlanRangeDeleteSuccess `json:"data,omitempty"`
}
...
func (o *VlanRangeDeleteSuccess) GetData() []DataInnerVlanRangeDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerVlanRangeDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerVlanRangeDeleteSuccess and assigns it to the Data field.
func (o *VlanRangeDeleteSuccess) SetData(v []DataInnerVlanRangeDeleteSuccess) {
	o.Data = v
}

func (o VlanRangeDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o VlanRangeDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableVlanRangeDeleteSuccess struct {
	value *VlanRangeDeleteSuccess
	isSet bool
}

func (v NullableVlanRangeDeleteSuccess) Get() *VlanRangeDeleteSuccess {
	return v.value
}

func (v *NullableVlanRangeDeleteSuccess) Set(val *VlanRangeDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanRangeDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanRangeDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanRangeDeleteSuccess(val *VlanRangeDeleteSuccess) *NullableVlanRangeDeleteSuccess {
	return &NullableVlanRangeDeleteSuccess{value: val, isSet: true}
}

func (v NullableVlanRangeDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanRangeDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
