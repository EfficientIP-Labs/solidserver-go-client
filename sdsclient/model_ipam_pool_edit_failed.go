...
// checks if the IpamPoolEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamPoolEditFailed{}

// IpamPoolEditFailed struct for IpamPoolEditFailed
type IpamPoolEditFailed struct {
...
func (o IpamPoolEditFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamPoolEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamPoolEditFailed struct {
	value *IpamPoolEditFailed
	isSet bool
}

func (v NullableIpamPoolEditFailed) Get() *IpamPoolEditFailed {
	return v.value
}

func (v *NullableIpamPoolEditFailed) Set(val *IpamPoolEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamPoolEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamPoolEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamPoolEditFailed(val *IpamPoolEditFailed) *NullableIpamPoolEditFailed {
	return &NullableIpamPoolEditFailed{value: val, isSet: true}
}

func (v NullableIpamPoolEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamPoolEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
