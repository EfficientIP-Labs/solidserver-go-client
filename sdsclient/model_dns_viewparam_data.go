...
// checks if the DnsViewparamData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsViewparamData{}

// DnsViewparamData struct for DnsViewparamData
type DnsViewparamData struct {
	...
	Data     []DataInnerDnsViewparamData `json:"data,omitempty"`
}
...
func (o *DnsViewparamData) GetData() []DataInnerDnsViewparamData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsViewparamData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsViewparamData and assigns it to the Data field.
func (o *DnsViewparamData) SetData(v []DataInnerDnsViewparamData) {
	o.Data = v
}

func (o DnsViewparamData) MarshalJSON() ([]byte, error) {
...
func (o DnsViewparamData) ToMap() (map[string]interface{}, error) {
...
type NullableDnsViewparamData struct {
	value *DnsViewparamData
	isSet bool
}

func (v NullableDnsViewparamData) Get() *DnsViewparamData {
	return v.value
}

func (v *NullableDnsViewparamData) Set(val *DnsViewparamData) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsViewparamData) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsViewparamData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsViewparamData(val *DnsViewparamData) *NullableDnsViewparamData {
	return &NullableDnsViewparamData{value: val, isSet: true}
}

func (v NullableDnsViewparamData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsViewparamData) UnmarshalJSON(src []byte) error {
	v.isSet = true
