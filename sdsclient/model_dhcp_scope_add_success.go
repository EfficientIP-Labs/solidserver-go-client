...
type DhcpScopeAddSuccess struct {
	...
	Data *[]DhcpScopeAddSuccessData `json:"data,omitempty"`
}
...
func (o *DhcpScopeAddSuccess) GetData() []DhcpScopeAddSuccessData {
	if o == nil || o.Data == nil {
		var ret []DhcpScopeAddSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DhcpScopeAddSuccessData and assigns it to the Data field.
