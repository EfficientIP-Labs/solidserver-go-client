...
// checks if the DhcpScopeAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpScopeAddSuccess{}

// DhcpScopeAddSuccess struct for DhcpScopeAddSuccess
type DhcpScopeAddSuccess struct {
	...
	Data     []DataInnerDhcpScopeAddSuccess `json:"data,omitempty"`
}
...
func (o *DhcpScopeAddSuccess) GetData() []DataInnerDhcpScopeAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpScopeAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpScopeAddSuccess and assigns it to the Data field.
func (o *DhcpScopeAddSuccess) SetData(v []DataInnerDhcpScopeAddSuccess) {
	o.Data = v
}

func (o DhcpScopeAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DhcpScopeAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpScopeAddSuccess struct {
	value *DhcpScopeAddSuccess
	isSet bool
}

func (v NullableDhcpScopeAddSuccess) Get() *DhcpScopeAddSuccess {
	return v.value
}

func (v *NullableDhcpScopeAddSuccess) Set(val *DhcpScopeAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpScopeAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpScopeAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpScopeAddSuccess(val *DhcpScopeAddSuccess) *NullableDhcpScopeAddSuccess {
	return &NullableDhcpScopeAddSuccess{value: val, isSet: true}
}

func (v NullableDhcpScopeAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpScopeAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
