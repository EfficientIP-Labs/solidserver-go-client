...
// checks if the AppPoolDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPoolDeleteSuccess{}

// AppPoolDeleteSuccess struct for AppPoolDeleteSuccess
type AppPoolDeleteSuccess struct {
	...
	Data     []DataInnerAppPoolDeleteSuccess `json:"data,omitempty"`
}
...
func (o *AppPoolDeleteSuccess) GetData() []DataInnerAppPoolDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerAppPoolDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerAppPoolDeleteSuccess and assigns it to the Data field.
func (o *AppPoolDeleteSuccess) SetData(v []DataInnerAppPoolDeleteSuccess) {
	o.Data = v
}

func (o AppPoolDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o AppPoolDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableAppPoolDeleteSuccess struct {
	value *AppPoolDeleteSuccess
	isSet bool
}

func (v NullableAppPoolDeleteSuccess) Get() *AppPoolDeleteSuccess {
	return v.value
}

func (v *NullableAppPoolDeleteSuccess) Set(val *AppPoolDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPoolDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPoolDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPoolDeleteSuccess(val *AppPoolDeleteSuccess) *NullableAppPoolDeleteSuccess {
	return &NullableAppPoolDeleteSuccess{value: val, isSet: true}
}

func (v NullableAppPoolDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPoolDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
