...
// checks if the DataInnerIpamAddress6EditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerIpamAddress6EditSuccess{}

// DataInnerIpamAddress6EditSuccess struct for DataInnerIpamAddress6EditSuccess
type DataInnerIpamAddress6EditSuccess struct {
...
func NewDataInnerIpamAddress6EditSuccess() *DataInnerIpamAddress6EditSuccess {
	this := DataInnerIpamAddress6EditSuccess{}
	return &this
}
...
func (o DataInnerIpamAddress6EditSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerIpamAddress6EditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerIpamAddress6EditSuccess struct {
	value *DataInnerIpamAddress6EditSuccess
	isSet bool
}

func (v NullableDataInnerIpamAddress6EditSuccess) Get() *DataInnerIpamAddress6EditSuccess {
	return v.value
}

func (v *NullableDataInnerIpamAddress6EditSuccess) Set(val *DataInnerIpamAddress6EditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerIpamAddress6EditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerIpamAddress6EditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerIpamAddress6EditSuccess(val *DataInnerIpamAddress6EditSuccess) *NullableDataInnerIpamAddress6EditSuccess {
	return &NullableDataInnerIpamAddress6EditSuccess{value: val, isSet: true}
}

func (v NullableDataInnerIpamAddress6EditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerIpamAddress6EditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
