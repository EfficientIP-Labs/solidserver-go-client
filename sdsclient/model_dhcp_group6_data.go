...
// checks if the DhcpGroup6Data type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpGroup6Data{}

// DhcpGroup6Data struct for DhcpGroup6Data
type DhcpGroup6Data struct {
	...
	Data     []DataInnerDhcpGroup6Data `json:"data,omitempty"`
}
...
func (o *DhcpGroup6Data) GetData() []DataInnerDhcpGroup6Data {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpGroup6Data
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpGroup6Data and assigns it to the Data field.
func (o *DhcpGroup6Data) SetData(v []DataInnerDhcpGroup6Data) {
	o.Data = v
}

func (o DhcpGroup6Data) MarshalJSON() ([]byte, error) {
...
func (o DhcpGroup6Data) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpGroup6Data struct {
	value *DhcpGroup6Data
	isSet bool
}

func (v NullableDhcpGroup6Data) Get() *DhcpGroup6Data {
	return v.value
}

func (v *NullableDhcpGroup6Data) Set(val *DhcpGroup6Data) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpGroup6Data) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpGroup6Data) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpGroup6Data(val *DhcpGroup6Data) *NullableDhcpGroup6Data {
	return &NullableDhcpGroup6Data{value: val, isSet: true}
}

func (v NullableDhcpGroup6Data) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpGroup6Data) UnmarshalJSON(src []byte) error {
	v.isSet = true
