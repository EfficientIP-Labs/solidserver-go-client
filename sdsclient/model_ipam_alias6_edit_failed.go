...
// checks if the IpamAlias6EditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAlias6EditFailed{}

// IpamAlias6EditFailed struct for IpamAlias6EditFailed
type IpamAlias6EditFailed struct {
...
func (o IpamAlias6EditFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamAlias6EditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAlias6EditFailed struct {
	value *IpamAlias6EditFailed
	isSet bool
}

func (v NullableIpamAlias6EditFailed) Get() *IpamAlias6EditFailed {
	return v.value
}

func (v *NullableIpamAlias6EditFailed) Set(val *IpamAlias6EditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAlias6EditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAlias6EditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAlias6EditFailed(val *IpamAlias6EditFailed) *NullableIpamAlias6EditFailed {
	return &NullableIpamAlias6EditFailed{value: val, isSet: true}
}

func (v NullableIpamAlias6EditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAlias6EditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
