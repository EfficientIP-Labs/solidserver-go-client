...
// checks if the DnsRrAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsRrAddFailed{}

// DnsRrAddFailed struct for DnsRrAddFailed
type DnsRrAddFailed struct {
...
func (o DnsRrAddFailed) MarshalJSON() ([]byte, error) {
...
func (o DnsRrAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDnsRrAddFailed struct {
	value *DnsRrAddFailed
	isSet bool
}

func (v NullableDnsRrAddFailed) Get() *DnsRrAddFailed {
	return v.value
}

func (v *NullableDnsRrAddFailed) Set(val *DnsRrAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsRrAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsRrAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsRrAddFailed(val *DnsRrAddFailed) *NullableDnsRrAddFailed {
	return &NullableDnsRrAddFailed{value: val, isSet: true}
}

func (v NullableDnsRrAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsRrAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
