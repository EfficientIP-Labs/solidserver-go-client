...
// checks if the IpamPool6EditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamPool6EditSuccess{}
...
type IpamPool6EditSuccess struct {
	...
	Data     []DataInnerIpamPool6EditSuccess `json:"data,omitempty"`
}
...
func (o *IpamPool6EditSuccess) GetData() []DataInnerIpamPool6EditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamPool6EditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamPool6EditSuccess and assigns it to the Data field.
...
func (o IpamPool6EditSuccess) ToMap() (map[string]interface{}, error) {
