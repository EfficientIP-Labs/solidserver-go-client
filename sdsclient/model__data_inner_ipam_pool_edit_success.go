...
// checks if the DataInnerIpamPoolEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerIpamPoolEditSuccess{}

// DataInnerIpamPoolEditSuccess struct for DataInnerIpamPoolEditSuccess
type DataInnerIpamPoolEditSuccess struct {
...
func NewDataInnerIpamPoolEditSuccess() *DataInnerIpamPoolEditSuccess {
	this := DataInnerIpamPoolEditSuccess{}
	return &this
}
...
func (o DataInnerIpamPoolEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerIpamPoolEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerIpamPoolEditSuccess struct {
	value *DataInnerIpamPoolEditSuccess
	isSet bool
}

func (v NullableDataInnerIpamPoolEditSuccess) Get() *DataInnerIpamPoolEditSuccess {
	return v.value
}

func (v *NullableDataInnerIpamPoolEditSuccess) Set(val *DataInnerIpamPoolEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerIpamPoolEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerIpamPoolEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerIpamPoolEditSuccess(val *DataInnerIpamPoolEditSuccess) *NullableDataInnerIpamPoolEditSuccess {
	return &NullableDataInnerIpamPoolEditSuccess{value: val, isSet: true}
}

func (v NullableDataInnerIpamPoolEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerIpamPoolEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
