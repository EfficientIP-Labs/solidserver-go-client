...
// checks if the AppApplicationData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppApplicationData{}

// AppApplicationData struct for AppApplicationData
type AppApplicationData struct {
	...
	Data     []DataInnerAppApplicationData `json:"data,omitempty"`
}
...
func (o *AppApplicationData) GetData() []DataInnerAppApplicationData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerAppApplicationData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerAppApplicationData and assigns it to the Data field.
func (o *AppApplicationData) SetData(v []DataInnerAppApplicationData) {
	o.Data = v
}

func (o AppApplicationData) MarshalJSON() ([]byte, error) {
...
func (o AppApplicationData) ToMap() (map[string]interface{}, error) {
...
type NullableAppApplicationData struct {
	value *AppApplicationData
	isSet bool
}

func (v NullableAppApplicationData) Get() *AppApplicationData {
	return v.value
}

func (v *NullableAppApplicationData) Set(val *AppApplicationData) {
	v.value = val
	v.isSet = true
}

func (v NullableAppApplicationData) IsSet() bool {
	return v.isSet
}

func (v *NullableAppApplicationData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppApplicationData(val *AppApplicationData) *NullableAppApplicationData {
	return &NullableAppApplicationData{value: val, isSet: true}
}

func (v NullableAppApplicationData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppApplicationData) UnmarshalJSON(src []byte) error {
	v.isSet = true
