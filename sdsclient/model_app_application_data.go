...
type AppApplicationData struct {
	...
	Data *[]AppApplicationDataData `json:"data,omitempty"`
}
...
func (o *AppApplicationData) GetData() []AppApplicationDataData {
	if o == nil || o.Data == nil {
		var ret []AppApplicationDataData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []AppApplicationDataData and assigns it to the Data field.
