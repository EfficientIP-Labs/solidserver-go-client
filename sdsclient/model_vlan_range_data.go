...
// checks if the VlanRangeData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanRangeData{}
...
type VlanRangeData struct {
	...
	Data     []DataInnerVlanRangeData `json:"data,omitempty"`
}
...
func (o *VlanRangeData) GetData() []DataInnerVlanRangeData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerVlanRangeData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerVlanRangeData and assigns it to the Data field.
...
func (o VlanRangeData) ToMap() (map[string]interface{}, error) {
