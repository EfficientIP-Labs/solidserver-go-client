...
// checks if the DeviceLinkAddInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceLinkAddInput{}

// DeviceLinkAddInput struct for DeviceLinkAddInput
type DeviceLinkAddInput struct {
...
func (o DeviceLinkAddInput) MarshalJSON() ([]byte, error) {
...
func (o DeviceLinkAddInput) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceLinkAddInput struct {
	value *DeviceLinkAddInput
	isSet bool
}

func (v NullableDeviceLinkAddInput) Get() *DeviceLinkAddInput {
	return v.value
}

func (v *NullableDeviceLinkAddInput) Set(val *DeviceLinkAddInput) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceLinkAddInput) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceLinkAddInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceLinkAddInput(val *DeviceLinkAddInput) *NullableDeviceLinkAddInput {
	return &NullableDeviceLinkAddInput{value: val, isSet: true}
}

func (v NullableDeviceLinkAddInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceLinkAddInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
