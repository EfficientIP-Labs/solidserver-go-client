...
// checks if the DnsViewDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsViewDeleteFailed{}

// DnsViewDeleteFailed struct for DnsViewDeleteFailed
type DnsViewDeleteFailed struct {
...
func (o DnsViewDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o DnsViewDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDnsViewDeleteFailed struct {
	value *DnsViewDeleteFailed
	isSet bool
}

func (v NullableDnsViewDeleteFailed) Get() *DnsViewDeleteFailed {
	return v.value
}

func (v *NullableDnsViewDeleteFailed) Set(val *DnsViewDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsViewDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsViewDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsViewDeleteFailed(val *DnsViewDeleteFailed) *NullableDnsViewDeleteFailed {
	return &NullableDnsViewDeleteFailed{value: val, isSet: true}
}

func (v NullableDnsViewDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsViewDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
