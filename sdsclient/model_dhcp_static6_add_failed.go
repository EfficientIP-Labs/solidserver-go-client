...
// checks if the DhcpStatic6AddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStatic6AddFailed{}
...
func (o DhcpStatic6AddFailed) ToMap() (map[string]interface{}, error) {
