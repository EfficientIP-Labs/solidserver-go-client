...
// checks if the DnsViewEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsViewEditSuccess{}

// DnsViewEditSuccess struct for DnsViewEditSuccess
type DnsViewEditSuccess struct {
	...
	Data     []DataInnerDnsViewEditSuccess `json:"data,omitempty"`
}
...
func (o *DnsViewEditSuccess) GetData() []DataInnerDnsViewEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsViewEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsViewEditSuccess and assigns it to the Data field.
func (o *DnsViewEditSuccess) SetData(v []DataInnerDnsViewEditSuccess) {
	o.Data = v
}

func (o DnsViewEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o DnsViewEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDnsViewEditSuccess struct {
	value *DnsViewEditSuccess
	isSet bool
}

func (v NullableDnsViewEditSuccess) Get() *DnsViewEditSuccess {
	return v.value
}

func (v *NullableDnsViewEditSuccess) Set(val *DnsViewEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsViewEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsViewEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsViewEditSuccess(val *DnsViewEditSuccess) *NullableDnsViewEditSuccess {
	return &NullableDnsViewEditSuccess{value: val, isSet: true}
}

func (v NullableDnsViewEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsViewEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
