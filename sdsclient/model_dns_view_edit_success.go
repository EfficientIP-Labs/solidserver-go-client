...
type DnsViewEditSuccess struct {
	...
	Data *[]DnsViewEditSuccessData `json:"data,omitempty"`
}
...
func (o *DnsViewEditSuccess) GetData() []DnsViewEditSuccessData {
	if o == nil || o.Data == nil {
		var ret []DnsViewEditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DnsViewEditSuccessData and assigns it to the Data field.
