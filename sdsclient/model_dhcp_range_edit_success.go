...
// checks if the DhcpRangeEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpRangeEditSuccess{}
...
type DhcpRangeEditSuccess struct {
	...
	Data     []DataInnerDhcpRangeEditSuccess `json:"data,omitempty"`
}
...
func (o *DhcpRangeEditSuccess) GetData() []DataInnerDhcpRangeEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpRangeEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpRangeEditSuccess and assigns it to the Data field.
...
func (o DhcpRangeEditSuccess) ToMap() (map[string]interface{}, error) {
