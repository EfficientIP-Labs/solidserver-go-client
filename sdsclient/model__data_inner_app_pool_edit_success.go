...
// checks if the DataInnerAppPoolEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerAppPoolEditSuccess{}

// DataInnerAppPoolEditSuccess struct for DataInnerAppPoolEditSuccess
type DataInnerAppPoolEditSuccess struct {
...
func NewDataInnerAppPoolEditSuccess() *DataInnerAppPoolEditSuccess {
	this := DataInnerAppPoolEditSuccess{}
	return &this
}
...
func (o DataInnerAppPoolEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerAppPoolEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerAppPoolEditSuccess struct {
	value *DataInnerAppPoolEditSuccess
	isSet bool
}

func (v NullableDataInnerAppPoolEditSuccess) Get() *DataInnerAppPoolEditSuccess {
	return v.value
}

func (v *NullableDataInnerAppPoolEditSuccess) Set(val *DataInnerAppPoolEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerAppPoolEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerAppPoolEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerAppPoolEditSuccess(val *DataInnerAppPoolEditSuccess) *NullableDataInnerAppPoolEditSuccess {
	return &NullableDataInnerAppPoolEditSuccess{value: val, isSet: true}
}

func (v NullableDataInnerAppPoolEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerAppPoolEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
