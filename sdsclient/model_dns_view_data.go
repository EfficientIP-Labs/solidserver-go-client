...
// checks if the DnsViewData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsViewData{}

// DnsViewData struct for DnsViewData
type DnsViewData struct {
	...
	Data     []DataInnerDnsViewData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DataInnerDnsViewData and assigns it to the Data field.
func (o *DnsViewData) SetData(v []DataInnerDnsViewData) {
	o.Data = v
}

func (o DnsViewData) MarshalJSON() ([]byte, error) {
...
func (o DnsViewData) ToMap() (map[string]interface{}, error) {
...
type NullableDnsViewData struct {
	value *DnsViewData
	isSet bool
}

func (v NullableDnsViewData) Get() *DnsViewData {
	return v.value
}

func (v *NullableDnsViewData) Set(val *DnsViewData) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsViewData) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsViewData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsViewData(val *DnsViewData) *NullableDnsViewData {
	return &NullableDnsViewData{value: val, isSet: true}
}

func (v NullableDnsViewData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsViewData) UnmarshalJSON(src []byte) error {
	v.isSet = true
