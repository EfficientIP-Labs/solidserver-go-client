...
// checks if the AppPoolEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPoolEditFailed{}

// AppPoolEditFailed struct for AppPoolEditFailed
type AppPoolEditFailed struct {
...
func (o AppPoolEditFailed) MarshalJSON() ([]byte, error) {
...
func (o AppPoolEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableAppPoolEditFailed struct {
	value *AppPoolEditFailed
	isSet bool
}

func (v NullableAppPoolEditFailed) Get() *AppPoolEditFailed {
	return v.value
}

func (v *NullableAppPoolEditFailed) Set(val *AppPoolEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPoolEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPoolEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPoolEditFailed(val *AppPoolEditFailed) *NullableAppPoolEditFailed {
	return &NullableAppPoolEditFailed{value: val, isSet: true}
}

func (v NullableAppPoolEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPoolEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
