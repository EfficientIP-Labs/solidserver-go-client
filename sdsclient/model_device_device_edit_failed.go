...
// checks if the DeviceDeviceEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceDeviceEditFailed{}

// DeviceDeviceEditFailed struct for DeviceDeviceEditFailed
type DeviceDeviceEditFailed struct {
...
func (o DeviceDeviceEditFailed) MarshalJSON() ([]byte, error) {
...
func (o DeviceDeviceEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceDeviceEditFailed struct {
	value *DeviceDeviceEditFailed
	isSet bool
}

func (v NullableDeviceDeviceEditFailed) Get() *DeviceDeviceEditFailed {
	return v.value
}

func (v *NullableDeviceDeviceEditFailed) Set(val *DeviceDeviceEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceDeviceEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceDeviceEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceDeviceEditFailed(val *DeviceDeviceEditFailed) *NullableDeviceDeviceEditFailed {
	return &NullableDeviceDeviceEditFailed{value: val, isSet: true}
}

func (v NullableDeviceDeviceEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceDeviceEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
