...
type DnsZoneparamEditSuccess struct {
	...
	Data *[]DnsZoneparamEditSuccessData `json:"data,omitempty"`
}
...
func (o *DnsZoneparamEditSuccess) GetData() []DnsZoneparamEditSuccessData {
	if o == nil || o.Data == nil {
		var ret []DnsZoneparamEditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DnsZoneparamEditSuccessData and assigns it to the Data field.
