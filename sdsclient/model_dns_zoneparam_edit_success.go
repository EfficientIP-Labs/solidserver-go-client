...
// checks if the DnsZoneparamEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneparamEditSuccess{}

// DnsZoneparamEditSuccess struct for DnsZoneparamEditSuccess
type DnsZoneparamEditSuccess struct {
	...
	Data     []DataInnerDnsZoneparamEditSuccess `json:"data,omitempty"`
}
...
func (o *DnsZoneparamEditSuccess) GetData() []DataInnerDnsZoneparamEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsZoneparamEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsZoneparamEditSuccess and assigns it to the Data field.
func (o *DnsZoneparamEditSuccess) SetData(v []DataInnerDnsZoneparamEditSuccess) {
	o.Data = v
}

func (o DnsZoneparamEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o DnsZoneparamEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDnsZoneparamEditSuccess struct {
	value *DnsZoneparamEditSuccess
	isSet bool
}

func (v NullableDnsZoneparamEditSuccess) Get() *DnsZoneparamEditSuccess {
	return v.value
}

func (v *NullableDnsZoneparamEditSuccess) Set(val *DnsZoneparamEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsZoneparamEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsZoneparamEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsZoneparamEditSuccess(val *DnsZoneparamEditSuccess) *NullableDnsZoneparamEditSuccess {
	return &NullableDnsZoneparamEditSuccess{value: val, isSet: true}
}

func (v NullableDnsZoneparamEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsZoneparamEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
