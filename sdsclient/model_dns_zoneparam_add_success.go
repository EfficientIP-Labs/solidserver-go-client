...
// checks if the DnsZoneparamAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneparamAddSuccess{}

// DnsZoneparamAddSuccess struct for DnsZoneparamAddSuccess
type DnsZoneparamAddSuccess struct {
	...
	Data     []DataInnerDnsZoneparamAddSuccess `json:"data,omitempty"`
}
...
func (o *DnsZoneparamAddSuccess) GetData() []DataInnerDnsZoneparamAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsZoneparamAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsZoneparamAddSuccess and assigns it to the Data field.
func (o *DnsZoneparamAddSuccess) SetData(v []DataInnerDnsZoneparamAddSuccess) {
	o.Data = v
}

func (o DnsZoneparamAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DnsZoneparamAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDnsZoneparamAddSuccess struct {
	value *DnsZoneparamAddSuccess
	isSet bool
}

func (v NullableDnsZoneparamAddSuccess) Get() *DnsZoneparamAddSuccess {
	return v.value
}

func (v *NullableDnsZoneparamAddSuccess) Set(val *DnsZoneparamAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsZoneparamAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsZoneparamAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsZoneparamAddSuccess(val *DnsZoneparamAddSuccess) *NullableDnsZoneparamAddSuccess {
	return &NullableDnsZoneparamAddSuccess{value: val, isSet: true}
}

func (v NullableDnsZoneparamAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsZoneparamAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
