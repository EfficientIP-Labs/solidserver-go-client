...
// checks if the DnsZoneEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneEditSuccess{}

// DnsZoneEditSuccess struct for DnsZoneEditSuccess
type DnsZoneEditSuccess struct {
	...
	Data     []DataInnerDnsZoneEditSuccess `json:"data,omitempty"`
}
...
func (o *DnsZoneEditSuccess) GetData() []DataInnerDnsZoneEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsZoneEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsZoneEditSuccess and assigns it to the Data field.
func (o *DnsZoneEditSuccess) SetData(v []DataInnerDnsZoneEditSuccess) {
	o.Data = v
}

func (o DnsZoneEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o DnsZoneEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDnsZoneEditSuccess struct {
	value *DnsZoneEditSuccess
	isSet bool
}

func (v NullableDnsZoneEditSuccess) Get() *DnsZoneEditSuccess {
	return v.value
}

func (v *NullableDnsZoneEditSuccess) Set(val *DnsZoneEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsZoneEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsZoneEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsZoneEditSuccess(val *DnsZoneEditSuccess) *NullableDnsZoneEditSuccess {
	return &NullableDnsZoneEditSuccess{value: val, isSet: true}
}

func (v NullableDnsZoneEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsZoneEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
