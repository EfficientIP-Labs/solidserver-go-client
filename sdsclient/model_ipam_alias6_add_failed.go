...
// checks if the IpamAlias6AddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAlias6AddFailed{}

// IpamAlias6AddFailed struct for IpamAlias6AddFailed
type IpamAlias6AddFailed struct {
...
func (o IpamAlias6AddFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamAlias6AddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAlias6AddFailed struct {
	value *IpamAlias6AddFailed
	isSet bool
}

func (v NullableIpamAlias6AddFailed) Get() *IpamAlias6AddFailed {
	return v.value
}

func (v *NullableIpamAlias6AddFailed) Set(val *IpamAlias6AddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAlias6AddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAlias6AddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAlias6AddFailed(val *IpamAlias6AddFailed) *NullableIpamAlias6AddFailed {
	return &NullableIpamAlias6AddFailed{value: val, isSet: true}
}

func (v NullableIpamAlias6AddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAlias6AddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
