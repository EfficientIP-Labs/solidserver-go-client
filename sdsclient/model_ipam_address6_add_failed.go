...
// checks if the IpamAddress6AddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAddress6AddFailed{}

// IpamAddress6AddFailed struct for IpamAddress6AddFailed
type IpamAddress6AddFailed struct {
...
func (o IpamAddress6AddFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamAddress6AddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAddress6AddFailed struct {
	value *IpamAddress6AddFailed
	isSet bool
}

func (v NullableIpamAddress6AddFailed) Get() *IpamAddress6AddFailed {
	return v.value
}

func (v *NullableIpamAddress6AddFailed) Set(val *IpamAddress6AddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAddress6AddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAddress6AddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAddress6AddFailed(val *IpamAddress6AddFailed) *NullableIpamAddress6AddFailed {
	return &NullableIpamAddress6AddFailed{value: val, isSet: true}
}

func (v NullableIpamAddress6AddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAddress6AddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
