...
// checks if the IpamNetwork6AddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamNetwork6AddSuccess{}
...
type IpamNetwork6AddSuccess struct {
	...
	Data     []DataInnerIpamNetwork6AddSuccess `json:"data,omitempty"`
}
...
func (o *IpamNetwork6AddSuccess) GetData() []DataInnerIpamNetwork6AddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamNetwork6AddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamNetwork6AddSuccess and assigns it to the Data field.
...
func (o IpamNetwork6AddSuccess) ToMap() (map[string]interface{}, error) {
