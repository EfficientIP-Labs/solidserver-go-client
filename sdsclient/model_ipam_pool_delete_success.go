...
// checks if the IpamPoolDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamPoolDeleteSuccess{}

// IpamPoolDeleteSuccess struct for IpamPoolDeleteSuccess
type IpamPoolDeleteSuccess struct {
	...
	Data     []DataInnerIpamPoolDeleteSuccess `json:"data,omitempty"`
}
...
func (o *IpamPoolDeleteSuccess) GetData() []DataInnerIpamPoolDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamPoolDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamPoolDeleteSuccess and assigns it to the Data field.
func (o *IpamPoolDeleteSuccess) SetData(v []DataInnerIpamPoolDeleteSuccess) {
	o.Data = v
}

func (o IpamPoolDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o IpamPoolDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableIpamPoolDeleteSuccess struct {
	value *IpamPoolDeleteSuccess
	isSet bool
}

func (v NullableIpamPoolDeleteSuccess) Get() *IpamPoolDeleteSuccess {
	return v.value
}

func (v *NullableIpamPoolDeleteSuccess) Set(val *IpamPoolDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamPoolDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamPoolDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamPoolDeleteSuccess(val *IpamPoolDeleteSuccess) *NullableIpamPoolDeleteSuccess {
	return &NullableIpamPoolDeleteSuccess{value: val, isSet: true}
}

func (v NullableIpamPoolDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamPoolDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
