...
// checks if the VlanRangeAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanRangeAddFailed{}

// VlanRangeAddFailed struct for VlanRangeAddFailed
type VlanRangeAddFailed struct {
...
func (o VlanRangeAddFailed) MarshalJSON() ([]byte, error) {
...
func (o VlanRangeAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableVlanRangeAddFailed struct {
	value *VlanRangeAddFailed
	isSet bool
}

func (v NullableVlanRangeAddFailed) Get() *VlanRangeAddFailed {
	return v.value
}

func (v *NullableVlanRangeAddFailed) Set(val *VlanRangeAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanRangeAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanRangeAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanRangeAddFailed(val *VlanRangeAddFailed) *NullableVlanRangeAddFailed {
	return &NullableVlanRangeAddFailed{value: val, isSet: true}
}

func (v NullableVlanRangeAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanRangeAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
