...
// checks if the DhcpStatic6DeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStatic6DeleteSuccess{}

// DhcpStatic6DeleteSuccess struct for DhcpStatic6DeleteSuccess
type DhcpStatic6DeleteSuccess struct {
	...
	Data     []DataInnerDhcpStatic6DeleteSuccess `json:"data,omitempty"`
}
...
func (o *DhcpStatic6DeleteSuccess) GetData() []DataInnerDhcpStatic6DeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpStatic6DeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpStatic6DeleteSuccess and assigns it to the Data field.
func (o *DhcpStatic6DeleteSuccess) SetData(v []DataInnerDhcpStatic6DeleteSuccess) {
	o.Data = v
}

func (o DhcpStatic6DeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o DhcpStatic6DeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpStatic6DeleteSuccess struct {
	value *DhcpStatic6DeleteSuccess
	isSet bool
}

func (v NullableDhcpStatic6DeleteSuccess) Get() *DhcpStatic6DeleteSuccess {
	return v.value
}

func (v *NullableDhcpStatic6DeleteSuccess) Set(val *DhcpStatic6DeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpStatic6DeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpStatic6DeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpStatic6DeleteSuccess(val *DhcpStatic6DeleteSuccess) *NullableDhcpStatic6DeleteSuccess {
	return &NullableDhcpStatic6DeleteSuccess{value: val, isSet: true}
}

func (v NullableDhcpStatic6DeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpStatic6DeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
