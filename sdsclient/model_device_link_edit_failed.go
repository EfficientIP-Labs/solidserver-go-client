...
// checks if the DeviceLinkEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceLinkEditFailed{}

// DeviceLinkEditFailed struct for DeviceLinkEditFailed
type DeviceLinkEditFailed struct {
...
func (o DeviceLinkEditFailed) MarshalJSON() ([]byte, error) {
...
func (o DeviceLinkEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceLinkEditFailed struct {
	value *DeviceLinkEditFailed
	isSet bool
}

func (v NullableDeviceLinkEditFailed) Get() *DeviceLinkEditFailed {
	return v.value
}

func (v *NullableDeviceLinkEditFailed) Set(val *DeviceLinkEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceLinkEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceLinkEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceLinkEditFailed(val *DeviceLinkEditFailed) *NullableDeviceLinkEditFailed {
	return &NullableDeviceLinkEditFailed{value: val, isSet: true}
}

func (v NullableDeviceLinkEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceLinkEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
