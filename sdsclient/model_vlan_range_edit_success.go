...
// checks if the VlanRangeEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanRangeEditSuccess{}

// VlanRangeEditSuccess struct for VlanRangeEditSuccess
type VlanRangeEditSuccess struct {
	...
	Data     []DataInnerVlanRangeEditSuccess `json:"data,omitempty"`
}
...
func (o *VlanRangeEditSuccess) GetData() []DataInnerVlanRangeEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerVlanRangeEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerVlanRangeEditSuccess and assigns it to the Data field.
func (o *VlanRangeEditSuccess) SetData(v []DataInnerVlanRangeEditSuccess) {
	o.Data = v
}

func (o VlanRangeEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o VlanRangeEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableVlanRangeEditSuccess struct {
	value *VlanRangeEditSuccess
	isSet bool
}

func (v NullableVlanRangeEditSuccess) Get() *VlanRangeEditSuccess {
	return v.value
}

func (v *NullableVlanRangeEditSuccess) Set(val *VlanRangeEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanRangeEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanRangeEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanRangeEditSuccess(val *VlanRangeEditSuccess) *NullableVlanRangeEditSuccess {
	return &NullableVlanRangeEditSuccess{value: val, isSet: true}
}

func (v NullableVlanRangeEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanRangeEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
