...
// checks if the DataInnerIpamAddress6AddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerIpamAddress6AddSuccess{}

// DataInnerIpamAddress6AddSuccess struct for DataInnerIpamAddress6AddSuccess
type DataInnerIpamAddress6AddSuccess struct {
...
func NewDataInnerIpamAddress6AddSuccess() *DataInnerIpamAddress6AddSuccess {
	this := DataInnerIpamAddress6AddSuccess{}
	return &this
}
...
func (o DataInnerIpamAddress6AddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerIpamAddress6AddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerIpamAddress6AddSuccess struct {
	value *DataInnerIpamAddress6AddSuccess
	isSet bool
}

func (v NullableDataInnerIpamAddress6AddSuccess) Get() *DataInnerIpamAddress6AddSuccess {
	return v.value
}

func (v *NullableDataInnerIpamAddress6AddSuccess) Set(val *DataInnerIpamAddress6AddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerIpamAddress6AddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerIpamAddress6AddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerIpamAddress6AddSuccess(val *DataInnerIpamAddress6AddSuccess) *NullableDataInnerIpamAddress6AddSuccess {
	return &NullableDataInnerIpamAddress6AddSuccess{value: val, isSet: true}
}

func (v NullableDataInnerIpamAddress6AddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerIpamAddress6AddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
