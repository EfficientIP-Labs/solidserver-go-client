...
// checks if the DnsAclEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsAclEditFailed{}

// DnsAclEditFailed struct for DnsAclEditFailed
type DnsAclEditFailed struct {
...
func (o DnsAclEditFailed) MarshalJSON() ([]byte, error) {
...
func (o DnsAclEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDnsAclEditFailed struct {
	value *DnsAclEditFailed
	isSet bool
}

func (v NullableDnsAclEditFailed) Get() *DnsAclEditFailed {
	return v.value
}

func (v *NullableDnsAclEditFailed) Set(val *DnsAclEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsAclEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsAclEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsAclEditFailed(val *DnsAclEditFailed) *NullableDnsAclEditFailed {
	return &NullableDnsAclEditFailed{value: val, isSet: true}
}

func (v NullableDnsAclEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsAclEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
