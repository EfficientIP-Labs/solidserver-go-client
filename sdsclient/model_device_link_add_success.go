...
// checks if the DeviceLinkAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceLinkAddSuccess{}

// DeviceLinkAddSuccess struct for DeviceLinkAddSuccess
type DeviceLinkAddSuccess struct {
	...
	Data     []DataInnerDeviceLinkAddSuccess `json:"data,omitempty"`
}
...
func (o *DeviceLinkAddSuccess) GetData() []DataInnerDeviceLinkAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDeviceLinkAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDeviceLinkAddSuccess and assigns it to the Data field.
func (o *DeviceLinkAddSuccess) SetData(v []DataInnerDeviceLinkAddSuccess) {
	o.Data = v
}

func (o DeviceLinkAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DeviceLinkAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceLinkAddSuccess struct {
	value *DeviceLinkAddSuccess
	isSet bool
}

func (v NullableDeviceLinkAddSuccess) Get() *DeviceLinkAddSuccess {
	return v.value
}

func (v *NullableDeviceLinkAddSuccess) Set(val *DeviceLinkAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceLinkAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceLinkAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceLinkAddSuccess(val *DeviceLinkAddSuccess) *NullableDeviceLinkAddSuccess {
	return &NullableDeviceLinkAddSuccess{value: val, isSet: true}
}

func (v NullableDeviceLinkAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceLinkAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
