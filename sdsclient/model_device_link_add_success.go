...
type DeviceLinkAddSuccess struct {
	...
	Data *[]DeviceLinkAddSuccessData `json:"data,omitempty"`
}
...
func (o *DeviceLinkAddSuccess) GetData() []DeviceLinkAddSuccessData {
	if o == nil || o.Data == nil {
		var ret []DeviceLinkAddSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DeviceLinkAddSuccessData and assigns it to the Data field.
