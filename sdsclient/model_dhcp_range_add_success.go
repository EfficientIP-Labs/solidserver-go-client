...
// checks if the DhcpRangeAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpRangeAddSuccess{}
...
type DhcpRangeAddSuccess struct {
	...
	Data     []DataInnerDhcpRangeAddSuccess `json:"data,omitempty"`
}
...
func (o *DhcpRangeAddSuccess) GetData() []DataInnerDhcpRangeAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpRangeAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpRangeAddSuccess and assigns it to the Data field.
...
func (o DhcpRangeAddSuccess) ToMap() (map[string]interface{}, error) {
