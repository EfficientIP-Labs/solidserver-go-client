...
// checks if the AppNodeEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppNodeEditSuccess{}

// AppNodeEditSuccess struct for AppNodeEditSuccess
type AppNodeEditSuccess struct {
	...
	Data     []DataInnerAppNodeEditSuccess `json:"data,omitempty"`
}
...
func (o *AppNodeEditSuccess) GetData() []DataInnerAppNodeEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerAppNodeEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerAppNodeEditSuccess and assigns it to the Data field.
func (o *AppNodeEditSuccess) SetData(v []DataInnerAppNodeEditSuccess) {
	o.Data = v
}

func (o AppNodeEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o AppNodeEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableAppNodeEditSuccess struct {
	value *AppNodeEditSuccess
	isSet bool
}

func (v NullableAppNodeEditSuccess) Get() *AppNodeEditSuccess {
	return v.value
}

func (v *NullableAppNodeEditSuccess) Set(val *AppNodeEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableAppNodeEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableAppNodeEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppNodeEditSuccess(val *AppNodeEditSuccess) *NullableAppNodeEditSuccess {
	return &NullableAppNodeEditSuccess{value: val, isSet: true}
}

func (v NullableAppNodeEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppNodeEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
