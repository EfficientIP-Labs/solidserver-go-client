...
// checks if the DhcpStatic6DeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStatic6DeleteFailed{}

// DhcpStatic6DeleteFailed struct for DhcpStatic6DeleteFailed
type DhcpStatic6DeleteFailed struct {
...
func (o DhcpStatic6DeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpStatic6DeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpStatic6DeleteFailed struct {
	value *DhcpStatic6DeleteFailed
	isSet bool
}

func (v NullableDhcpStatic6DeleteFailed) Get() *DhcpStatic6DeleteFailed {
	return v.value
}

func (v *NullableDhcpStatic6DeleteFailed) Set(val *DhcpStatic6DeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpStatic6DeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpStatic6DeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpStatic6DeleteFailed(val *DhcpStatic6DeleteFailed) *NullableDhcpStatic6DeleteFailed {
	return &NullableDhcpStatic6DeleteFailed{value: val, isSet: true}
}

func (v NullableDhcpStatic6DeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpStatic6DeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
