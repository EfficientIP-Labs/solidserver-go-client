...
type DnsZoneparamDeleteSuccess struct {
	...
	Data *[]DnsZoneparamDeleteSuccessData `json:"data,omitempty"`
}
...
func (o *DnsZoneparamDeleteSuccess) GetData() []DnsZoneparamDeleteSuccessData {
	if o == nil || o.Data == nil {
		var ret []DnsZoneparamDeleteSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DnsZoneparamDeleteSuccessData and assigns it to the Data field.
