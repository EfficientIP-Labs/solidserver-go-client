...
// checks if the DnsZoneparamDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneparamDeleteSuccess{}

// DnsZoneparamDeleteSuccess struct for DnsZoneparamDeleteSuccess
type DnsZoneparamDeleteSuccess struct {
	...
	Data     []DataInnerDnsZoneparamDeleteSuccess `json:"data,omitempty"`
}
...
func NewDnsZoneparamDeleteSuccess() *DnsZoneparamDeleteSuccess {
	this := DnsZoneparamDeleteSuccess{}
	return &this
}
...
func (o *DnsZoneparamDeleteSuccess) GetData() []DataInnerDnsZoneparamDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsZoneparamDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsZoneparamDeleteSuccess and assigns it to the Data field.
func (o *DnsZoneparamDeleteSuccess) SetData(v []DataInnerDnsZoneparamDeleteSuccess) {
	o.Data = v
}

func (o DnsZoneparamDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o DnsZoneparamDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDnsZoneparamDeleteSuccess struct {
	value *DnsZoneparamDeleteSuccess
	isSet bool
}

func (v NullableDnsZoneparamDeleteSuccess) Get() *DnsZoneparamDeleteSuccess {
	return v.value
}

func (v *NullableDnsZoneparamDeleteSuccess) Set(val *DnsZoneparamDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsZoneparamDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsZoneparamDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsZoneparamDeleteSuccess(val *DnsZoneparamDeleteSuccess) *NullableDnsZoneparamDeleteSuccess {
	return &NullableDnsZoneparamDeleteSuccess{value: val, isSet: true}
}

func (v NullableDnsZoneparamDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsZoneparamDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
