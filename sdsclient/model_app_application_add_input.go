...
// checks if the AppApplicationAddInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppApplicationAddInput{}
...
func (o AppApplicationAddInput) ToMap() (map[string]interface{}, error) {
