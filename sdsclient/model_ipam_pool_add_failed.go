...
// checks if the IpamPoolAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamPoolAddFailed{}

// IpamPoolAddFailed struct for IpamPoolAddFailed
type IpamPoolAddFailed struct {
...
func (o IpamPoolAddFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamPoolAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamPoolAddFailed struct {
	value *IpamPoolAddFailed
	isSet bool
}

func (v NullableIpamPoolAddFailed) Get() *IpamPoolAddFailed {
	return v.value
}

func (v *NullableIpamPoolAddFailed) Set(val *IpamPoolAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamPoolAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamPoolAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamPoolAddFailed(val *IpamPoolAddFailed) *NullableIpamPoolAddFailed {
	return &NullableIpamPoolAddFailed{value: val, isSet: true}
}

func (v NullableIpamPoolAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamPoolAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
