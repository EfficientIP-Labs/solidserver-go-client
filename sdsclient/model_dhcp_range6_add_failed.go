...
// checks if the DhcpRange6AddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpRange6AddFailed{}

// DhcpRange6AddFailed struct for DhcpRange6AddFailed
type DhcpRange6AddFailed struct {
...
func (o DhcpRange6AddFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpRange6AddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpRange6AddFailed struct {
	value *DhcpRange6AddFailed
	isSet bool
}

func (v NullableDhcpRange6AddFailed) Get() *DhcpRange6AddFailed {
	return v.value
}

func (v *NullableDhcpRange6AddFailed) Set(val *DhcpRange6AddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpRange6AddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpRange6AddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpRange6AddFailed(val *DhcpRange6AddFailed) *NullableDhcpRange6AddFailed {
	return &NullableDhcpRange6AddFailed{value: val, isSet: true}
}

func (v NullableDhcpRange6AddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpRange6AddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
