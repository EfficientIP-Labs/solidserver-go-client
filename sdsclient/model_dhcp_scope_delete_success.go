...
type DhcpScopeDeleteSuccess struct {
	...
	Data *[]DhcpScopeDeleteSuccessData `json:"data,omitempty"`
}
...
func (o *DhcpScopeDeleteSuccess) GetData() []DhcpScopeDeleteSuccessData {
	if o == nil || o.Data == nil {
		var ret []DhcpScopeDeleteSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DhcpScopeDeleteSuccessData and assigns it to the Data field.
