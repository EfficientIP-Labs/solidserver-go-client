...
// checks if the DhcpScopeDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpScopeDeleteSuccess{}

// DhcpScopeDeleteSuccess struct for DhcpScopeDeleteSuccess
type DhcpScopeDeleteSuccess struct {
	...
	Data     []DataInnerDhcpScopeDeleteSuccess `json:"data,omitempty"`
}
...
func (o *DhcpScopeDeleteSuccess) GetData() []DataInnerDhcpScopeDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpScopeDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpScopeDeleteSuccess and assigns it to the Data field.
func (o *DhcpScopeDeleteSuccess) SetData(v []DataInnerDhcpScopeDeleteSuccess) {
	o.Data = v
}

func (o DhcpScopeDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o DhcpScopeDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpScopeDeleteSuccess struct {
	value *DhcpScopeDeleteSuccess
	isSet bool
}

func (v NullableDhcpScopeDeleteSuccess) Get() *DhcpScopeDeleteSuccess {
	return v.value
}

func (v *NullableDhcpScopeDeleteSuccess) Set(val *DhcpScopeDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpScopeDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpScopeDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpScopeDeleteSuccess(val *DhcpScopeDeleteSuccess) *NullableDhcpScopeDeleteSuccess {
	return &NullableDhcpScopeDeleteSuccess{value: val, isSet: true}
}

func (v NullableDhcpScopeDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpScopeDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
