...
// checks if the DataInnerIpamAlias6EditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerIpamAlias6EditSuccess{}

// DataInnerIpamAlias6EditSuccess struct for DataInnerIpamAlias6EditSuccess
type DataInnerIpamAlias6EditSuccess struct {
...
func NewDataInnerIpamAlias6EditSuccess() *DataInnerIpamAlias6EditSuccess {
	this := DataInnerIpamAlias6EditSuccess{}
	return &this
}
...
func (o DataInnerIpamAlias6EditSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerIpamAlias6EditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerIpamAlias6EditSuccess struct {
	value *DataInnerIpamAlias6EditSuccess
	isSet bool
}

func (v NullableDataInnerIpamAlias6EditSuccess) Get() *DataInnerIpamAlias6EditSuccess {
	return v.value
}

func (v *NullableDataInnerIpamAlias6EditSuccess) Set(val *DataInnerIpamAlias6EditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerIpamAlias6EditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerIpamAlias6EditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerIpamAlias6EditSuccess(val *DataInnerIpamAlias6EditSuccess) *NullableDataInnerIpamAlias6EditSuccess {
	return &NullableDataInnerIpamAlias6EditSuccess{value: val, isSet: true}
}

func (v NullableDataInnerIpamAlias6EditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerIpamAlias6EditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
