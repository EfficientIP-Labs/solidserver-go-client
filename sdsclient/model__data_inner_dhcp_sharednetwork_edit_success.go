...
// checks if the DataInnerDhcpSharednetworkEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerDhcpSharednetworkEditSuccess{}

// DataInnerDhcpSharednetworkEditSuccess struct for DataInnerDhcpSharednetworkEditSuccess
type DataInnerDhcpSharednetworkEditSuccess struct {
...
func NewDataInnerDhcpSharednetworkEditSuccess() *DataInnerDhcpSharednetworkEditSuccess {
	this := DataInnerDhcpSharednetworkEditSuccess{}
	return &this
}
...
func (o DataInnerDhcpSharednetworkEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerDhcpSharednetworkEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerDhcpSharednetworkEditSuccess struct {
	value *DataInnerDhcpSharednetworkEditSuccess
	isSet bool
}

func (v NullableDataInnerDhcpSharednetworkEditSuccess) Get() *DataInnerDhcpSharednetworkEditSuccess {
	return v.value
}

func (v *NullableDataInnerDhcpSharednetworkEditSuccess) Set(val *DataInnerDhcpSharednetworkEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerDhcpSharednetworkEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerDhcpSharednetworkEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerDhcpSharednetworkEditSuccess(val *DataInnerDhcpSharednetworkEditSuccess) *NullableDataInnerDhcpSharednetworkEditSuccess {
	return &NullableDataInnerDhcpSharednetworkEditSuccess{value: val, isSet: true}
}

func (v NullableDataInnerDhcpSharednetworkEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerDhcpSharednetworkEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
