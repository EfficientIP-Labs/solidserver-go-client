...
type DhcpSharednetworkData struct {
	...
	Data *[]DhcpSharednetworkDataData `json:"data,omitempty"`
}
...
func (o *DhcpSharednetworkData) GetData() []DhcpSharednetworkDataData {
	if o == nil || o.Data == nil {
		var ret []DhcpSharednetworkDataData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DhcpSharednetworkDataData and assigns it to the Data field.
