...
// checks if the VlanDomainData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanDomainData{}

// VlanDomainData struct for VlanDomainData
type VlanDomainData struct {
	...
	Data     []DataInnerVlanDomainData `json:"data,omitempty"`
}
...
func (o *VlanDomainData) GetData() []DataInnerVlanDomainData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerVlanDomainData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerVlanDomainData and assigns it to the Data field.
func (o *VlanDomainData) SetData(v []DataInnerVlanDomainData) {
	o.Data = v
}

func (o VlanDomainData) MarshalJSON() ([]byte, error) {
...
func (o VlanDomainData) ToMap() (map[string]interface{}, error) {
...
type NullableVlanDomainData struct {
	value *VlanDomainData
	isSet bool
}

func (v NullableVlanDomainData) Get() *VlanDomainData {
	return v.value
}

func (v *NullableVlanDomainData) Set(val *VlanDomainData) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanDomainData) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanDomainData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanDomainData(val *VlanDomainData) *NullableVlanDomainData {
	return &NullableVlanDomainData{value: val, isSet: true}
}

func (v NullableVlanDomainData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanDomainData) UnmarshalJSON(src []byte) error {
	v.isSet = true
