...
// checks if the DnsZoneparamAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneparamAddFailed{}

// DnsZoneparamAddFailed struct for DnsZoneparamAddFailed
type DnsZoneparamAddFailed struct {
...
func (o DnsZoneparamAddFailed) MarshalJSON() ([]byte, error) {
...
func (o DnsZoneparamAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDnsZoneparamAddFailed struct {
	value *DnsZoneparamAddFailed
	isSet bool
}

func (v NullableDnsZoneparamAddFailed) Get() *DnsZoneparamAddFailed {
	return v.value
}

func (v *NullableDnsZoneparamAddFailed) Set(val *DnsZoneparamAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsZoneparamAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsZoneparamAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsZoneparamAddFailed(val *DnsZoneparamAddFailed) *NullableDnsZoneparamAddFailed {
	return &NullableDnsZoneparamAddFailed{value: val, isSet: true}
}

func (v NullableDnsZoneparamAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsZoneparamAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
