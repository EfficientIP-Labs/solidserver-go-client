...
type DnsAclAddSuccess struct {
	...
	Data *[]DnsAclAddSuccessData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DnsAclAddSuccessData and assigns it to the Data field.
