...
// checks if the DnsAclAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsAclAddSuccess{}

// DnsAclAddSuccess struct for DnsAclAddSuccess
type DnsAclAddSuccess struct {
	...
	Data     []DataInnerDnsAclAddSuccess `json:"data,omitempty"`
}
...
func (o *DnsAclAddSuccess) GetData() []DataInnerDnsAclAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsAclAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsAclAddSuccess and assigns it to the Data field.
func (o *DnsAclAddSuccess) SetData(v []DataInnerDnsAclAddSuccess) {
	o.Data = v
}

func (o DnsAclAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DnsAclAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDnsAclAddSuccess struct {
	value *DnsAclAddSuccess
	isSet bool
}

func (v NullableDnsAclAddSuccess) Get() *DnsAclAddSuccess {
	return v.value
}

func (v *NullableDnsAclAddSuccess) Set(val *DnsAclAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsAclAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsAclAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsAclAddSuccess(val *DnsAclAddSuccess) *NullableDnsAclAddSuccess {
	return &NullableDnsAclAddSuccess{value: val, isSet: true}
}

func (v NullableDnsAclAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsAclAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
