...
type AppApplicationEditSuccess struct {
	...
	Data *[]AppApplicationEditSuccessData `json:"data,omitempty"`
}
...
func (o *AppApplicationEditSuccess) GetData() []AppApplicationEditSuccessData {
	if o == nil || o.Data == nil {
		var ret []AppApplicationEditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []AppApplicationEditSuccessData and assigns it to the Data field.
