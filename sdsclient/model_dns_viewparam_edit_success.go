...
// checks if the DnsViewparamEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsViewparamEditSuccess{}
...
type DnsViewparamEditSuccess struct {
	...
	Data     []DataInnerDnsViewparamEditSuccess `json:"data,omitempty"`
}
...
func (o *DnsViewparamEditSuccess) GetData() []DataInnerDnsViewparamEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsViewparamEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsViewparamEditSuccess and assigns it to the Data field.
...
func (o DnsViewparamEditSuccess) ToMap() (map[string]interface{}, error) {
