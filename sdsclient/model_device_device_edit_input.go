...
// checks if the DeviceDeviceEditInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceDeviceEditInput{}

// DeviceDeviceEditInput struct for DeviceDeviceEditInput
type DeviceDeviceEditInput struct {
...
func (o DeviceDeviceEditInput) MarshalJSON() ([]byte, error) {
...
func (o DeviceDeviceEditInput) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceDeviceEditInput struct {
	value *DeviceDeviceEditInput
	isSet bool
}

func (v NullableDeviceDeviceEditInput) Get() *DeviceDeviceEditInput {
	return v.value
}

func (v *NullableDeviceDeviceEditInput) Set(val *DeviceDeviceEditInput) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceDeviceEditInput) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceDeviceEditInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceDeviceEditInput(val *DeviceDeviceEditInput) *NullableDeviceDeviceEditInput {
	return &NullableDeviceDeviceEditInput{value: val, isSet: true}
}

func (v NullableDeviceDeviceEditInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceDeviceEditInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
