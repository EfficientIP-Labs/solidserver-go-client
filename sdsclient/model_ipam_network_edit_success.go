...
// checks if the IpamNetworkEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamNetworkEditSuccess{}

// IpamNetworkEditSuccess struct for IpamNetworkEditSuccess
type IpamNetworkEditSuccess struct {
	...
	Data     []DataInnerIpamNetworkEditSuccess `json:"data,omitempty"`
}
...
func (o *IpamNetworkEditSuccess) GetData() []DataInnerIpamNetworkEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamNetworkEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamNetworkEditSuccess and assigns it to the Data field.
func (o *IpamNetworkEditSuccess) SetData(v []DataInnerIpamNetworkEditSuccess) {
	o.Data = v
}

func (o IpamNetworkEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o IpamNetworkEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableIpamNetworkEditSuccess struct {
	value *IpamNetworkEditSuccess
	isSet bool
}

func (v NullableIpamNetworkEditSuccess) Get() *IpamNetworkEditSuccess {
	return v.value
}

func (v *NullableIpamNetworkEditSuccess) Set(val *IpamNetworkEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamNetworkEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamNetworkEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamNetworkEditSuccess(val *IpamNetworkEditSuccess) *NullableIpamNetworkEditSuccess {
	return &NullableIpamNetworkEditSuccess{value: val, isSet: true}
}

func (v NullableIpamNetworkEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamNetworkEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
