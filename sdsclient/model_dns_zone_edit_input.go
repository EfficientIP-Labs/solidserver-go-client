...
// checks if the DnsZoneEditInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneEditInput{}
...
func (o DnsZoneEditInput) ToMap() (map[string]interface{}, error) {
