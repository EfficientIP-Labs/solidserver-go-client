...
// checks if the DhcpScopeAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpScopeAddFailed{}
...
func (o DhcpScopeAddFailed) ToMap() (map[string]interface{}, error) {
