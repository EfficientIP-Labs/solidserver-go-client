...
// checks if the IpamPool6DeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamPool6DeleteFailed{}

// IpamPool6DeleteFailed struct for IpamPool6DeleteFailed
type IpamPool6DeleteFailed struct {
...
func (o IpamPool6DeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamPool6DeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamPool6DeleteFailed struct {
	value *IpamPool6DeleteFailed
	isSet bool
}

func (v NullableIpamPool6DeleteFailed) Get() *IpamPool6DeleteFailed {
	return v.value
}

func (v *NullableIpamPool6DeleteFailed) Set(val *IpamPool6DeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamPool6DeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamPool6DeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamPool6DeleteFailed(val *IpamPool6DeleteFailed) *NullableIpamPool6DeleteFailed {
	return &NullableIpamPool6DeleteFailed{value: val, isSet: true}
}

func (v NullableIpamPool6DeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamPool6DeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
