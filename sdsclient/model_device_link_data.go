...
type DeviceLinkData struct {
	...
	Data *[]DeviceLinkDataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DeviceLinkDataData and assigns it to the Data field.
