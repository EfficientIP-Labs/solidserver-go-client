...
// checks if the DnsAclDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsAclDeleteSuccess{}
...
type DnsAclDeleteSuccess struct {
	...
	Data     []DataInnerDnsAclDeleteSuccess `json:"data,omitempty"`
}
...
func (o *DnsAclDeleteSuccess) GetData() []DataInnerDnsAclDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsAclDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsAclDeleteSuccess and assigns it to the Data field.
...
func (o DnsAclDeleteSuccess) ToMap() (map[string]interface{}, error) {
