...
// checks if the AppApplicationAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppApplicationAddFailed{}

// AppApplicationAddFailed struct for AppApplicationAddFailed
type AppApplicationAddFailed struct {
...
func (o AppApplicationAddFailed) MarshalJSON() ([]byte, error) {
...
func (o AppApplicationAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableAppApplicationAddFailed struct {
	value *AppApplicationAddFailed
	isSet bool
}

func (v NullableAppApplicationAddFailed) Get() *AppApplicationAddFailed {
	return v.value
}

func (v *NullableAppApplicationAddFailed) Set(val *AppApplicationAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableAppApplicationAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableAppApplicationAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppApplicationAddFailed(val *AppApplicationAddFailed) *NullableAppApplicationAddFailed {
	return &NullableAppApplicationAddFailed{value: val, isSet: true}
}

func (v NullableAppApplicationAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppApplicationAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
