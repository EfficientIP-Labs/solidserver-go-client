...
// checks if the DhcpScope6DeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpScope6DeleteSuccess{}

// DhcpScope6DeleteSuccess struct for DhcpScope6DeleteSuccess
type DhcpScope6DeleteSuccess struct {
	...
	Data     []DataInnerDhcpScope6DeleteSuccess `json:"data,omitempty"`
}
...
func (o *DhcpScope6DeleteSuccess) GetData() []DataInnerDhcpScope6DeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpScope6DeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpScope6DeleteSuccess and assigns it to the Data field.
func (o *DhcpScope6DeleteSuccess) SetData(v []DataInnerDhcpScope6DeleteSuccess) {
	o.Data = v
}

func (o DhcpScope6DeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o DhcpScope6DeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpScope6DeleteSuccess struct {
	value *DhcpScope6DeleteSuccess
	isSet bool
}

func (v NullableDhcpScope6DeleteSuccess) Get() *DhcpScope6DeleteSuccess {
	return v.value
}

func (v *NullableDhcpScope6DeleteSuccess) Set(val *DhcpScope6DeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpScope6DeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpScope6DeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpScope6DeleteSuccess(val *DhcpScope6DeleteSuccess) *NullableDhcpScope6DeleteSuccess {
	return &NullableDhcpScope6DeleteSuccess{value: val, isSet: true}
}

func (v NullableDhcpScope6DeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpScope6DeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
