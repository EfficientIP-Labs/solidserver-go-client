...
type DhcpScope6DeleteSuccess struct {
	...
	Data *[]DhcpScope6DeleteSuccessData `json:"data,omitempty"`
}
...
func (o *DhcpScope6DeleteSuccess) GetData() []DhcpScope6DeleteSuccessData {
	if o == nil || o.Data == nil {
		var ret []DhcpScope6DeleteSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DhcpScope6DeleteSuccessData and assigns it to the Data field.
