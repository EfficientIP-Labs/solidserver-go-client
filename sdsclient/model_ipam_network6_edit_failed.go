...
// checks if the IpamNetwork6EditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamNetwork6EditFailed{}

// IpamNetwork6EditFailed struct for IpamNetwork6EditFailed
type IpamNetwork6EditFailed struct {
...
func (o IpamNetwork6EditFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamNetwork6EditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamNetwork6EditFailed struct {
	value *IpamNetwork6EditFailed
	isSet bool
}

func (v NullableIpamNetwork6EditFailed) Get() *IpamNetwork6EditFailed {
	return v.value
}

func (v *NullableIpamNetwork6EditFailed) Set(val *IpamNetwork6EditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamNetwork6EditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamNetwork6EditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamNetwork6EditFailed(val *IpamNetwork6EditFailed) *NullableIpamNetwork6EditFailed {
	return &NullableIpamNetwork6EditFailed{value: val, isSet: true}
}

func (v NullableIpamNetwork6EditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamNetwork6EditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
