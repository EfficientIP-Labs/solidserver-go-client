...
// checks if the DnsAclDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsAclDeleteFailed{}

// DnsAclDeleteFailed struct for DnsAclDeleteFailed
type DnsAclDeleteFailed struct {
...
func (o DnsAclDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o DnsAclDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDnsAclDeleteFailed struct {
	value *DnsAclDeleteFailed
	isSet bool
}

func (v NullableDnsAclDeleteFailed) Get() *DnsAclDeleteFailed {
	return v.value
}

func (v *NullableDnsAclDeleteFailed) Set(val *DnsAclDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsAclDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsAclDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsAclDeleteFailed(val *DnsAclDeleteFailed) *NullableDnsAclDeleteFailed {
	return &NullableDnsAclDeleteFailed{value: val, isSet: true}
}

func (v NullableDnsAclDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsAclDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
