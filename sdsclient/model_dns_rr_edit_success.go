...
// checks if the DnsRrEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsRrEditSuccess{}
...
type DnsRrEditSuccess struct {
	...
	Data     []DataInnerDnsRrEditSuccess `json:"data,omitempty"`
}
...
func (o *DnsRrEditSuccess) GetData() []DataInnerDnsRrEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsRrEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsRrEditSuccess and assigns it to the Data field.
...
func (o DnsRrEditSuccess) ToMap() (map[string]interface{}, error) {
