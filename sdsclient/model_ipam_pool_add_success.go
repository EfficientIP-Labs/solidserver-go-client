...
// checks if the IpamPoolAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamPoolAddSuccess{}
...
type IpamPoolAddSuccess struct {
	...
	Data     []DataInnerIpamPoolAddSuccess `json:"data,omitempty"`
}
...
func (o *IpamPoolAddSuccess) GetData() []DataInnerIpamPoolAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamPoolAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamPoolAddSuccess and assigns it to the Data field.
...
func (o IpamPoolAddSuccess) ToMap() (map[string]interface{}, error) {
