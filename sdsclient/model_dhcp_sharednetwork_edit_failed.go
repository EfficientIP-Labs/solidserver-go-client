...
// checks if the DhcpSharednetworkEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpSharednetworkEditFailed{}
...
func (o DhcpSharednetworkEditFailed) ToMap() (map[string]interface{}, error) {
