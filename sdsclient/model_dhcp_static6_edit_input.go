...
// checks if the DhcpStatic6EditInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStatic6EditInput{}
...
func (o DhcpStatic6EditInput) ToMap() (map[string]interface{}, error) {
