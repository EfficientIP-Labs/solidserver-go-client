...
// checks if the DeviceLinkDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceLinkDeleteSuccess{}
...
type DeviceLinkDeleteSuccess struct {
	...
	Data     []DataInnerDeviceLinkDeleteSuccess `json:"data,omitempty"`
}
...
func (o *DeviceLinkDeleteSuccess) GetData() []DataInnerDeviceLinkDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDeviceLinkDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDeviceLinkDeleteSuccess and assigns it to the Data field.
...
func (o DeviceLinkDeleteSuccess) ToMap() (map[string]interface{}, error) {
