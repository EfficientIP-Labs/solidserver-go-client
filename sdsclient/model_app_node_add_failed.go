...
// checks if the AppNodeAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppNodeAddFailed{}

// AppNodeAddFailed struct for AppNodeAddFailed
type AppNodeAddFailed struct {
...
func (o AppNodeAddFailed) MarshalJSON() ([]byte, error) {
...
func (o AppNodeAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableAppNodeAddFailed struct {
	value *AppNodeAddFailed
	isSet bool
}

func (v NullableAppNodeAddFailed) Get() *AppNodeAddFailed {
	return v.value
}

func (v *NullableAppNodeAddFailed) Set(val *AppNodeAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableAppNodeAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableAppNodeAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppNodeAddFailed(val *AppNodeAddFailed) *NullableAppNodeAddFailed {
	return &NullableAppNodeAddFailed{value: val, isSet: true}
}

func (v NullableAppNodeAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppNodeAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
