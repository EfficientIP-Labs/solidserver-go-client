...
// checks if the DhcpRange6DeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpRange6DeleteSuccess{}

// DhcpRange6DeleteSuccess struct for DhcpRange6DeleteSuccess
type DhcpRange6DeleteSuccess struct {
	...
	Data     []DataInnerDhcpRange6DeleteSuccess `json:"data,omitempty"`
}
...
func (o *DhcpRange6DeleteSuccess) GetData() []DataInnerDhcpRange6DeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpRange6DeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpRange6DeleteSuccess and assigns it to the Data field.
func (o *DhcpRange6DeleteSuccess) SetData(v []DataInnerDhcpRange6DeleteSuccess) {
	o.Data = v
}

func (o DhcpRange6DeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o DhcpRange6DeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpRange6DeleteSuccess struct {
	value *DhcpRange6DeleteSuccess
	isSet bool
}

func (v NullableDhcpRange6DeleteSuccess) Get() *DhcpRange6DeleteSuccess {
	return v.value
}

func (v *NullableDhcpRange6DeleteSuccess) Set(val *DhcpRange6DeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpRange6DeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpRange6DeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpRange6DeleteSuccess(val *DhcpRange6DeleteSuccess) *NullableDhcpRange6DeleteSuccess {
	return &NullableDhcpRange6DeleteSuccess{value: val, isSet: true}
}

func (v NullableDhcpRange6DeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpRange6DeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
