...
// checks if the DhcpGroupAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpGroupAddSuccess{}

// DhcpGroupAddSuccess struct for DhcpGroupAddSuccess
type DhcpGroupAddSuccess struct {
	...
	Data     []DataInnerDhcpGroupAddSuccess `json:"data,omitempty"`
}
...
func (o *DhcpGroupAddSuccess) GetData() []DataInnerDhcpGroupAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpGroupAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpGroupAddSuccess and assigns it to the Data field.
func (o *DhcpGroupAddSuccess) SetData(v []DataInnerDhcpGroupAddSuccess) {
	o.Data = v
}

func (o DhcpGroupAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DhcpGroupAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpGroupAddSuccess struct {
	value *DhcpGroupAddSuccess
	isSet bool
}

func (v NullableDhcpGroupAddSuccess) Get() *DhcpGroupAddSuccess {
	return v.value
}

func (v *NullableDhcpGroupAddSuccess) Set(val *DhcpGroupAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpGroupAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpGroupAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpGroupAddSuccess(val *DhcpGroupAddSuccess) *NullableDhcpGroupAddSuccess {
	return &NullableDhcpGroupAddSuccess{value: val, isSet: true}
}

func (v NullableDhcpGroupAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpGroupAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
