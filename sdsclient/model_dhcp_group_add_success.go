...
type DhcpGroupAddSuccess struct {
	...
	Data *[]DhcpGroupAddSuccessData `json:"data,omitempty"`
}
...
func (o *DhcpGroupAddSuccess) GetData() []DhcpGroupAddSuccessData {
	if o == nil || o.Data == nil {
		var ret []DhcpGroupAddSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DhcpGroupAddSuccessData and assigns it to the Data field.
