...
// checks if the DeviceDeviceEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceDeviceEditSuccess{}
...
type DeviceDeviceEditSuccess struct {
	...
	Data     []DataInnerDeviceDeviceEditSuccess `json:"data,omitempty"`
}
...
func (o *DeviceDeviceEditSuccess) GetData() []DataInnerDeviceDeviceEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDeviceDeviceEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDeviceDeviceEditSuccess and assigns it to the Data field.
...
func (o DeviceDeviceEditSuccess) ToMap() (map[string]interface{}, error) {
