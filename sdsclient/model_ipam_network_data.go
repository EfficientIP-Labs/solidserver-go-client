...
// checks if the IpamNetworkData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamNetworkData{}

// IpamNetworkData struct for IpamNetworkData
type IpamNetworkData struct {
	...
	Data     []DataInnerIpamNetworkData `json:"data,omitempty"`
}
...
func (o *IpamNetworkData) GetData() []DataInnerIpamNetworkData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamNetworkData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamNetworkData and assigns it to the Data field.
func (o *IpamNetworkData) SetData(v []DataInnerIpamNetworkData) {
	o.Data = v
}

func (o IpamNetworkData) MarshalJSON() ([]byte, error) {
...
func (o IpamNetworkData) ToMap() (map[string]interface{}, error) {
...
type NullableIpamNetworkData struct {
	value *IpamNetworkData
	isSet bool
}

func (v NullableIpamNetworkData) Get() *IpamNetworkData {
	return v.value
}

func (v *NullableIpamNetworkData) Set(val *IpamNetworkData) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamNetworkData) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamNetworkData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamNetworkData(val *IpamNetworkData) *NullableIpamNetworkData {
	return &NullableIpamNetworkData{value: val, isSet: true}
}

func (v NullableIpamNetworkData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamNetworkData) UnmarshalJSON(src []byte) error {
	v.isSet = true
