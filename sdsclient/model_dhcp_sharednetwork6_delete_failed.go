...
// checks if the DhcpSharednetwork6DeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpSharednetwork6DeleteFailed{}

// DhcpSharednetwork6DeleteFailed struct for DhcpSharednetwork6DeleteFailed
type DhcpSharednetwork6DeleteFailed struct {
...
func NewDhcpSharednetwork6DeleteFailed() *DhcpSharednetwork6DeleteFailed {
	this := DhcpSharednetwork6DeleteFailed{}
	return &this
}
...
func (o DhcpSharednetwork6DeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpSharednetwork6DeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpSharednetwork6DeleteFailed struct {
	value *DhcpSharednetwork6DeleteFailed
	isSet bool
}

func (v NullableDhcpSharednetwork6DeleteFailed) Get() *DhcpSharednetwork6DeleteFailed {
	return v.value
}

func (v *NullableDhcpSharednetwork6DeleteFailed) Set(val *DhcpSharednetwork6DeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpSharednetwork6DeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpSharednetwork6DeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpSharednetwork6DeleteFailed(val *DhcpSharednetwork6DeleteFailed) *NullableDhcpSharednetwork6DeleteFailed {
	return &NullableDhcpSharednetwork6DeleteFailed{value: val, isSet: true}
}

func (v NullableDhcpSharednetwork6DeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpSharednetwork6DeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
