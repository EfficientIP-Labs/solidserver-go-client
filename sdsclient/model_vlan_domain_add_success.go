...
// checks if the VlanDomainAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanDomainAddSuccess{}

// VlanDomainAddSuccess struct for VlanDomainAddSuccess
type VlanDomainAddSuccess struct {
	...
	Data     []DataInnerVlanDomainAddSuccess `json:"data,omitempty"`
}
...
func (o *VlanDomainAddSuccess) GetData() []DataInnerVlanDomainAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerVlanDomainAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerVlanDomainAddSuccess and assigns it to the Data field.
func (o *VlanDomainAddSuccess) SetData(v []DataInnerVlanDomainAddSuccess) {
	o.Data = v
}

func (o VlanDomainAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o VlanDomainAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableVlanDomainAddSuccess struct {
	value *VlanDomainAddSuccess
	isSet bool
}

func (v NullableVlanDomainAddSuccess) Get() *VlanDomainAddSuccess {
	return v.value
}

func (v *NullableVlanDomainAddSuccess) Set(val *VlanDomainAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanDomainAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanDomainAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanDomainAddSuccess(val *VlanDomainAddSuccess) *NullableVlanDomainAddSuccess {
	return &NullableVlanDomainAddSuccess{value: val, isSet: true}
}

func (v NullableVlanDomainAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanDomainAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
