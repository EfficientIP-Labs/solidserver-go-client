...
// checks if the IpamNetworkDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamNetworkDeleteFailed{}

// IpamNetworkDeleteFailed struct for IpamNetworkDeleteFailed
type IpamNetworkDeleteFailed struct {
...
func (o IpamNetworkDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamNetworkDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamNetworkDeleteFailed struct {
	value *IpamNetworkDeleteFailed
	isSet bool
}

func (v NullableIpamNetworkDeleteFailed) Get() *IpamNetworkDeleteFailed {
	return v.value
}

func (v *NullableIpamNetworkDeleteFailed) Set(val *IpamNetworkDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamNetworkDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamNetworkDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamNetworkDeleteFailed(val *IpamNetworkDeleteFailed) *NullableIpamNetworkDeleteFailed {
	return &NullableIpamNetworkDeleteFailed{value: val, isSet: true}
}

func (v NullableIpamNetworkDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamNetworkDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
