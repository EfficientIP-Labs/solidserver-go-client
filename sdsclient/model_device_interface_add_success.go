...
// checks if the DeviceInterfaceAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceInterfaceAddSuccess{}
...
type DeviceInterfaceAddSuccess struct {
	...
	Data     []DataInnerDeviceInterfaceAddSuccess `json:"data,omitempty"`
}
...
func (o *DeviceInterfaceAddSuccess) GetData() []DataInnerDeviceInterfaceAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDeviceInterfaceAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDeviceInterfaceAddSuccess and assigns it to the Data field.
...
func (o DeviceInterfaceAddSuccess) ToMap() (map[string]interface{}, error) {
