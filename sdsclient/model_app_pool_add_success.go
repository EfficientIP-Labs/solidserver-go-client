...
// checks if the AppPoolAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppPoolAddSuccess{}

// AppPoolAddSuccess struct for AppPoolAddSuccess
type AppPoolAddSuccess struct {
	...
	Data     []DataInnerAppPoolAddSuccess `json:"data,omitempty"`
}
...
func (o *AppPoolAddSuccess) GetData() []DataInnerAppPoolAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerAppPoolAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerAppPoolAddSuccess and assigns it to the Data field.
func (o *AppPoolAddSuccess) SetData(v []DataInnerAppPoolAddSuccess) {
	o.Data = v
}

func (o AppPoolAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o AppPoolAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableAppPoolAddSuccess struct {
	value *AppPoolAddSuccess
	isSet bool
}

func (v NullableAppPoolAddSuccess) Get() *AppPoolAddSuccess {
	return v.value
}

func (v *NullableAppPoolAddSuccess) Set(val *AppPoolAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableAppPoolAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableAppPoolAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppPoolAddSuccess(val *AppPoolAddSuccess) *NullableAppPoolAddSuccess {
	return &NullableAppPoolAddSuccess{value: val, isSet: true}
}

func (v NullableAppPoolAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppPoolAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
