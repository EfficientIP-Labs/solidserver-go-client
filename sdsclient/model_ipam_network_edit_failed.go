...
// checks if the IpamNetworkEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamNetworkEditFailed{}

// IpamNetworkEditFailed struct for IpamNetworkEditFailed
type IpamNetworkEditFailed struct {
...
func (o IpamNetworkEditFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamNetworkEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamNetworkEditFailed struct {
	value *IpamNetworkEditFailed
	isSet bool
}

func (v NullableIpamNetworkEditFailed) Get() *IpamNetworkEditFailed {
	return v.value
}

func (v *NullableIpamNetworkEditFailed) Set(val *IpamNetworkEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamNetworkEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamNetworkEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamNetworkEditFailed(val *IpamNetworkEditFailed) *NullableIpamNetworkEditFailed {
	return &NullableIpamNetworkEditFailed{value: val, isSet: true}
}

func (v NullableIpamNetworkEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamNetworkEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
