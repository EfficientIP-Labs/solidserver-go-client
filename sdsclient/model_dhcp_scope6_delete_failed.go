...
// checks if the DhcpScope6DeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpScope6DeleteFailed{}

// DhcpScope6DeleteFailed struct for DhcpScope6DeleteFailed
type DhcpScope6DeleteFailed struct {
...
func (o DhcpScope6DeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpScope6DeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpScope6DeleteFailed struct {
	value *DhcpScope6DeleteFailed
	isSet bool
}

func (v NullableDhcpScope6DeleteFailed) Get() *DhcpScope6DeleteFailed {
	return v.value
}

func (v *NullableDhcpScope6DeleteFailed) Set(val *DhcpScope6DeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpScope6DeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpScope6DeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpScope6DeleteFailed(val *DhcpScope6DeleteFailed) *NullableDhcpScope6DeleteFailed {
	return &NullableDhcpScope6DeleteFailed{value: val, isSet: true}
}

func (v NullableDhcpScope6DeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpScope6DeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
