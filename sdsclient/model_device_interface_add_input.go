...
// checks if the DeviceInterfaceAddInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceInterfaceAddInput{}
...
func (o DeviceInterfaceAddInput) ToMap() (map[string]interface{}, error) {
