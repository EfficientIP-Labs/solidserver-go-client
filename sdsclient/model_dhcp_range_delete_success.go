...
// checks if the DhcpRangeDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpRangeDeleteSuccess{}

// DhcpRangeDeleteSuccess struct for DhcpRangeDeleteSuccess
type DhcpRangeDeleteSuccess struct {
	...
	Data     []DataInnerDhcpRangeDeleteSuccess `json:"data,omitempty"`
}
...
func (o *DhcpRangeDeleteSuccess) GetData() []DataInnerDhcpRangeDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpRangeDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpRangeDeleteSuccess and assigns it to the Data field.
func (o *DhcpRangeDeleteSuccess) SetData(v []DataInnerDhcpRangeDeleteSuccess) {
	o.Data = v
}

func (o DhcpRangeDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o DhcpRangeDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpRangeDeleteSuccess struct {
	value *DhcpRangeDeleteSuccess
	isSet bool
}

func (v NullableDhcpRangeDeleteSuccess) Get() *DhcpRangeDeleteSuccess {
	return v.value
}

func (v *NullableDhcpRangeDeleteSuccess) Set(val *DhcpRangeDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpRangeDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpRangeDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpRangeDeleteSuccess(val *DhcpRangeDeleteSuccess) *NullableDhcpRangeDeleteSuccess {
	return &NullableDhcpRangeDeleteSuccess{value: val, isSet: true}
}

func (v NullableDhcpRangeDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpRangeDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
