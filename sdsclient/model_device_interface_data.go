...
// checks if the DeviceInterfaceData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceInterfaceData{}
...
type DeviceInterfaceData struct {
	...
	Data     []DataInnerDeviceInterfaceData `json:"data,omitempty"`
}
...
func (o *DeviceInterfaceData) GetData() []DataInnerDeviceInterfaceData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDeviceInterfaceData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDeviceInterfaceData and assigns it to the Data field.
...
func (o DeviceInterfaceData) ToMap() (map[string]interface{}, error) {
