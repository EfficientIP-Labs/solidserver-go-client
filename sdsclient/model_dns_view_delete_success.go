...
// checks if the DnsViewDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsViewDeleteSuccess{}

// DnsViewDeleteSuccess struct for DnsViewDeleteSuccess
type DnsViewDeleteSuccess struct {
	...
	Data     []DataInnerDnsViewDeleteSuccess `json:"data,omitempty"`
}
...
func (o *DnsViewDeleteSuccess) GetData() []DataInnerDnsViewDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDnsViewDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDnsViewDeleteSuccess and assigns it to the Data field.
func (o *DnsViewDeleteSuccess) SetData(v []DataInnerDnsViewDeleteSuccess) {
	o.Data = v
}

func (o DnsViewDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o DnsViewDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDnsViewDeleteSuccess struct {
	value *DnsViewDeleteSuccess
	isSet bool
}

func (v NullableDnsViewDeleteSuccess) Get() *DnsViewDeleteSuccess {
	return v.value
}

func (v *NullableDnsViewDeleteSuccess) Set(val *DnsViewDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsViewDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsViewDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsViewDeleteSuccess(val *DnsViewDeleteSuccess) *NullableDnsViewDeleteSuccess {
	return &NullableDnsViewDeleteSuccess{value: val, isSet: true}
}

func (v NullableDnsViewDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsViewDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
