...
type DnsViewDeleteSuccess struct {
	...
	Data *[]DnsViewDeleteSuccessData `json:"data,omitempty"`
}
...
func (o *DnsViewDeleteSuccess) GetData() []DnsViewDeleteSuccessData {
	if o == nil || o.Data == nil {
		var ret []DnsViewDeleteSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DnsViewDeleteSuccessData and assigns it to the Data field.
