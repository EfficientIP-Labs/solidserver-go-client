...
// checks if the DataInnerDhcpStatic6AddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerDhcpStatic6AddSuccess{}

// DataInnerDhcpStatic6AddSuccess struct for DataInnerDhcpStatic6AddSuccess
type DataInnerDhcpStatic6AddSuccess struct {
...
func NewDataInnerDhcpStatic6AddSuccess() *DataInnerDhcpStatic6AddSuccess {
	this := DataInnerDhcpStatic6AddSuccess{}
	return &this
}
...
func (o DataInnerDhcpStatic6AddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerDhcpStatic6AddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerDhcpStatic6AddSuccess struct {
	value *DataInnerDhcpStatic6AddSuccess
	isSet bool
}

func (v NullableDataInnerDhcpStatic6AddSuccess) Get() *DataInnerDhcpStatic6AddSuccess {
	return v.value
}

func (v *NullableDataInnerDhcpStatic6AddSuccess) Set(val *DataInnerDhcpStatic6AddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerDhcpStatic6AddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerDhcpStatic6AddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerDhcpStatic6AddSuccess(val *DataInnerDhcpStatic6AddSuccess) *NullableDataInnerDhcpStatic6AddSuccess {
	return &NullableDataInnerDhcpStatic6AddSuccess{value: val, isSet: true}
}

func (v NullableDataInnerDhcpStatic6AddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerDhcpStatic6AddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
