...
// checks if the IpamNetwork6AddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamNetwork6AddFailed{}

// IpamNetwork6AddFailed struct for IpamNetwork6AddFailed
type IpamNetwork6AddFailed struct {
...
func (o IpamNetwork6AddFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamNetwork6AddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamNetwork6AddFailed struct {
	value *IpamNetwork6AddFailed
	isSet bool
}

func (v NullableIpamNetwork6AddFailed) Get() *IpamNetwork6AddFailed {
	return v.value
}

func (v *NullableIpamNetwork6AddFailed) Set(val *IpamNetwork6AddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamNetwork6AddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamNetwork6AddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamNetwork6AddFailed(val *IpamNetwork6AddFailed) *NullableIpamNetwork6AddFailed {
	return &NullableIpamNetwork6AddFailed{value: val, isSet: true}
}

func (v NullableIpamNetwork6AddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamNetwork6AddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
