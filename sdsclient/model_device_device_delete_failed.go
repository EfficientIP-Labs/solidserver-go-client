...
// checks if the DeviceDeviceDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceDeviceDeleteFailed{}

// DeviceDeviceDeleteFailed struct for DeviceDeviceDeleteFailed
type DeviceDeviceDeleteFailed struct {
...
func (o DeviceDeviceDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o DeviceDeviceDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceDeviceDeleteFailed struct {
	value *DeviceDeviceDeleteFailed
	isSet bool
}

func (v NullableDeviceDeviceDeleteFailed) Get() *DeviceDeviceDeleteFailed {
	return v.value
}

func (v *NullableDeviceDeviceDeleteFailed) Set(val *DeviceDeviceDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceDeviceDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceDeviceDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceDeviceDeleteFailed(val *DeviceDeviceDeleteFailed) *NullableDeviceDeviceDeleteFailed {
	return &NullableDeviceDeviceDeleteFailed{value: val, isSet: true}
}

func (v NullableDeviceDeviceDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceDeviceDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
