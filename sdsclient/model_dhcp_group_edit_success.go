...
// checks if the DhcpGroupEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpGroupEditSuccess{}
...
type DhcpGroupEditSuccess struct {
	...
	Data     []DataInnerDhcpGroupEditSuccess `json:"data,omitempty"`
}
...
func (o *DhcpGroupEditSuccess) GetData() []DataInnerDhcpGroupEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpGroupEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpGroupEditSuccess and assigns it to the Data field.
...
func (o DhcpGroupEditSuccess) ToMap() (map[string]interface{}, error) {
