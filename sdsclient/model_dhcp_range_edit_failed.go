...
// checks if the DhcpRangeEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpRangeEditFailed{}

// DhcpRangeEditFailed struct for DhcpRangeEditFailed
type DhcpRangeEditFailed struct {
...
func (o DhcpRangeEditFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpRangeEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpRangeEditFailed struct {
	value *DhcpRangeEditFailed
	isSet bool
}

func (v NullableDhcpRangeEditFailed) Get() *DhcpRangeEditFailed {
	return v.value
}

func (v *NullableDhcpRangeEditFailed) Set(val *DhcpRangeEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpRangeEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpRangeEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpRangeEditFailed(val *DhcpRangeEditFailed) *NullableDhcpRangeEditFailed {
	return &NullableDhcpRangeEditFailed{value: val, isSet: true}
}

func (v NullableDhcpRangeEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpRangeEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
