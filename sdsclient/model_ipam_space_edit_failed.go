...
// checks if the IpamSpaceEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamSpaceEditFailed{}
...
func (o IpamSpaceEditFailed) ToMap() (map[string]interface{}, error) {
