...
// checks if the DnsAclData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsAclData{}

// DnsAclData struct for DnsAclData
type DnsAclData struct {
	...
	Data     []DataInnerDnsAclData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DataInnerDnsAclData and assigns it to the Data field.
func (o *DnsAclData) SetData(v []DataInnerDnsAclData) {
	o.Data = v
}

func (o DnsAclData) MarshalJSON() ([]byte, error) {
...
func (o DnsAclData) ToMap() (map[string]interface{}, error) {
...
type NullableDnsAclData struct {
	value *DnsAclData
	isSet bool
}

func (v NullableDnsAclData) Get() *DnsAclData {
	return v.value
}

func (v *NullableDnsAclData) Set(val *DnsAclData) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsAclData) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsAclData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsAclData(val *DnsAclData) *NullableDnsAclData {
	return &NullableDnsAclData{value: val, isSet: true}
}

func (v NullableDnsAclData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsAclData) UnmarshalJSON(src []byte) error {
	v.isSet = true
