...
// checks if the DhcpSharednetworkAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpSharednetworkAddSuccess{}

// DhcpSharednetworkAddSuccess struct for DhcpSharednetworkAddSuccess
type DhcpSharednetworkAddSuccess struct {
	...
	Data     []DataInnerDhcpSharednetworkAddSuccess `json:"data,omitempty"`
}
...
func NewDhcpSharednetworkAddSuccess() *DhcpSharednetworkAddSuccess {
	this := DhcpSharednetworkAddSuccess{}
	return &this
}
...
func (o *DhcpSharednetworkAddSuccess) GetData() []DataInnerDhcpSharednetworkAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpSharednetworkAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpSharednetworkAddSuccess and assigns it to the Data field.
func (o *DhcpSharednetworkAddSuccess) SetData(v []DataInnerDhcpSharednetworkAddSuccess) {
	o.Data = v
}

func (o DhcpSharednetworkAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DhcpSharednetworkAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpSharednetworkAddSuccess struct {
	value *DhcpSharednetworkAddSuccess
	isSet bool
}

func (v NullableDhcpSharednetworkAddSuccess) Get() *DhcpSharednetworkAddSuccess {
	return v.value
}

func (v *NullableDhcpSharednetworkAddSuccess) Set(val *DhcpSharednetworkAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpSharednetworkAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpSharednetworkAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpSharednetworkAddSuccess(val *DhcpSharednetworkAddSuccess) *NullableDhcpSharednetworkAddSuccess {
	return &NullableDhcpSharednetworkAddSuccess{value: val, isSet: true}
}

func (v NullableDhcpSharednetworkAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpSharednetworkAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
