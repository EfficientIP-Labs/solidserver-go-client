...
// checks if the DhcpSharednetwork6DeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpSharednetwork6DeleteSuccess{}
...
type DhcpSharednetwork6DeleteSuccess struct {
	...
	Data     []DataInnerDhcpSharednetwork6DeleteSuccess `json:"data,omitempty"`
}
...
func (o *DhcpSharednetwork6DeleteSuccess) GetData() []DataInnerDhcpSharednetwork6DeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpSharednetwork6DeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpSharednetwork6DeleteSuccess and assigns it to the Data field.
...
func (o DhcpSharednetwork6DeleteSuccess) ToMap() (map[string]interface{}, error) {
