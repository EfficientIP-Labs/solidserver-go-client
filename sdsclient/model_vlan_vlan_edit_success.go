...
// checks if the VlanVlanEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanVlanEditSuccess{}

// VlanVlanEditSuccess struct for VlanVlanEditSuccess
type VlanVlanEditSuccess struct {
	...
	Data     []DataInnerVlanVlanEditSuccess `json:"data,omitempty"`
}
...
func (o *VlanVlanEditSuccess) GetData() []DataInnerVlanVlanEditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerVlanVlanEditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerVlanVlanEditSuccess and assigns it to the Data field.
func (o *VlanVlanEditSuccess) SetData(v []DataInnerVlanVlanEditSuccess) {
	o.Data = v
}

func (o VlanVlanEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o VlanVlanEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableVlanVlanEditSuccess struct {
	value *VlanVlanEditSuccess
	isSet bool
}

func (v NullableVlanVlanEditSuccess) Get() *VlanVlanEditSuccess {
	return v.value
}

func (v *NullableVlanVlanEditSuccess) Set(val *VlanVlanEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanVlanEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanVlanEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanVlanEditSuccess(val *VlanVlanEditSuccess) *NullableVlanVlanEditSuccess {
	return &NullableVlanVlanEditSuccess{value: val, isSet: true}
}

func (v NullableVlanVlanEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanVlanEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
