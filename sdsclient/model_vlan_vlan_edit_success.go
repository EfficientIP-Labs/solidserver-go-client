...
type VlanVlanEditSuccess struct {
	...
	Data *[]VlanVlanEditSuccessData `json:"data,omitempty"`
}
...
func (o *VlanVlanEditSuccess) GetData() []VlanVlanEditSuccessData {
	if o == nil || o.Data == nil {
		var ret []VlanVlanEditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []VlanVlanEditSuccessData and assigns it to the Data field.
