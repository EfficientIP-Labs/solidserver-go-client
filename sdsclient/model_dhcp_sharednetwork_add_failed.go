...
// checks if the DhcpSharednetworkAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpSharednetworkAddFailed{}

// DhcpSharednetworkAddFailed struct for DhcpSharednetworkAddFailed
type DhcpSharednetworkAddFailed struct {
...
func NewDhcpSharednetworkAddFailed() *DhcpSharednetworkAddFailed {
	this := DhcpSharednetworkAddFailed{}
	return &this
}
...
func (o DhcpSharednetworkAddFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpSharednetworkAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpSharednetworkAddFailed struct {
	value *DhcpSharednetworkAddFailed
	isSet bool
}

func (v NullableDhcpSharednetworkAddFailed) Get() *DhcpSharednetworkAddFailed {
	return v.value
}

func (v *NullableDhcpSharednetworkAddFailed) Set(val *DhcpSharednetworkAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpSharednetworkAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpSharednetworkAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpSharednetworkAddFailed(val *DhcpSharednetworkAddFailed) *NullableDhcpSharednetworkAddFailed {
	return &NullableDhcpSharednetworkAddFailed{value: val, isSet: true}
}

func (v NullableDhcpSharednetworkAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpSharednetworkAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
