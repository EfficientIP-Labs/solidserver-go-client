...
// checks if the DeviceDeviceAddInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceDeviceAddInput{}
...
func (o DeviceDeviceAddInput) ToMap() (map[string]interface{}, error) {
