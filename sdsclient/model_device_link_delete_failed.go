...
// checks if the DeviceLinkDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceLinkDeleteFailed{}

// DeviceLinkDeleteFailed struct for DeviceLinkDeleteFailed
type DeviceLinkDeleteFailed struct {
...
func (o DeviceLinkDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o DeviceLinkDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceLinkDeleteFailed struct {
	value *DeviceLinkDeleteFailed
	isSet bool
}

func (v NullableDeviceLinkDeleteFailed) Get() *DeviceLinkDeleteFailed {
	return v.value
}

func (v *NullableDeviceLinkDeleteFailed) Set(val *DeviceLinkDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceLinkDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceLinkDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceLinkDeleteFailed(val *DeviceLinkDeleteFailed) *NullableDeviceLinkDeleteFailed {
	return &NullableDeviceLinkDeleteFailed{value: val, isSet: true}
}

func (v NullableDeviceLinkDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceLinkDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
