...
// checks if the DhcpStatic6Data type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStatic6Data{}

// DhcpStatic6Data struct for DhcpStatic6Data
type DhcpStatic6Data struct {
	...
	Data     []DataInnerDhcpStatic6Data `json:"data,omitempty"`
}
...
func (o *DhcpStatic6Data) GetData() []DataInnerDhcpStatic6Data {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpStatic6Data
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpStatic6Data and assigns it to the Data field.
func (o *DhcpStatic6Data) SetData(v []DataInnerDhcpStatic6Data) {
	o.Data = v
}

func (o DhcpStatic6Data) MarshalJSON() ([]byte, error) {
...
func (o DhcpStatic6Data) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpStatic6Data struct {
	value *DhcpStatic6Data
	isSet bool
}

func (v NullableDhcpStatic6Data) Get() *DhcpStatic6Data {
	return v.value
}

func (v *NullableDhcpStatic6Data) Set(val *DhcpStatic6Data) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpStatic6Data) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpStatic6Data) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpStatic6Data(val *DhcpStatic6Data) *NullableDhcpStatic6Data {
	return &NullableDhcpStatic6Data{value: val, isSet: true}
}

func (v NullableDhcpStatic6Data) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpStatic6Data) UnmarshalJSON(src []byte) error {
	v.isSet = true
