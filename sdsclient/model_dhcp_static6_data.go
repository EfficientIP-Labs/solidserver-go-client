...
type DhcpStatic6Data struct {
	...
	Data *[]DhcpStatic6DataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DhcpStatic6DataData and assigns it to the Data field.
