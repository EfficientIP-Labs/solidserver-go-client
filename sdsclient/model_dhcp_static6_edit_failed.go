...
// checks if the DhcpStatic6EditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStatic6EditFailed{}

// DhcpStatic6EditFailed struct for DhcpStatic6EditFailed
type DhcpStatic6EditFailed struct {
...
func (o DhcpStatic6EditFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpStatic6EditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpStatic6EditFailed struct {
	value *DhcpStatic6EditFailed
	isSet bool
}

func (v NullableDhcpStatic6EditFailed) Get() *DhcpStatic6EditFailed {
	return v.value
}

func (v *NullableDhcpStatic6EditFailed) Set(val *DhcpStatic6EditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpStatic6EditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpStatic6EditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpStatic6EditFailed(val *DhcpStatic6EditFailed) *NullableDhcpStatic6EditFailed {
	return &NullableDhcpStatic6EditFailed{value: val, isSet: true}
}

func (v NullableDhcpStatic6EditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpStatic6EditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
