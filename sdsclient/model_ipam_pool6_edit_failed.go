...
// checks if the IpamPool6EditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamPool6EditFailed{}

// IpamPool6EditFailed struct for IpamPool6EditFailed
type IpamPool6EditFailed struct {
...
func (o IpamPool6EditFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamPool6EditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamPool6EditFailed struct {
	value *IpamPool6EditFailed
	isSet bool
}

func (v NullableIpamPool6EditFailed) Get() *IpamPool6EditFailed {
	return v.value
}

func (v *NullableIpamPool6EditFailed) Set(val *IpamPool6EditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamPool6EditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamPool6EditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamPool6EditFailed(val *IpamPool6EditFailed) *NullableIpamPool6EditFailed {
	return &NullableIpamPool6EditFailed{value: val, isSet: true}
}

func (v NullableIpamPool6EditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamPool6EditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
