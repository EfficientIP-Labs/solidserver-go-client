...
// checks if the DeviceInterfaceDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceInterfaceDeleteFailed{}

// DeviceInterfaceDeleteFailed struct for DeviceInterfaceDeleteFailed
type DeviceInterfaceDeleteFailed struct {
...
func NewDeviceInterfaceDeleteFailed() *DeviceInterfaceDeleteFailed {
	this := DeviceInterfaceDeleteFailed{}
	return &this
}
...
func (o DeviceInterfaceDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o DeviceInterfaceDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceInterfaceDeleteFailed struct {
	value *DeviceInterfaceDeleteFailed
	isSet bool
}

func (v NullableDeviceInterfaceDeleteFailed) Get() *DeviceInterfaceDeleteFailed {
	return v.value
}

func (v *NullableDeviceInterfaceDeleteFailed) Set(val *DeviceInterfaceDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceInterfaceDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceInterfaceDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceInterfaceDeleteFailed(val *DeviceInterfaceDeleteFailed) *NullableDeviceInterfaceDeleteFailed {
	return &NullableDeviceInterfaceDeleteFailed{value: val, isSet: true}
}

func (v NullableDeviceInterfaceDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceInterfaceDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
