...
// checks if the DhcpStaticAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStaticAddSuccess{}

// DhcpStaticAddSuccess struct for DhcpStaticAddSuccess
type DhcpStaticAddSuccess struct {
	...
	Data     []DataInnerDhcpStaticAddSuccess `json:"data,omitempty"`
}
...
func (o *DhcpStaticAddSuccess) GetData() []DataInnerDhcpStaticAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpStaticAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpStaticAddSuccess and assigns it to the Data field.
func (o *DhcpStaticAddSuccess) SetData(v []DataInnerDhcpStaticAddSuccess) {
	o.Data = v
}

func (o DhcpStaticAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DhcpStaticAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpStaticAddSuccess struct {
	value *DhcpStaticAddSuccess
	isSet bool
}

func (v NullableDhcpStaticAddSuccess) Get() *DhcpStaticAddSuccess {
	return v.value
}

func (v *NullableDhcpStaticAddSuccess) Set(val *DhcpStaticAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpStaticAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpStaticAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpStaticAddSuccess(val *DhcpStaticAddSuccess) *NullableDhcpStaticAddSuccess {
	return &NullableDhcpStaticAddSuccess{value: val, isSet: true}
}

func (v NullableDhcpStaticAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpStaticAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
