...
type DhcpStaticAddSuccess struct {
	...
	Data *[]DhcpStaticAddSuccessData `json:"data,omitempty"`
}
...
func (o *DhcpStaticAddSuccess) GetData() []DhcpStaticAddSuccessData {
	if o == nil || o.Data == nil {
		var ret []DhcpStaticAddSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DhcpStaticAddSuccessData and assigns it to the Data field.
