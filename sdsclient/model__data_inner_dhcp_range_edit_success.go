...
// checks if the DataInnerDhcpRangeEditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerDhcpRangeEditSuccess{}

// DataInnerDhcpRangeEditSuccess struct for DataInnerDhcpRangeEditSuccess
type DataInnerDhcpRangeEditSuccess struct {
...
func NewDataInnerDhcpRangeEditSuccess() *DataInnerDhcpRangeEditSuccess {
	this := DataInnerDhcpRangeEditSuccess{}
	return &this
}
...
func (o DataInnerDhcpRangeEditSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerDhcpRangeEditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerDhcpRangeEditSuccess struct {
	value *DataInnerDhcpRangeEditSuccess
	isSet bool
}

func (v NullableDataInnerDhcpRangeEditSuccess) Get() *DataInnerDhcpRangeEditSuccess {
	return v.value
}

func (v *NullableDataInnerDhcpRangeEditSuccess) Set(val *DataInnerDhcpRangeEditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerDhcpRangeEditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerDhcpRangeEditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerDhcpRangeEditSuccess(val *DataInnerDhcpRangeEditSuccess) *NullableDataInnerDhcpRangeEditSuccess {
	return &NullableDataInnerDhcpRangeEditSuccess{value: val, isSet: true}
}

func (v NullableDataInnerDhcpRangeEditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerDhcpRangeEditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
