...
// checks if the IpamAliasDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAliasDeleteSuccess{}

// IpamAliasDeleteSuccess struct for IpamAliasDeleteSuccess
type IpamAliasDeleteSuccess struct {
	...
	Data     []DataInnerIpamAliasDeleteSuccess `json:"data,omitempty"`
}
...
func (o *IpamAliasDeleteSuccess) GetData() []DataInnerIpamAliasDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamAliasDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamAliasDeleteSuccess and assigns it to the Data field.
func (o *IpamAliasDeleteSuccess) SetData(v []DataInnerIpamAliasDeleteSuccess) {
	o.Data = v
}

func (o IpamAliasDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o IpamAliasDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAliasDeleteSuccess struct {
	value *IpamAliasDeleteSuccess
	isSet bool
}

func (v NullableIpamAliasDeleteSuccess) Get() *IpamAliasDeleteSuccess {
	return v.value
}

func (v *NullableIpamAliasDeleteSuccess) Set(val *IpamAliasDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAliasDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAliasDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAliasDeleteSuccess(val *IpamAliasDeleteSuccess) *NullableIpamAliasDeleteSuccess {
	return &NullableIpamAliasDeleteSuccess{value: val, isSet: true}
}

func (v NullableIpamAliasDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAliasDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
