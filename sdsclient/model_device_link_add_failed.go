...
// checks if the DeviceLinkAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceLinkAddFailed{}

// DeviceLinkAddFailed struct for DeviceLinkAddFailed
type DeviceLinkAddFailed struct {
...
func (o DeviceLinkAddFailed) MarshalJSON() ([]byte, error) {
...
func (o DeviceLinkAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceLinkAddFailed struct {
	value *DeviceLinkAddFailed
	isSet bool
}

func (v NullableDeviceLinkAddFailed) Get() *DeviceLinkAddFailed {
	return v.value
}

func (v *NullableDeviceLinkAddFailed) Set(val *DeviceLinkAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceLinkAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceLinkAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceLinkAddFailed(val *DeviceLinkAddFailed) *NullableDeviceLinkAddFailed {
	return &NullableDeviceLinkAddFailed{value: val, isSet: true}
}

func (v NullableDeviceLinkAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceLinkAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
