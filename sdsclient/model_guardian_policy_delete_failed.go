...
// checks if the GuardianPolicyDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuardianPolicyDeleteFailed{}
...
func (o GuardianPolicyDeleteFailed) ToMap() (map[string]interface{}, error) {
