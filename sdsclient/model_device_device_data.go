...
type DeviceDeviceData struct {
	...
	Data *[]DeviceDeviceDataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DeviceDeviceDataData and assigns it to the Data field.
