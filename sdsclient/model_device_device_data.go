...
// checks if the DeviceDeviceData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceDeviceData{}

// DeviceDeviceData struct for DeviceDeviceData
type DeviceDeviceData struct {
	...
	Data     []DataInnerDeviceDeviceData `json:"data,omitempty"`
}
...
func (o *DeviceDeviceData) GetData() []DataInnerDeviceDeviceData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDeviceDeviceData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDeviceDeviceData and assigns it to the Data field.
func (o *DeviceDeviceData) SetData(v []DataInnerDeviceDeviceData) {
	o.Data = v
}

func (o DeviceDeviceData) MarshalJSON() ([]byte, error) {
...
func (o DeviceDeviceData) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceDeviceData struct {
	value *DeviceDeviceData
	isSet bool
}

func (v NullableDeviceDeviceData) Get() *DeviceDeviceData {
	return v.value
}

func (v *NullableDeviceDeviceData) Set(val *DeviceDeviceData) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceDeviceData) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceDeviceData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceDeviceData(val *DeviceDeviceData) *NullableDeviceDeviceData {
	return &NullableDeviceDeviceData{value: val, isSet: true}
}

func (v NullableDeviceDeviceData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceDeviceData) UnmarshalJSON(src []byte) error {
	v.isSet = true
