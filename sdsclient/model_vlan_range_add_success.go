...
// checks if the VlanRangeAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanRangeAddSuccess{}

// VlanRangeAddSuccess struct for VlanRangeAddSuccess
type VlanRangeAddSuccess struct {
	...
	Data     []DataInnerVlanRangeAddSuccess `json:"data,omitempty"`
}
...
func (o *VlanRangeAddSuccess) GetData() []DataInnerVlanRangeAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerVlanRangeAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerVlanRangeAddSuccess and assigns it to the Data field.
func (o *VlanRangeAddSuccess) SetData(v []DataInnerVlanRangeAddSuccess) {
	o.Data = v
}

func (o VlanRangeAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o VlanRangeAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableVlanRangeAddSuccess struct {
	value *VlanRangeAddSuccess
	isSet bool
}

func (v NullableVlanRangeAddSuccess) Get() *VlanRangeAddSuccess {
	return v.value
}

func (v *NullableVlanRangeAddSuccess) Set(val *VlanRangeAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanRangeAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanRangeAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanRangeAddSuccess(val *VlanRangeAddSuccess) *NullableVlanRangeAddSuccess {
	return &NullableVlanRangeAddSuccess{value: val, isSet: true}
}

func (v NullableVlanRangeAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanRangeAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
