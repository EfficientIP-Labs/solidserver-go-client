...
// checks if the DhcpScopeEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpScopeEditFailed{}
...
func (o DhcpScopeEditFailed) ToMap() (map[string]interface{}, error) {
