...
// checks if the GuardianPolicyAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuardianPolicyAddSuccess{}

// GuardianPolicyAddSuccess struct for GuardianPolicyAddSuccess
type GuardianPolicyAddSuccess struct {
	...
	Data     []DataInnerGuardianPolicyAddSuccess `json:"data,omitempty"`
}
...
func (o *GuardianPolicyAddSuccess) GetData() []DataInnerGuardianPolicyAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerGuardianPolicyAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerGuardianPolicyAddSuccess and assigns it to the Data field.
func (o *GuardianPolicyAddSuccess) SetData(v []DataInnerGuardianPolicyAddSuccess) {
	o.Data = v
}

func (o GuardianPolicyAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o GuardianPolicyAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableGuardianPolicyAddSuccess struct {
	value *GuardianPolicyAddSuccess
	isSet bool
}

func (v NullableGuardianPolicyAddSuccess) Get() *GuardianPolicyAddSuccess {
	return v.value
}

func (v *NullableGuardianPolicyAddSuccess) Set(val *GuardianPolicyAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableGuardianPolicyAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableGuardianPolicyAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuardianPolicyAddSuccess(val *GuardianPolicyAddSuccess) *NullableGuardianPolicyAddSuccess {
	return &NullableGuardianPolicyAddSuccess{value: val, isSet: true}
}

func (v NullableGuardianPolicyAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuardianPolicyAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
