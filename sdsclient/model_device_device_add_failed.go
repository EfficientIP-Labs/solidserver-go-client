...
// checks if the DeviceDeviceAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceDeviceAddFailed{}
...
func (o DeviceDeviceAddFailed) ToMap() (map[string]interface{}, error) {
