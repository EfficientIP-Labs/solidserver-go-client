...
// checks if the DhcpScopeAddInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpScopeAddInput{}
...
func (o DhcpScopeAddInput) ToMap() (map[string]interface{}, error) {
