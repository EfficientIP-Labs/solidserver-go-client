...
// checks if the DhcpRangeAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpRangeAddFailed{}

// DhcpRangeAddFailed struct for DhcpRangeAddFailed
type DhcpRangeAddFailed struct {
...
func (o DhcpRangeAddFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpRangeAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpRangeAddFailed struct {
	value *DhcpRangeAddFailed
	isSet bool
}

func (v NullableDhcpRangeAddFailed) Get() *DhcpRangeAddFailed {
	return v.value
}

func (v *NullableDhcpRangeAddFailed) Set(val *DhcpRangeAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpRangeAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpRangeAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpRangeAddFailed(val *DhcpRangeAddFailed) *NullableDhcpRangeAddFailed {
	return &NullableDhcpRangeAddFailed{value: val, isSet: true}
}

func (v NullableDhcpRangeAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpRangeAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
