...
type IpamSpaceAddSuccess struct {
	...
	Data *[]IpamSpaceAddSuccessData `json:"data,omitempty"`
}
...
func (o *IpamSpaceAddSuccess) GetData() []IpamSpaceAddSuccessData {
	if o == nil || o.Data == nil {
		var ret []IpamSpaceAddSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []IpamSpaceAddSuccessData and assigns it to the Data field.
