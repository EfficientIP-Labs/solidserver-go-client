...
// checks if the IpamSpaceAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamSpaceAddSuccess{}

// IpamSpaceAddSuccess struct for IpamSpaceAddSuccess
type IpamSpaceAddSuccess struct {
	...
	Data     []DataInnerIpamSpaceAddSuccess `json:"data,omitempty"`
}
...
func (o *IpamSpaceAddSuccess) GetData() []DataInnerIpamSpaceAddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamSpaceAddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamSpaceAddSuccess and assigns it to the Data field.
func (o *IpamSpaceAddSuccess) SetData(v []DataInnerIpamSpaceAddSuccess) {
	o.Data = v
}

func (o IpamSpaceAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o IpamSpaceAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableIpamSpaceAddSuccess struct {
	value *IpamSpaceAddSuccess
	isSet bool
}

func (v NullableIpamSpaceAddSuccess) Get() *IpamSpaceAddSuccess {
	return v.value
}

func (v *NullableIpamSpaceAddSuccess) Set(val *IpamSpaceAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamSpaceAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamSpaceAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamSpaceAddSuccess(val *IpamSpaceAddSuccess) *NullableIpamSpaceAddSuccess {
	return &NullableIpamSpaceAddSuccess{value: val, isSet: true}
}

func (v NullableIpamSpaceAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamSpaceAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
