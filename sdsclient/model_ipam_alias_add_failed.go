...
// checks if the IpamAliasAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAliasAddFailed{}

// IpamAliasAddFailed struct for IpamAliasAddFailed
type IpamAliasAddFailed struct {
...
func (o IpamAliasAddFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamAliasAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAliasAddFailed struct {
	value *IpamAliasAddFailed
	isSet bool
}

func (v NullableIpamAliasAddFailed) Get() *IpamAliasAddFailed {
	return v.value
}

func (v *NullableIpamAliasAddFailed) Set(val *IpamAliasAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAliasAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAliasAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAliasAddFailed(val *IpamAliasAddFailed) *NullableIpamAliasAddFailed {
	return &NullableIpamAliasAddFailed{value: val, isSet: true}
}

func (v NullableIpamAliasAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAliasAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
