...
// checks if the DhcpStaticDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpStaticDeleteFailed{}
...
func (o DhcpStaticDeleteFailed) ToMap() (map[string]interface{}, error) {
