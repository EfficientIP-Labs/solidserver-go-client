...
// checks if the VlanDomainDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanDomainDeleteFailed{}

// VlanDomainDeleteFailed struct for VlanDomainDeleteFailed
type VlanDomainDeleteFailed struct {
...
func (o VlanDomainDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o VlanDomainDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableVlanDomainDeleteFailed struct {
	value *VlanDomainDeleteFailed
	isSet bool
}

func (v NullableVlanDomainDeleteFailed) Get() *VlanDomainDeleteFailed {
	return v.value
}

func (v *NullableVlanDomainDeleteFailed) Set(val *VlanDomainDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanDomainDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanDomainDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanDomainDeleteFailed(val *VlanDomainDeleteFailed) *NullableVlanDomainDeleteFailed {
	return &NullableVlanDomainDeleteFailed{value: val, isSet: true}
}

func (v NullableVlanDomainDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanDomainDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
