...
// checks if the DataInnerVlanVlanAddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataInnerVlanVlanAddSuccess{}

// DataInnerVlanVlanAddSuccess struct for DataInnerVlanVlanAddSuccess
type DataInnerVlanVlanAddSuccess struct {
...
func NewDataInnerVlanVlanAddSuccess() *DataInnerVlanVlanAddSuccess {
	this := DataInnerVlanVlanAddSuccess{}
	return &this
}
...
func (o DataInnerVlanVlanAddSuccess) MarshalJSON() ([]byte, error) {
...
func (o DataInnerVlanVlanAddSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDataInnerVlanVlanAddSuccess struct {
	value *DataInnerVlanVlanAddSuccess
	isSet bool
}

func (v NullableDataInnerVlanVlanAddSuccess) Get() *DataInnerVlanVlanAddSuccess {
	return v.value
}

func (v *NullableDataInnerVlanVlanAddSuccess) Set(val *DataInnerVlanVlanAddSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDataInnerVlanVlanAddSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDataInnerVlanVlanAddSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataInnerVlanVlanAddSuccess(val *DataInnerVlanVlanAddSuccess) *NullableDataInnerVlanVlanAddSuccess {
	return &NullableDataInnerVlanVlanAddSuccess{value: val, isSet: true}
}

func (v NullableDataInnerVlanVlanAddSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataInnerVlanVlanAddSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
