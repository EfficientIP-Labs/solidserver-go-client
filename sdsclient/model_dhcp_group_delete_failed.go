...
// checks if the DhcpGroupDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpGroupDeleteFailed{}

// DhcpGroupDeleteFailed struct for DhcpGroupDeleteFailed
type DhcpGroupDeleteFailed struct {
...
func (o DhcpGroupDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o DhcpGroupDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpGroupDeleteFailed struct {
	value *DhcpGroupDeleteFailed
	isSet bool
}

func (v NullableDhcpGroupDeleteFailed) Get() *DhcpGroupDeleteFailed {
	return v.value
}

func (v *NullableDhcpGroupDeleteFailed) Set(val *DhcpGroupDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpGroupDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpGroupDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpGroupDeleteFailed(val *DhcpGroupDeleteFailed) *NullableDhcpGroupDeleteFailed {
	return &NullableDhcpGroupDeleteFailed{value: val, isSet: true}
}

func (v NullableDhcpGroupDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpGroupDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
