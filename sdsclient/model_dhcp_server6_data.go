...
// checks if the DhcpServer6Data type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpServer6Data{}

// DhcpServer6Data struct for DhcpServer6Data
type DhcpServer6Data struct {
	...
	Data     []DataInnerDhcpServer6Data `json:"data,omitempty"`
}
...
func (o *DhcpServer6Data) GetData() []DataInnerDhcpServer6Data {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpServer6Data
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpServer6Data and assigns it to the Data field.
func (o *DhcpServer6Data) SetData(v []DataInnerDhcpServer6Data) {
	o.Data = v
}

func (o DhcpServer6Data) MarshalJSON() ([]byte, error) {
...
func (o DhcpServer6Data) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpServer6Data struct {
	value *DhcpServer6Data
	isSet bool
}

func (v NullableDhcpServer6Data) Get() *DhcpServer6Data {
	return v.value
}

func (v *NullableDhcpServer6Data) Set(val *DhcpServer6Data) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpServer6Data) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpServer6Data) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpServer6Data(val *DhcpServer6Data) *NullableDhcpServer6Data {
	return &NullableDhcpServer6Data{value: val, isSet: true}
}

func (v NullableDhcpServer6Data) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpServer6Data) UnmarshalJSON(src []byte) error {
	v.isSet = true
