...
// checks if the DeviceInterfaceAddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceInterfaceAddFailed{}

// DeviceInterfaceAddFailed struct for DeviceInterfaceAddFailed
type DeviceInterfaceAddFailed struct {
...
func (o DeviceInterfaceAddFailed) MarshalJSON() ([]byte, error) {
...
func (o DeviceInterfaceAddFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceInterfaceAddFailed struct {
	value *DeviceInterfaceAddFailed
	isSet bool
}

func (v NullableDeviceInterfaceAddFailed) Get() *DeviceInterfaceAddFailed {
	return v.value
}

func (v *NullableDeviceInterfaceAddFailed) Set(val *DeviceInterfaceAddFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceInterfaceAddFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceInterfaceAddFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceInterfaceAddFailed(val *DeviceInterfaceAddFailed) *NullableDeviceInterfaceAddFailed {
	return &NullableDeviceInterfaceAddFailed{value: val, isSet: true}
}

func (v NullableDeviceInterfaceAddFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceInterfaceAddFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
