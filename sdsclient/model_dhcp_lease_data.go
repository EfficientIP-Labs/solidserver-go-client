...
type DhcpLeaseData struct {
	...
	Data *[]DhcpLeaseDataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DhcpLeaseDataData and assigns it to the Data field.
