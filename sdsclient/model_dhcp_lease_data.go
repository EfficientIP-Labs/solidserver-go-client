...
// checks if the DhcpLeaseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpLeaseData{}

// DhcpLeaseData struct for DhcpLeaseData
type DhcpLeaseData struct {
	...
	Data     []DataInnerDhcpLeaseData `json:"data,omitempty"`
}
...
func (o *DhcpLeaseData) GetData() []DataInnerDhcpLeaseData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpLeaseData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpLeaseData and assigns it to the Data field.
func (o *DhcpLeaseData) SetData(v []DataInnerDhcpLeaseData) {
	o.Data = v
}

func (o DhcpLeaseData) MarshalJSON() ([]byte, error) {
...
func (o DhcpLeaseData) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpLeaseData struct {
	value *DhcpLeaseData
	isSet bool
}

func (v NullableDhcpLeaseData) Get() *DhcpLeaseData {
	return v.value
}

func (v *NullableDhcpLeaseData) Set(val *DhcpLeaseData) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpLeaseData) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpLeaseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpLeaseData(val *DhcpLeaseData) *NullableDhcpLeaseData {
	return &NullableDhcpLeaseData{value: val, isSet: true}
}

func (v NullableDhcpLeaseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpLeaseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
