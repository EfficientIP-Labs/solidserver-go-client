...
// checks if the GuardianPolicyEditInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuardianPolicyEditInput{}
...
func (o GuardianPolicyEditInput) ToMap() (map[string]interface{}, error) {
