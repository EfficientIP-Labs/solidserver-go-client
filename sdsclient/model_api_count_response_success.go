...
// checks if the ApiCountResponseSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiCountResponseSuccess{}

// ApiCountResponseSuccess struct for ApiCountResponseSuccess
type ApiCountResponseSuccess struct {
	...
	Data     []ApiCountResponseSuccessDataInner `json:"data,omitempty"`
}
...
func (o *ApiCountResponseSuccess) GetData() []ApiCountResponseSuccessDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []ApiCountResponseSuccessDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ApiCountResponseSuccessDataInner and assigns it to the Data field.
func (o *ApiCountResponseSuccess) SetData(v []ApiCountResponseSuccessDataInner) {
	o.Data = v
}

func (o ApiCountResponseSuccess) MarshalJSON() ([]byte, error) {
...
func (o ApiCountResponseSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableApiCountResponseSuccess struct {
	value *ApiCountResponseSuccess
	isSet bool
}

func (v NullableApiCountResponseSuccess) Get() *ApiCountResponseSuccess {
	return v.value
}

func (v *NullableApiCountResponseSuccess) Set(val *ApiCountResponseSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableApiCountResponseSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableApiCountResponseSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiCountResponseSuccess(val *ApiCountResponseSuccess) *NullableApiCountResponseSuccess {
	return &NullableApiCountResponseSuccess{value: val, isSet: true}
}

func (v NullableApiCountResponseSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiCountResponseSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
