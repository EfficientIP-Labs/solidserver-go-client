...
// checks if the DnsZoneDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneDeleteFailed{}

// DnsZoneDeleteFailed struct for DnsZoneDeleteFailed
type DnsZoneDeleteFailed struct {
...
func (o DnsZoneDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o DnsZoneDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDnsZoneDeleteFailed struct {
	value *DnsZoneDeleteFailed
	isSet bool
}

func (v NullableDnsZoneDeleteFailed) Get() *DnsZoneDeleteFailed {
	return v.value
}

func (v *NullableDnsZoneDeleteFailed) Set(val *DnsZoneDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsZoneDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsZoneDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsZoneDeleteFailed(val *DnsZoneDeleteFailed) *NullableDnsZoneDeleteFailed {
	return &NullableDnsZoneDeleteFailed{value: val, isSet: true}
}

func (v NullableDnsZoneDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsZoneDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
