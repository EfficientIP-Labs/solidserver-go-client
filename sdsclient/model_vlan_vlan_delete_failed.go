...
// checks if the VlanVlanDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanVlanDeleteFailed{}

// VlanVlanDeleteFailed struct for VlanVlanDeleteFailed
type VlanVlanDeleteFailed struct {
...
func (o VlanVlanDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o VlanVlanDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableVlanVlanDeleteFailed struct {
	value *VlanVlanDeleteFailed
	isSet bool
}

func (v NullableVlanVlanDeleteFailed) Get() *VlanVlanDeleteFailed {
	return v.value
}

func (v *NullableVlanVlanDeleteFailed) Set(val *VlanVlanDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanVlanDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanVlanDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanVlanDeleteFailed(val *VlanVlanDeleteFailed) *NullableVlanVlanDeleteFailed {
	return &NullableVlanVlanDeleteFailed{value: val, isSet: true}
}

func (v NullableVlanVlanDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanVlanDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
