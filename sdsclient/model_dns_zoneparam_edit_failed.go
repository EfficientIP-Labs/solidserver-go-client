...
// checks if the DnsZoneparamEditFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsZoneparamEditFailed{}

// DnsZoneparamEditFailed struct for DnsZoneparamEditFailed
type DnsZoneparamEditFailed struct {
...
func (o DnsZoneparamEditFailed) MarshalJSON() ([]byte, error) {
...
func (o DnsZoneparamEditFailed) ToMap() (map[string]interface{}, error) {
...
type NullableDnsZoneparamEditFailed struct {
	value *DnsZoneparamEditFailed
	isSet bool
}

func (v NullableDnsZoneparamEditFailed) Get() *DnsZoneparamEditFailed {
	return v.value
}

func (v *NullableDnsZoneparamEditFailed) Set(val *DnsZoneparamEditFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsZoneparamEditFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsZoneparamEditFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsZoneparamEditFailed(val *DnsZoneparamEditFailed) *NullableDnsZoneparamEditFailed {
	return &NullableDnsZoneparamEditFailed{value: val, isSet: true}
}

func (v NullableDnsZoneparamEditFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsZoneparamEditFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
