...
// checks if the DhcpScope6AddSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpScope6AddSuccess{}
...
type DhcpScope6AddSuccess struct {
	...
	Data     []DataInnerDhcpScope6AddSuccess `json:"data,omitempty"`
}
...
func (o *DhcpScope6AddSuccess) GetData() []DataInnerDhcpScope6AddSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpScope6AddSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpScope6AddSuccess and assigns it to the Data field.
...
func (o DhcpScope6AddSuccess) ToMap() (map[string]interface{}, error) {
