...
// checks if the VlanRangeDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanRangeDeleteFailed{}

// VlanRangeDeleteFailed struct for VlanRangeDeleteFailed
type VlanRangeDeleteFailed struct {
...
func (o VlanRangeDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o VlanRangeDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableVlanRangeDeleteFailed struct {
	value *VlanRangeDeleteFailed
	isSet bool
}

func (v NullableVlanRangeDeleteFailed) Get() *VlanRangeDeleteFailed {
	return v.value
}

func (v *NullableVlanRangeDeleteFailed) Set(val *VlanRangeDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanRangeDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanRangeDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanRangeDeleteFailed(val *VlanRangeDeleteFailed) *NullableVlanRangeDeleteFailed {
	return &NullableVlanRangeDeleteFailed{value: val, isSet: true}
}

func (v NullableVlanRangeDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanRangeDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
