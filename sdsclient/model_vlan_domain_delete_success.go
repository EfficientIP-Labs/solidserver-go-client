...
// checks if the VlanDomainDeleteSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanDomainDeleteSuccess{}

// VlanDomainDeleteSuccess struct for VlanDomainDeleteSuccess
type VlanDomainDeleteSuccess struct {
	...
	Data     []DataInnerVlanDomainDeleteSuccess `json:"data,omitempty"`
}
...
func (o *VlanDomainDeleteSuccess) GetData() []DataInnerVlanDomainDeleteSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerVlanDomainDeleteSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerVlanDomainDeleteSuccess and assigns it to the Data field.
func (o *VlanDomainDeleteSuccess) SetData(v []DataInnerVlanDomainDeleteSuccess) {
	o.Data = v
}

func (o VlanDomainDeleteSuccess) MarshalJSON() ([]byte, error) {
...
func (o VlanDomainDeleteSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableVlanDomainDeleteSuccess struct {
	value *VlanDomainDeleteSuccess
	isSet bool
}

func (v NullableVlanDomainDeleteSuccess) Get() *VlanDomainDeleteSuccess {
	return v.value
}

func (v *NullableVlanDomainDeleteSuccess) Set(val *VlanDomainDeleteSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanDomainDeleteSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanDomainDeleteSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanDomainDeleteSuccess(val *VlanDomainDeleteSuccess) *NullableVlanDomainDeleteSuccess {
	return &NullableVlanDomainDeleteSuccess{value: val, isSet: true}
}

func (v NullableVlanDomainDeleteSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanDomainDeleteSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
