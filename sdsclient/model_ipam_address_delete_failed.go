...
// checks if the IpamAddressDeleteFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAddressDeleteFailed{}

// IpamAddressDeleteFailed struct for IpamAddressDeleteFailed
type IpamAddressDeleteFailed struct {
...
func (o IpamAddressDeleteFailed) MarshalJSON() ([]byte, error) {
...
func (o IpamAddressDeleteFailed) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAddressDeleteFailed struct {
	value *IpamAddressDeleteFailed
	isSet bool
}

func (v NullableIpamAddressDeleteFailed) Get() *IpamAddressDeleteFailed {
	return v.value
}

func (v *NullableIpamAddressDeleteFailed) Set(val *IpamAddressDeleteFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAddressDeleteFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAddressDeleteFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAddressDeleteFailed(val *IpamAddressDeleteFailed) *NullableIpamAddressDeleteFailed {
	return &NullableIpamAddressDeleteFailed{value: val, isSet: true}
}

func (v NullableIpamAddressDeleteFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAddressDeleteFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
