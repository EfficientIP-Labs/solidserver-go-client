...
type DhcpScope6EditSuccess struct {
	...
	Data *[]DhcpScope6EditSuccessData `json:"data,omitempty"`
}
...
func (o *DhcpScope6EditSuccess) GetData() []DhcpScope6EditSuccessData {
	if o == nil || o.Data == nil {
		var ret []DhcpScope6EditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DhcpScope6EditSuccessData and assigns it to the Data field.
