...
// checks if the DhcpScope6EditSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DhcpScope6EditSuccess{}

// DhcpScope6EditSuccess struct for DhcpScope6EditSuccess
type DhcpScope6EditSuccess struct {
	...
	Data     []DataInnerDhcpScope6EditSuccess `json:"data,omitempty"`
}
...
func (o *DhcpScope6EditSuccess) GetData() []DataInnerDhcpScope6EditSuccess {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerDhcpScope6EditSuccess
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerDhcpScope6EditSuccess and assigns it to the Data field.
func (o *DhcpScope6EditSuccess) SetData(v []DataInnerDhcpScope6EditSuccess) {
	o.Data = v
}

func (o DhcpScope6EditSuccess) MarshalJSON() ([]byte, error) {
...
func (o DhcpScope6EditSuccess) ToMap() (map[string]interface{}, error) {
...
type NullableDhcpScope6EditSuccess struct {
	value *DhcpScope6EditSuccess
	isSet bool
}

func (v NullableDhcpScope6EditSuccess) Get() *DhcpScope6EditSuccess {
	return v.value
}

func (v *NullableDhcpScope6EditSuccess) Set(val *DhcpScope6EditSuccess) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpScope6EditSuccess) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpScope6EditSuccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpScope6EditSuccess(val *DhcpScope6EditSuccess) *NullableDhcpScope6EditSuccess {
	return &NullableDhcpScope6EditSuccess{value: val, isSet: true}
}

func (v NullableDhcpScope6EditSuccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpScope6EditSuccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
