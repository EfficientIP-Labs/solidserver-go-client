...
// checks if the IpamPool6AddFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamPool6AddFailed{}
...
func (o IpamPool6AddFailed) ToMap() (map[string]interface{}, error) {
