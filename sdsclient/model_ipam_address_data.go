...
type IpamAddressData struct {
	...
	Data *[]IpamAddressDataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []IpamAddressDataData and assigns it to the Data field.
