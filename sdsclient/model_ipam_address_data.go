...
// checks if the IpamAddressData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpamAddressData{}

// IpamAddressData struct for IpamAddressData
type IpamAddressData struct {
	...
	Data     []DataInnerIpamAddressData `json:"data,omitempty"`
}
...
func (o *IpamAddressData) GetData() []DataInnerIpamAddressData {
	if o == nil || IsNil(o.Data) {
		var ret []DataInnerIpamAddressData
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DataInnerIpamAddressData and assigns it to the Data field.
func (o *IpamAddressData) SetData(v []DataInnerIpamAddressData) {
	o.Data = v
}

func (o IpamAddressData) MarshalJSON() ([]byte, error) {
...
func (o IpamAddressData) ToMap() (map[string]interface{}, error) {
...
type NullableIpamAddressData struct {
	value *IpamAddressData
	isSet bool
}

func (v NullableIpamAddressData) Get() *IpamAddressData {
	return v.value
}

func (v *NullableIpamAddressData) Set(val *IpamAddressData) {
	v.value = val
	v.isSet = true
}

func (v NullableIpamAddressData) IsSet() bool {
	return v.isSet
}

func (v *NullableIpamAddressData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpamAddressData(val *IpamAddressData) *NullableIpamAddressData {
	return &NullableIpamAddressData{value: val, isSet: true}
}

func (v NullableIpamAddressData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpamAddressData) UnmarshalJSON(src []byte) error {
	v.isSet = true
