...
type ApiCountResponseSuccess struct {
	...
	Data *[]ApiCountResponseSuccessData `json:"data,omitempty"`
}
...
func (o *ApiCountResponseSuccess) GetData() []ApiCountResponseSuccessData {
	if o == nil || o.Data == nil {
		var ret []ApiCountResponseSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []ApiCountResponseSuccessData and assigns it to the Data field.
