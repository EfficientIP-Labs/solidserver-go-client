...
type DnsViewparamData struct {
	...
	Data *[]DnsViewparamDataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DnsViewparamDataData and assigns it to the Data field.
