...
type DnsZoneparamAddSuccess struct {
	...
	Data *[]DnsZoneparamAddSuccessData `json:"data,omitempty"`
}
...
func (o *DnsZoneparamAddSuccess) GetData() []DnsZoneparamAddSuccessData {
	if o == nil || o.Data == nil {
		var ret []DnsZoneparamAddSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DnsZoneparamAddSuccessData and assigns it to the Data field.
