...
type DnsRrAddSuccess struct {
	...
	Data *[]DnsRrAddSuccessData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DnsRrAddSuccessData and assigns it to the Data field.
