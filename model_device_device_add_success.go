...
type DeviceDeviceAddSuccess struct {
	...
	Data *[]DeviceDeviceAddSuccessData `json:"data,omitempty"`
}
...
func (o *DeviceDeviceAddSuccess) GetData() []DeviceDeviceAddSuccessData {
	if o == nil || o.Data == nil {
		var ret []DeviceDeviceAddSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DeviceDeviceAddSuccessData and assigns it to the Data field.
