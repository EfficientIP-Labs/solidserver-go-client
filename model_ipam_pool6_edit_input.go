...
type IpamPool6EditInput struct {
	// todo(here) :ipam.pool6.edit.input.pool6_end_address_addr. : IPv6 address
	Pool6EndAddressAddr *string `json:"pool6_end_address_addr,omitempty"`
	// The database identifier (ID) of the IPv6 pool, a unique numeric key value automatically incremented when you add an IPv6 pool. Use the ID to specify which IPv6 pool to edit.
	...
	// todo(here) :ipam.pool6.edit.input.pool6_start_address_addr. : IPv6 address
