...
type DhcpSharednetworkAddSuccess struct {
	...
	Data *[]DhcpSharednetworkAddSuccessData `json:"data,omitempty"`
}
...
func (o *DhcpSharednetworkAddSuccess) GetData() []DhcpSharednetworkAddSuccessData {
	if o == nil || o.Data == nil {
		var ret []DhcpSharednetworkAddSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DhcpSharednetworkAddSuccessData and assigns it to the Data field.
