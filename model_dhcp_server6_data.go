...
type DhcpServer6Data struct {
	...
	Data *[]DhcpServer6DataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DhcpServer6DataData and assigns it to the Data field.
