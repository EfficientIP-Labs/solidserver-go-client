...
type IpamAddressEditSuccess struct {
	...
	Data *[]IpamAddressEditSuccessData `json:"data,omitempty"`
}
...
func (o *IpamAddressEditSuccess) GetData() []IpamAddressEditSuccessData {
	if o == nil || o.Data == nil {
		var ret []IpamAddressEditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []IpamAddressEditSuccessData and assigns it to the Data field.
