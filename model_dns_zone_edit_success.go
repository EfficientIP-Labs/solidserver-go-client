...
type DnsZoneEditSuccess struct {
	...
	Data *[]DnsZoneEditSuccessData `json:"data,omitempty"`
}
...
func (o *DnsZoneEditSuccess) GetData() []DnsZoneEditSuccessData {
	if o == nil || o.Data == nil {
		var ret []DnsZoneEditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []DnsZoneEditSuccessData and assigns it to the Data field.
