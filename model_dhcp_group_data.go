...
type DhcpGroupData struct {
	...
	Data *[]DhcpGroupDataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []DhcpGroupDataData and assigns it to the Data field.
