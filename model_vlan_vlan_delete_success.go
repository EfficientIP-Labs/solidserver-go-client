...
type VlanVlanDeleteSuccess struct {
	...
	Data *[]VlanVlanDeleteSuccessData `json:"data,omitempty"`
}
...
func (o *VlanVlanDeleteSuccess) GetData() []VlanVlanDeleteSuccessData {
	if o == nil || o.Data == nil {
		var ret []VlanVlanDeleteSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []VlanVlanDeleteSuccessData and assigns it to the Data field.
