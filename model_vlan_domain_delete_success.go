...
type VlanDomainDeleteSuccess struct {
	...
	Data *[]VlanDomainDeleteSuccessData `json:"data,omitempty"`
}
...
func (o *VlanDomainDeleteSuccess) GetData() []VlanDomainDeleteSuccessData {
	if o == nil || o.Data == nil {
		var ret []VlanDomainDeleteSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []VlanDomainDeleteSuccessData and assigns it to the Data field.
