...
type VlanDomainAddSuccess struct {
	...
	Data *[]VlanDomainAddSuccessData `json:"data,omitempty"`
}
...
func (o *VlanDomainAddSuccess) GetData() []VlanDomainAddSuccessData {
	if o == nil || o.Data == nil {
		var ret []VlanDomainAddSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []VlanDomainAddSuccessData and assigns it to the Data field.
