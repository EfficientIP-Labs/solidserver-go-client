...
type IpamNetworkData struct {
	...
	Data *[]IpamNetworkDataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []IpamNetworkDataData and assigns it to the Data field.
