...
type VlanVlanData struct {
	...
	Data *[]VlanVlanDataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []VlanVlanDataData and assigns it to the Data field.
