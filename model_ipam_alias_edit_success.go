...
type IpamAliasEditSuccess struct {
	...
	Data *[]IpamAliasEditSuccessData `json:"data,omitempty"`
}
...
func (o *IpamAliasEditSuccess) GetData() []IpamAliasEditSuccessData {
	if o == nil || o.Data == nil {
		var ret []IpamAliasEditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []IpamAliasEditSuccessData and assigns it to the Data field.
