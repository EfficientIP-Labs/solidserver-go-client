...
type IpamPool6Data struct {
	...
	Data *[]IpamPool6DataData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []IpamPool6DataData and assigns it to the Data field.
