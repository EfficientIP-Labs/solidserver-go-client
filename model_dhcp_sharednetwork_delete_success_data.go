...
// DhcpSharednetworkDeleteSuccessData struct for DhcpSharednetworkDeleteSuccessData
type DhcpSharednetworkDeleteSuccessData struct {
...
func NewDhcpSharednetworkDeleteSuccessData() *DhcpSharednetworkDeleteSuccessData {
	this := DhcpSharednetworkDeleteSuccessData{}
	return &this
}
...
func (o DhcpSharednetworkDeleteSuccessData) MarshalJSON() ([]byte, error) {
...
type NullableDhcpSharednetworkDeleteSuccessData struct {
	value *DhcpSharednetworkDeleteSuccessData
	isSet bool
}

func (v NullableDhcpSharednetworkDeleteSuccessData) Get() *DhcpSharednetworkDeleteSuccessData {
	return v.value
}

func (v *NullableDhcpSharednetworkDeleteSuccessData) Set(val *DhcpSharednetworkDeleteSuccessData) {
	v.value = val
	v.isSet = true
}

func (v NullableDhcpSharednetworkDeleteSuccessData) IsSet() bool {
	return v.isSet
}

func (v *NullableDhcpSharednetworkDeleteSuccessData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDhcpSharednetworkDeleteSuccessData(val *DhcpSharednetworkDeleteSuccessData) *NullableDhcpSharednetworkDeleteSuccessData {
	return &NullableDhcpSharednetworkDeleteSuccessData{value: val, isSet: true}
}

func (v NullableDhcpSharednetworkDeleteSuccessData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDhcpSharednetworkDeleteSuccessData) UnmarshalJSON(src []byte) error {
	v.isSet = true
