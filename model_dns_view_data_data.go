...
// DnsViewDataData struct for DnsViewDataData
type DnsViewDataData struct {
...
func (o *DnsViewDataData) GetViewDelayedCreateTime() string {
	if o == nil || o.ViewDelayedCreateTime == nil {
		var ret string
		return ret
	}
...
func (o *DnsViewDataData) GetViewDelayedDeleteTime() string {
	if o == nil || o.ViewDelayedDeleteTime == nil {
		var ret string
		return ret
	}
...
func (o *DnsViewDataData) GetViewMultistatus() string {
	if o == nil || o.ViewMultistatus == nil {
		var ret string
		return ret
	}
...
func (o DnsViewDataData) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.ViewDelayedCreateTime != nil {
		toSerialize["view_delayed_create_time"] = o.ViewDelayedCreateTime
	}
	if o.ViewDelayedDeleteTime != nil {
...
type NullableDnsViewDataData struct {
	value *DnsViewDataData
	isSet bool
}

func (v NullableDnsViewDataData) Get() *DnsViewDataData {
	return v.value
}

func (v *NullableDnsViewDataData) Set(val *DnsViewDataData) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsViewDataData) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsViewDataData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsViewDataData(val *DnsViewDataData) *NullableDnsViewDataData {
	return &NullableDnsViewDataData{value: val, isSet: true}
}

func (v NullableDnsViewDataData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsViewDataData) UnmarshalJSON(src []byte) error {
	v.isSet = true
