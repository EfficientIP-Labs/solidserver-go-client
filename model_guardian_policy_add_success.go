...
type GuardianPolicyAddSuccess struct {
	...
	Data *[]GuardianPolicyAddSuccessData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []GuardianPolicyAddSuccessData and assigns it to the Data field.
