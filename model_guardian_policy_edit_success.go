...
type GuardianPolicyEditSuccess struct {
	...
	Data *[]GuardianPolicyEditSuccessData `json:"data,omitempty"`
}
...
func (o *GuardianPolicyEditSuccess) GetData() []GuardianPolicyEditSuccessData {
	if o == nil || o.Data == nil {
		var ret []GuardianPolicyEditSuccessData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []GuardianPolicyEditSuccessData and assigns it to the Data field.
